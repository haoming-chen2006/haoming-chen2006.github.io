...
export const translations = {
  en: {
    ...
    scoringFlat: 'Every match scores the same: 3 points for the correct result (win / draw / loss) and +2 more for the exact score. No upset or minority bonus.',
  ...
  zh: {
    ...
    scoringFlat: '所有比赛计分相同：猜对赛果（胜 / 平 / 负）得 3 分，比分完全正确再加 2 分。没有任何冷门或小众加成。',
