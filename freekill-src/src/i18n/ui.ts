...
export const UI = {
  ...
  'waiting.customHeroes': { zh_CN: '自制武将', en_US: 'Designed heroes' },
  'waiting.customHeroes.enable': { zh_CN: '本局启用', en_US: 'Deal them at this table' },
  'waiting.customHeroes.count': { zh_CN: '共 {n} 个：{names}', en_US: '{n} in the pack: {names}' },
  'waiting.customHeroes.empty': {
    zh_CN: '这台浏览器还没有自制武将。',
    en_US: 'No designed heroes on this browser yet.',
  },
  'waiting.customHeroes.design': { zh_CN: '去武将设计器', en_US: 'Open the hero designer' },
  'waiting.customHeroes.hint': {
    zh_CN: '设计器里做过的武将会自动带进你开的每一局；打开开关，它们才会进入武将池。',
    en_US: 'Every hero you designed rides along in each room you open; switch this on and they join the pool.',
  },
  'waiting.customHeroes.on': { zh_CN: '已启用 · {names}', en_US: 'On · {names}' },
  'waiting.customHeroes.off': { zh_CN: '未启用（房主带来了 {names}）', en_US: 'Off (the host brought {names})' },
  'waiting.customHeroes.none': { zh_CN: '本局没有自制武将', en_US: 'No designed heroes at this table' },
  'pack.custom': { zh_CN: '自制武将', en_US: 'Designed heroes' },
