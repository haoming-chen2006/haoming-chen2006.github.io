...
return {
  ...
  ["!m_shi2__zhouyu"] = "The great river washes every hero's pride away - only Zhou Lang's name is fixed in the histories!",
  ["!m_shi3__weiyan"] = "My lord and the Chancellor are gone, but Wei Yan remains - I will not let the Wei rebels run wild.",
  ...
  ["!m_shi__zanghong"] = "Fortunes rise and fall, and men turn with them or against - but heaven favours the loyal and the just.",
  ...
  ["#CardDisplayedDesc"] = "A revealed card is a general property of a game card: it means the card is visible to all players.<br />Normally the cards in a player's equip area and judgement area are all revealed cards, but a player's revealed cards do not include the cards in their judgement area.<br />(Note: this mechanic is not additionally adapted to any mechanic other than Mobile's reveal.)",
  ...
  ["#ChengShi"] = "Seize Momentum is a special additional effect: in a multi-branch effect, if the trigger condition of every branch is met, this effect is triggered.",
  ["#Choice"] = "%from chose %arg",
  ["#ChooseInitialKingdom"] = "Please choose your kingdom in this game",
  ["#ConnectCards"] = "An operation performed on hand cards. Connected hand cards are visible to all players. When one connected card leaves a player's hand area because it was used, played or discarded, all players discard the remaining connected cards one by one (this operation does not trigger this rule's discard again). When a connected card is connected again or leaves the corresponding area, it is reset to its normal state.",
  ["#Damage"] = "%to dealt %arg %arg2 DMG to %from",
  ["#DamageWithNoFrom"] = "%from took %arg %arg2 DMG",
  ["#DestructCards"] = "%card was destroyed",
  ["#DisplayCardsDesc"] = "Revealing is an action: the process of turning a game card from face down to face up.<br />When a player reveals cards, every card about to be revealed must meet the following conditions:<br />1. it is in a player's area;<br />2. it is not already a revealed card.<br />(Note: this mechanic is not additionally adapted to any mechanic other than Mobile's reveal.)",
  ...
  ["#LawsDesc"] = "1. The player who dealt the most damage this round takes 2 sourceless damage;<br />2. the player who obtained the most cards this round has their hand card limit -2;<br />3. the player whose HP changed the most times this round loses 1 max HP;<br />4. the player with the most cards in their areas in play gives one card to each other player.",
  ...
  ["#PathDesc"] = "A path between the user (the one who triggers) and the target (the one chosen) that traverses all the players between them in one direction. 'Players on the path' does not include the first and last players.",
  ...
  ["#anda-invoke"] = "Confidant: you can make %src give %dest two cards of different colours, otherwise %dest recovers 1 HP",
  ["#anda_1_trig"] = "Confidant",
  ["#anda_active_1_active"] = "Confidant",
  ["#anxianc-choose"] = "Hidden Bowstring: you can obtain one of these Slashes and then use it (it does not count toward the use limit and has no distance or use restriction)",
  ["#anxianc-slash"] = "Hidden Bowstring: use this Slash (it does not count toward the use limit and has no distance or use restriction)",
  ...
  ["#beizhu-prompt"] = "Prepared Punishment: you can look at another player's hand cards; if there is a Slash, they use their Slashes on you, otherwise you discard a card from them",
  ...
  ["#bifeng-invoke"] = "Evade the Edge: you can cancel the %arg that %src used on you; after it resolves you lose HP or draw cards",
  ["#bifeng_1_trig"] = "Evade the Edge",
  ["#bifeng_2_trig"] = "Evade the Edge",
  ["#bihan-choose"] = "Shield Ward: make yourself or %dest discard hand cards down to their current HP, and this Slash deals 1 less damage to them",
  ["#bihan_1_trig"] = "Shield Ward",
  ["#bihuoy-invoke"] = "Avert Disaster: you can make %dest draw three cards, and this round the distance from every player to them is increased",
  ["#bihuoy_1_trig"] = "Avert Disaster",
  ["#bihuoy_2_distance"] = "Avert Disaster",
  ["#biluan-invoke"] = "Flee the Turmoil: you can give up drawing cards to make other players' distance to you increase by %arg",
  ...
  ["#bingfa-choose_basic"] = "Uphold the Law: choose two laws for every player whose character card is face up to choose between",
  ...
  ["#binghuo-choose"] = "Scourge of War: make a player judge, and if the result is black, you deal 1 thunder damage to them",
  ["#binghuo_1_trig"] = "Scourge of War",
  ["#binglun"] = "Treatise: you can remove a card from the Benevolence area and make a player choose to draw a card or to recover HP at the end of their turn",
  ...
  ["#biwei"] = "Scorn of Rank: discard the hand card with the unique highest number, then make a player discard all hand cards with a number not less than that card",
  ...
  ["#caiqiu-put"] = "Tailored Fur: you can obtain at least one of these cards, but you lose HP this round when another player uses a card with the same name",
  ...
  ["#changshi__chihe-invoke"] = "Thunderous Rebuke: make the Slash you use on %dest unable to be responded to and increase its damage?",
  ...
  ["#changshi__kuiji"] = "Spy the Moment: look at a player's hand cards, and you can discard four cards of different suits from your hand and theirs",
  ...
  ["#changshi__picai"] = "Gather Materials: judge repeatedly until a suit repeats, then you can give the judgement cards to a player",
  ...
  ["#changshi__xiaolu"] = "Night Bribes: draw two cards, then discard two hand cards or give two hand cards to another player",
  ["#changshi__xiaolu-give"] = "Night Bribes: give %arg hand cards to another player",
  ["#changshi__xiaolu_1_active"] = "Night Bribe",
  ["#changshi__yaozhuo"] = "Slander: point fight with a player; if you win, they skip their next Draw phase; if you do not win, you discard two cards",
  ...
  ["#chengzhao-choose"] = "Bear the Edict: start a point fight with a player; if you win, it counts as using a Slash on them that ignores armor",
  ...
  ["#chenshe-invoke"] = "Plea for Pardon: you can discard one card each from you, %src and %dest; if the suits are the same, %src recovers to full HP",
  ["#chenshe-invokeNoSource"] = "Plea for Pardon: you can discard one card each from you and %src; if the suits are the same, %src recovers to full HP",
  ...
  ["#chizhang-invoke"] = "Rampant Display: you can discard at least one hand card; other players cannot use cards of those colors to respond",
  ...
  ["#chongcha-active"] = "Double Difference: you can discard a card to adjust the X in \"Circle Cutting\" to the value of the next digit",
  ["#chongcha_1_active"] = "Double Difference",
  ["#chongcha_2_maxcards"] = "Double Difference",
  ["#chongjian"] = "Breach: use an equip card as Alcohol, or as a Slash with no distance restriction that ignores armor",
  ...
  ["#chongsi-choose"] = "Storm the Court: deal 1 damage to yourself or to the player equipped with Six Dragon Chariot",
  ...
  ["#chuhai"] = "Slay the Scourge: draw a card and point fight with a player; if you win, obtain cards matching the card types in their hand, and this phase, after you deal damage to them, obtain an equip",
  ...
  ["#countermeausre-ask"] = "Respond to 'Countermeasure': if you and the other player choose the same, %src's countermeasure succeeds; otherwise %src fails",
  ["#crossbow_skill"] = "Crossbow",
  ["#cuijin-ask"] = "Urge the Advance: discard a card to make the %arg used by %dest deal 1 more damage? If it deals no damage, you draw a card and deal 1 damage to %dest.",
  ...
  ["#daigong-give"] = "Blunted Assault: you must give %src a card of a different suit, otherwise this damage is prevented",
  ["#daigong-invoke"] = "Blunted Assault: you can show all your hand cards to make the damage source give you a card of a different suit or prevent this damage",
  ...
  ["#daming-choose"] = "Mandate: choose another player. If they have %arg, they must give %dest a %arg and you gain 1 Mandate point; otherwise you give the %arg2 to %dest",
  ["#daming-give"] = "Mandate: you must give %dest a %arg",
  ["#daming_1_trig"] = "Mandate",
  ["#daming_other"] = "Mandate: you can give a card to the player who has Mandate, making them choose another player to give you a card of the same type",
  ...
  ["#daoji"] = "Steal the Halberd: discard a non-basic card and choose a player with cards in their equip area, obtain one of their equips, and if it is a weapon deal damage to them",
  ["#daoji-use"] = "Steal the Halberd: use %arg",
  ["#daoji_1_active"] = "Steal the Halberd",
  ["#daozhuan"] = "Turn of the Way: put a card from you or %dest into the discard pile, counting as using a basic card",
  ...
  ["#difei-discard-recover1"] = "Deflect Slander: discard a hand card, or click Cancel to draw a card, then show all your hand cards and recover 1 HP",
  ["#difei-discard-recover2"] = "Deflect Slander: discard a hand card, or click Cancel to draw a card, then show all your hand cards; if none of them is a %arg card, recover 1 HP",
  ...
  ["#dingzhen-discard"] = "Frontier Guard: discard a Slash, otherwise trick cards you use during your turn this round cannot target %src",
  ["#dingzhen_1_trig"] = "Frontier Guard",
  ["#dingzhen_2_prohibit"] = "Frontier Guard",
  ["#dingzhou"] = "Secure the Province: give another player as many cards as they have on the field, then obtain their cards on the field",
  ...
  ["#duanbi"] = "Forge Currency: make every other player discard half their hand cards (rounded up), then you can give the discarded cards to a player!",
  ...
  ["#duohui-give"] = "Undertow: you can give %src a card; they must then give you another card of the same suit or make you draw a card",
  ["#duohui-give_same"] = "Undertow: give %dest another %arg card, otherwise they draw a card",
  ["#duohui_1_trig"] = "Undertow",
  ["#duoji"] = "Seize Ji Province: you can discard two hand cards and obtain all cards in another player's equip area!",
  ...
  ["#ex__leiji-choose"] = "Lightning Strike: make a player perform a judgement; if it is ♠, you deal 2 thunder damage to them; if it is ♣, you recover 1 HP and deal 1 thunder damage to them",
  ...
  ["#fan_skill"] = "Fan",
  ["#fangqiu-invoke"] = "Full Vigor: make this \"Sleeping Dragon's Stratagem\" prediction public? the effects carried out after all predictions are verified are increased by 1",
  ...
  ["#feijing-choose"] = "Flying Path: you can choose a colour, and the players who discarded a card of that colour become extra targets of the Slash",
  ...
  ["#fengjie-choose"] = "Uphold Integrity: choose a player; in every Finish phase you adjust your hand to match their HP",
  ["#fengjie_1_trig"] = "Uphold Integrity",
  ["#fengjie_2_trig"] = "Uphold Integrity",
  ["#fentao-discard"] = "Burning Tide: discard %arg cards, or cancel to make the damage in this chain transmission +1 instead",
  ...
  ["#friend__manjuan-invoke"] = "Sweeping Scrolls: you can put those cards on top of the draw pile and obtain the same number of cards of a different type",
  ...
  ["#fubi"] = "Right Hand: change one player's Ordained Rites effect, or discard a card to double one player's Ordained Rites effect until the start of your next turn",
  ...
  ["#fujiy"] = "Talisman Aid: show up to %arg cards and give them to that many other players; these cards gain extra effects when used",
  ...
  ["#futu_1_trig"] = "Pagoda",
  ["#futu_2_trig"] = "Pagoda",
  ["#fuyu1-invoke"] = "Desperate Stand: you can point fight with %dest; if you win, this card resolves one extra time; if you do not win, this card has no effect",
  ["#fuyu2-invoke"] = "Desperate Stand: you can point fight with %dest; if they win, this card resolves one extra time; if they do not win, this card has no effect",
  ["#fuyu_1_trig"] = "Cornered Stand",
  ["#fuyu_2_trig"] = "Cornered Stand",
  ["#gaigong-choose"] = "Public Spirit: you can show up to two hand cards of yours or theirs and swap them with the same number of cards from the bottom of the draw pile",
  ...
  ["#ganggeng"] = "Blunt Integrity: give at least two hand cards to a player; at the end of the turn the effect depends on whether they have the most hand cards",
  ["#ganggeng_1_active"] = "Blunt Integrity",
  ["#ganggeng_2_trig"] = "Blunt Integrity",
  ["#ganglie_1_trig"] = "Eye for an Eye",
  ["#ganjue"] = "Bold Resolve: use a card from your equip area as a Slash with no distance or use limit; if the target has no hand card of the same colour, they cannot respond to it",
  ["#ganjue_1_active"] = "Bold Resolve",
  ["#ganjue_2_targetmod"] = "Bold Resolve",
  ["#ganjue_3_trig"] = "Bold Resolve",
  ["#ganning"] = "The Brocade Sail Ranger",
  ["#gaoyuan-choose"] = "Call for Aid: you can discard a card to transfer this Slash to another player with a Candid Recommendation mark",
  ...
  ["#gongmou-choose"] = "Joint Scheme: exchange hand cards with a player, gaining \"Wondrous Plan\" this turn while they gain \"See Through\" this turn",
  ...
  ["#guanzong"] = "Pampering: choose two players, the first <font color='red'>counts as</font> dealing 1 damage to the second",
  ...
  ["#guimou-choose"] = "Cunning Scheme: choose one option, and at your next Prepare phase the player with the lowest value for it is punished",
  ["#guimou-give"] = "Cunning Scheme: give %arg to another player",
  ["#guimou-invoke"] = "Cunning Scheme: choose one of those players to view their hand cards, and you can choose one of those cards to give away or discard",
  ...
  ["#hannan"] = "Ward Off Peril: start a point fight with a player, and the player who wins deals 1 damage to the player who does not win!",
  ...
  ["#hongyi-active"] = "Grand Decorum: choose another player; when they deal damage they judge, red lets the damaged player draw, black reduces the damage by 1",
  ...
  ["#houfeng-invoke"] = "Rich Stipend: you can make %dest Rectify; if they succeed, you and they gain the Rectify reward",
  ...
  ["#huantu-invoke"] = "Patient Design: you can give %dest a card to make them skip their Draw phase, and they draw cards at the Finish phase this turn",
  ["#huantu_1_trig"] = "Patient Design",
  ["#huantu_2_trig"] = "Patient Design",
  ["#huatuo"] = "The Divine Physician",
  ["#hucheer"] = "Night Thief of Divine Stride",
  ["#huishig"] = "Fading Radiance: lose 2 max HP and make one of a player's awaken skills count as meeting its condition (if they have no awaken skill, they draw four cards)",
  ...
  ["#huiyao"] = "Doomed Brilliance: you can take 1 damage with no source and choose another player, who <font color='red'>counts as</font> dealing the damage",
  ...
  ["#jianlv-choose"] = "Broad Deliberation: you can deal 1 damage to another player, then if they die, you carry out an extra effect",
  ...
  ["#jianyu"] = "Remonstrance: choose two players; until the start of your next turn, when these players use cards on each other, the target draws a card",
  ["#jianyu_1_active"] = "Remonstrance",
  ["#jianyu_2_trig"] = "Remonstrance",
  ["#jianyu_3_trig"] = "Remonstrance",
  ["#jianzhan"] = "War Counsel: make a player choose to count as using a Slash on another player you name, or you draw a card",
  ...
  ["#jichou"] = "Swift Scheme: you can count as using one kind of regular trick card, then for the rest of this game you cannot use non-virtual cards of that name and cannot respond to cards of that name",
  ...
  ["#jiejianw-give"] = "Loyal Remonstrance: give any number of hand cards to a player; they gain the Loyal Remonstrance mark",
  ...
  ["#jiejie"] = "Admonition: look at your hand cards, then choose a suit; the effect depends on whether your hand contains that suit",
  ["#jiejie&"] = "Admonition: let Momentum Xin Xianying look at your hand cards, then they choose a suit; the effect depends on whether your hand contains that suit",
  ["#jiejie&_1_active"] = "Admonition",
  ["#jiejie-choice"] = "Admonition: choose a suit; if their hand contains it they discard their hand cards of the other suits, otherwise they obtain a card of that suit",
  ...
  ["#jiezhu-viewas"] = "Relentless Pursuit: you can discard %arg cards; it counts as using a Slash that can target %arg players with no distance restriction",
  ...
  ["#jilim-choice"] = "Mounting Malice: you can secretly choose one of these numbers; the effect depends on how it compares with the number of times %dest targets you this turn",
  ...
  ["#jingzhong-choose"] = "Reverence: you can choose a player and obtain the first three cards they use in their next Action phase",
  ...
  ["#jinzu-display"] = "Mighty Arrowhead: show %arg hand cards; if the number is the middle value the Slash gains an extra effect, if it is an extreme value the shown cards are discarded",
  ["#jinzu_1_active"] = "Mighty Arrowhead",
  ["#jinzu_2_trig"] = "Mighty Arrowhead",
  ["#jinzu_3_trig"] = "Mighty Arrowhead",
  ["#jiren-active"] = "Rousing Blade: you can make all players unable to choose themselves as a target when using non-weapon cards for the rest of the game",
  ...
  ["#jiwei-choice"] = "Aid in Peril: choose a color, then distribute your hand cards of that color to other players",
  ...
  ["#jiyul"] = "Urgent Defense: discard a hand card and obtain one random card of each type different from it",
  ...
  ["#juezhi"] = "Order of Rank: discard at least two cards and obtain a card whose number is the remainder of the sum of the discarded cards' numbers divided by 13",
  ...
  ["#jungong"] = "Severe Assault: you can carry out one option, and it counts as using a Slash with no distance restriction and no limit on the number of uses",
  ...
  ["#kuili_1_trig"] = "Rout",
  ["#kujian-active"] = "You can use Bitter Counsel: mark up to two hand cards as Counsel and give them to another player",
  ...
  ["#lianxi-use"] = "Chain Raid: you can count as using a Slash with no distance restriction and no limit on the number of uses",
  ["#lianxi_1_trig"] = "Chain Raid",
  ["#lianxi_2_maxcards"] = "Chain Raid",
  ["#lianying_1_trig"] = "One After Another",
  ["#lianzhant-slash"] = "Chain Slaughter: you can use a Slash with a number greater than %arg against %dest and draw a card",
  ...
  ["#lingfa-invokeOne"] = "Rule of Law: you can make other players discard a card when they use a Slash this round, otherwise they take damage",
  ["#lingfa-invokeTwo"] = "Rule of Law: you can make other players give you a card when they use a Peach this round, otherwise they take damage",
  ...
  ["#luanqun"] = "Rabble Rouser: make all players show a hand card; you can obtain one of them with the same color as the card you showed",
  ...
  ["#luezhen-invoke"] = "Sweep the Ranks: you can make all other players choose in turn to show hand cards or to have you count as using a Slash on them",
  ...
  ["#lunxiong-invoke"] = "Measure of Heroes: you can discard the hand card with the unique highest number (at least %arg), then draw three cards",
  ...
  ["#m_ex__anjian-choice"] = "Hidden Arrow: make %dest unable to respond to this Slash, or increase the damage they take from this Slash by 1",
  ["#m_ex__anjian_1_trig"] = "Hidden Arrow",
  ["#m_ex__anxu-active"] = "Consolation: choose two other players; the first one chosen obtains a card from the second one chosen",
  ...
  ["#m_ex__benxi-discard"] = "Swift Raid: discard several cards; the first card you use this phase can choose that many additional targets",
  ...
  ["#m_ex__dingpin-active"] = "Grading: choose 1 card to discard (it cannot be a type you have used or discarded this turn) and choose 1 player",
  ...
  ["#m_ex__fangzhu-ask"] = "Banishment: discard %arg cards and lose 1 HP, or click Cancel to draw %arg cards and turn your character card over",
  ["#m_ex__fangzhu-choose"] = "Banishment: make a player choose to draw %arg cards and turn their character card over, or to discard %arg cards and lose 1 HP",
  ...
  ["#m_ex__ganlu-active"] = "Sweet Dew: make two players whose difference in the number of cards in their equip areas is no greater than %arg swap the cards in their equip areas; if you choose yourself there is no such restriction",
  ...
  ["#m_ex__guhuo"] = "Bewitch: place a hand card face down and declare a basic card or ordinary trick card; if nobody challenges, use or play it as that card name",
  ...
  ["#m_ex__jiangchi-invoke"] = "Charge: you can draw a card and use no Slash this phase; or discard a chosen card and use one extra Slash this phase",
  ...
  ["#m_ex__jieming-choose"] = "Devotion: make a player draw two cards, then if their hand card count is less than their max HP, you draw a card",
  ["#m_ex__jieming_1_trig"] = "Integrity",
  ["#m_ex__jieyue-choose"] = "Token of Command: you can choose a card to give to another player",
  ["#m_ex__jieyue-select"] = "Token of Command: choose one hand card and one card in your equip area to keep and discard the rest, or click cancel to make %src draw three cards",
  ...
  ["#m_ex__juece-choose"] = "Ruthless Scheme: choose another player who has lost cards this turn and deal 1 damage to them",
  ...
  ["#m_ex__junxing-discard"] = "Harsh Punishment: discard %arg cards and lose 1 HP, or click Cancel to turn your character card over and draw %arg cards",
  ...
  ["#m_ex__luanji"] = "Wild Assault: use two hand cards as Archery Attack; you cannot use a suit already used this phase",
  ...
  ["#m_ex__mieji-active"] = "Plot Breaker: choose a black trick card to place on top of the draw pile, and choose another player",
  ["#m_ex__mieji-choice"] = "Plot Breaker: choose to give %src a trick card, or to discard two non-trick cards one at a time",
  ["#m_ex__mieji-discard"] = "Plot Breaker: choose one more non-trick card to discard",
  ["#m_ex__mieji_1_active"] = "Scheme Breaker",
  ["#m_ex__niepan"] = "Nirvana: do you want to discard all the cards in your areas, draw three cards, heal your HP up to 3 and restore your character card?",
  ["#m_ex__niepan_1_active"] = "Nirvana",
  ["#m_ex__niepan_2_trig"] = "Nirvana",
  ["#m_ex__paiyi-active"] = "Rejection: choose a Power card to put into the discard pile and choose a player to draw two cards",
  ...
  ["#m_ex__pingkou-choose"] = "Bandit Purge: you can deal 1 damage to each of up to %arg players, then randomly obtain 1 equip card",
  ...
  ["#m_ex__qiangxi"] = "Strong Assault: discard a weapon card, or click OK to lose 1 HP, then deal 1 damage to a player in your ATK range not yet chosen this phase",
  ...
  ["#m_ex__qimou"] = "Ingenious Scheme: lose any amount of HP; this turn your distance to other players is reduced by that much and you can use that many extra Slashes",
  ["#m_ex__qimou_1_active"] = "Ingenious Scheme",
  ["#m_ex__qimou_2_targetmod"] = "Ingenious Scheme",
  ["#m_ex__qimou_3_distance"] = "Ingenious Scheme",
  ["#m_ex__qingjian-ask"] = "Pure Thrift: you can place any number of hand cards face down as Pure Thrift cards, and distribute these cards to other players in your Finish phase",
  ["#m_ex__qingjian_1_trig"] = "Frugality",
  ["#m_ex__qingjian_2_trig"] = "Frugality",
  ["#m_ex__qingnang"] = "Green Salve: discard a hand card to make a player recover 1 HP; if the discarded card was red you can use it again",
  ...
  ["#m_ex__qiuyuan-choose"] = "Call for Aid: make another player give you a basic card other than Slash, or they also become a target of this Slash",
  ["#m_ex__qiuyuan-give"] = "Call for Aid: give %dest a basic card other than Slash, or become an extra target of this Slash",
  ...
  ["#m_ex__shenxing"] = "Prudence: you can discard two cards and draw a card, plus one more if the discarded cards are different colors",
  ["#m_ex__shenxing_1_active"] = "Prudence",
  ["#m_ex__shuangxiong-get"] = "Twin Heroes: obtain one of these cards; this turn you can use hand cards of a different colour as Duel",
  ["#m_ex__shuangxiong-invoke"] = "Twin Heroes: give up drawing cards and instead reveal the top two cards of the draw pile and obtain one of them?",
  ...
  ["#m_ex__sidi-choose2"] = "Mark the Foe: name a Mark the Foe target for %dest; if it is correct, you can trigger the matching effect",
  ...
  ["#m_ex__tianxiang-choose"] = "Heavenly Fragrance: discard a <font color='red'>♥</font> hand card and choose another player",
  ...
  ["#m_ex__xingxue-choose"] = "Promote Learning: you can make up to %arg players each draw a card and place a card on top of the draw pile",
  ["#m_ex__xingxue-give"] = "Promote Learning: choose 1 card to give to 1 target of this Promote Learning, or choose no target and place it on top of the draw pile",
  ...
  ["#m_ex__xuanfeng-choose"] = "Whirlwind: choose to discard 2 cards from other players, or to move 1 equip card of another player",
  ...
  ["#m_ex__yanzhu-choice"] = "Banquet Execution: choose whether %src obtains one card from your area, or %src obtains all cards in your equip area and loses Banquet Execution",
  ...
  ["#m_ex__zhuikong-invoke"] = "Trembling Dread: you can point fight with %dest; if you win, cards they use this turn can only target themselves",
  ...
  ["#m_js__jishan-invoke"] = "Accumulated Virtue: you can lose 2 HP to prevent the damage %dest is taking, then you and they each draw a card",
  ...
  ["#m_js__shelun"] = "Amnesty Debate: name %arg players; every other player whose hand card count is not greater than yours holds a council<br>Red: discard two cards from the targets; Black: deal 1 damage to the targets",
  ...
  ["#m_shi__ceduan"] = "Decisive Strategy: choose a player, then use your hand cards of one color as one kind of Slash against them",
  ["#m_shi__ceduan-show"] = "Decisive Strategy: show a hand card; depending on the color, %src will use a Slash against %dest",
  ...
  ["#m_shi__dimeng"] = "Alliance: make two players whose hand counts differ by no more than %arg exchange hand cards",
  ...
  ["#m_shi__haoshi-choose"] = "Generosity: choose a player; until the start of your next turn, they can use or play your hand cards as if they were their own hand cards",
  ...
  ["#m_shi__jixi-use"] = "Swift Raid: choose any number of players who have been targets of cards you used this turn; it counts as using Snatch on them",
  ...
  ["#m_shi__tuntian"] = "Garrison Farming: you can spend any number of charge points to make up to that many players each obtain a <font color='red'>♥</font> card",
  ["#m_shi__tuntian-choose"] = "Garrison Farming: choose up to %arg players to each obtain a <font color='red'>♥</font> card",
  ...
  ["#m_yuan__wusheng"] = "Warrior Saint: you can use or play any number of cards as a Slash with no distance restriction",
  ...
  ["#miewu"] = "Destroy Wu: discard 1 Armoury mark to use or play a card as any basic or trick card, then draw a card",
  ...
  ["#mobile__beini"] = "Treason: choose a player whose HP is not less than yours; one side draws two cards, the other side uses a Slash on them or obtains a card from them",
  ...
  ["#mobile__chijie-invoke"] = "Imperial Staff: you can perform a judgement, and if the number is greater than 6, cancel this %arg",
  ...
  ["#mobile__daoshu"] = "Steal the Letter: you and your teammates can look at one enemy's hand cards and find the card disguised under a false name",
  ["#mobile__daoshu-choose"] = "Steal the Letter: choose a card name on the left and choose a hand card, then disguise that card as that card name",
  ...
  ["#mobile__diaodu-move"] = "Dispatch: you can move an equip card on the field, and the player who loses the card draws a card",
  ...
  ["#mobile__fuhaiw"] = "Sail the Seas: make all other players choose Rising Tide or Ebbing Tide, then you draw cards",
  ...
  ["#mobile__gongsun-choose"] = "Mutual Loss: discard two cards and choose another player, then name a card; neither of you can use, play or discard hand cards with that name",
  ["#mobile__gongsun-name"] = "Mutual Loss: name a card; you and %dest cannot use, play or discard hand cards with that name until the start of your next turn",
  ...
  ["#mobile__hanzhan"] = "Fierce Battle: you can draw cards together with another player, then it counts as you using a Duel on them",
  ...
  ["#mobile__huishi"] = "Keen Insight: judge repeatedly until a suit repeats, then give the judgement cards to a player",
  ["#mobile__huishi-ask"] = "Keen Insight: you can gain 1 max HP and keep judging",
  ["#mobile__huishi-choose"] = "Keen Insight: give these judgement cards to a player, or click Cancel to obtain them yourself",
  ...
  ["#mobile__jianji"] = "Divisive Scheme: choose a hand card and make two players point fight; the winner counts as using a Slash against the other",
  ...
  ["#mobile__jiexun-choose"] = "Admonition: choose a suit, make a player draw cards equal to the number of cards of that suit on the field, then discard %arg cards",
  ...
  ["#mobile__kuangxiang"] = "Mutual Aid: you can exchange hand cards with a player whose hand count is no greater than yours",
  ...
  ["#mobile__lianji0"] = "Chain Stratagem: choose two players; the first player uses a random weapon, then it counts as using a random damage card on the second player",
  ["#mobile__lianji1"] = "Chain Stratagem: %src uses a random weapon, then it counts as using a random damage card on another player",
  ["#mobile__lianji2"] = "Chain Stratagem: %src uses a random weapon, then it counts as using a random damage card on %dest",
  ["#mobile__lianji_1_active"] = "Chain Stratagem",
  ["#mobile__lianpo_1_trig"] = "Onslaught",
  ["#mobile__lianzhu"] = "Chain Execution: give a player a card; this phase you use cards on the player who has that card with no distance or count restriction",
  ["#mobile__lianzhu-give"] = "Chain Execution: give %src another card and give the Chain Execution card to %dest, otherwise %src draws two cards",
  ...
  ["#mobile__lingren-choice"] = "Overbearing: guess whether the hand cards of %dest contain a basic card, a trick card or an equip card",
  ["#mobile__lingren-choose"] = "Do you want to use Overbearing and guess whether the hand cards of one of the target players contain a basic card, a trick card or an equip card?",
  ["#mobile__lingren-invoke"] = "Do you want to use Overbearing on %dest and guess whether the hand cards of one of the target players contain a basic card, a trick card or an equip card?",
  ...
  ["#mobile__mingfa-show"] = "Open Campaign: you can show a card, and point-fight with it in your next turn's Action phase",
  ...
  ["#mobile__mingshi-discard"] = "Renowned Scholar: discard a card from your areas; if it is black %src obtains it, if it is red %scr recovers HP",
  ...
  ["#mobile__mutao"] = "Call to Arms: choose a player to hand out the Slashes in their hand and deal damage to the last player",
  ...
  ["#mobile__natu_lie-invoke"] = "Fierce: you can adjust your hand to %arg cards; if you discard cards to do so, you can deal 1 damage",
  ...
  ["#mobile__natu_yi-give"] = "Righteousness: distribute these cards; using a black card among them makes the target's non-forced skills invalid",
  ["#mobile__natu_yi-slash"] = "Righteousness: use these cards as a Slash against one of those players; the target cannot use hand cards of the converted cards' color",
  ...
  ["#mobile__qiantun"] = "Humble Ambition: make a player show any number of hand cards and point fight with them; if you win, you obtain the shown cards; if you do not win, you obtain their unshown hand cards",
  ["#mobile__qiantun-ask"] = "Humble Ambition: show any number of hand cards. You can only use these cards to point fight with %src, and depending on the result they obtain your shown cards or your unshown cards!",
  ["#mobile__qiantun-pindian"] = "Humble Ambition: you can only use these cards to point fight with %src! If they win, they obtain your shown cards; if they do not win, they obtain your unshown hand cards",
  ["#mobile__qiantun_1_active"] = "Humble Ambition",
  ["#mobile__qiantun_2_trig"] = "Humble Ambition",
  ["#mobile__qianxinz"] = "Dispatch Letters: choose up to two hand cards and hand them out at random to the same number of other players",
  ["#mobile__qianxinz_1_active"] = "Dispatch Letters",
  ["#mobile__qianxinz_2_trig"] = "Dispatch Letters",
  ["#mobile__qinghegongzhu"] = "Venomous Slander",
  ["#mobile__qingxian"] = "Clear Strings: choose up to %arg other players and discard the same number of cards; the effect depends on how many equips they have",
  ...
  ["#mobile__runwei"] = "Subtle Nourishment: you can show up to 5 cards from the top of the draw pile and make 1 player obtain the cards of one colour among them",
  ...
  ["#mobile__saojian"] = "Purge Traitors: look at another player's hand cards, then make them discard hand cards until they discard the card you chose",
  ["#mobile__saojian-discard"] = "Purge Traitors: discard a hand card, until you discard the card chosen by Purge Traitors (%arg remaining)",
  ["#mobile__saojian_1_active"] = "Purge Traitors",
  ["#mobile__shajue_1_trig"] = "Slaughter",
  ["#mobile__shangyi"] = "Uphold Honor: discard a card to make a player look at your hand cards, then you look at their hand cards and obtain one of them",
  ["#mobile__shangyi_1_active"] = "Uphold Honor",
  ["#mobile__shanxi-cards"] = "Flash Raid: put up to %arg of %dest's cards face down on their character card until the end of the turn",
  ["#mobile__shanxi-choose"] = "Flash Raid: you can discard a red basic card to put another player's cards face down on their character card until the end of the turn",
  ...
  ["#mobile__sidai"] = "Seize the Lull: you can use all your basic cards as a Slash (a Peach or a Dodge among them adds an extra effect)!",
  ...
  ["#mobile__songshu-invoke"] = "Praise of Shu: you can make %dest give up drawing and obtain Benevolence cards instead, and this turn the cards they use cannot target other players",
  ...
  ["#mobile__tianshu-invoke"] = "Heavenly Scripture: you can discard a card to make a player obtain the Classic of Great Peace and use it",
  ...
  ["#mobile__wangliec-invoke"] = "Valiant Advance: choose a hand card; your use of it this phase has no distance restriction and cannot be responded to, and after it resolves you cannot use cards on other players",
  ...
  ["#mobile__weisi"] = "Unbridled Might: make a player remove any number of hand cards from the game until the end of the turn, then it counts as using a Duel against them!",
  ["#mobile__weisi-ask"] = "Unbridled Might: %src will use a Duel against you! Remove any number of hand cards from the game for this turn; after the Duel deals damage to you, they obtain your hand cards!",
  ...
  ["#mobile__wuji"] = "Martial Legacy: modify Vengeance this phase, so that after using a Vengeance card you draw a card!",
  ...
  ["#mobile__xiezheng-choose"] = "Coerced Campaign: make up to %arg players each place a random hand card on top of the draw pile, then you count as using a %arg2 Besiege!",
  ...
  ["#mobile__xuehen-invoke"] = "Vengeance: show up to %arg hand cards; these cards count as Slash with no limit on the number of uses",
  ...
  ["#mobile__xuewei-choose"] = "Blood Guard: secretly choose a player, prevent the next damage they take, take that much damage yourself, and deal damage to the damage source",
  ...
  ["#mobile__yanjiao"] = "Strict Teaching: choose a suit and a player, give all hand cards of that suit to them and deal 1 damage to them",
  ...
  ["#mobile__yilie-choose"] = "Righteous Ardor: choose another player; you take damage in their place, and you recover HP after they deal damage",
  ...
  ["#mobile__yinju"] = "Grasp the Robe: make another player choose: use a Slash on you, or skip their Action phase and Discard phase next turn",
  ["#mobile__yinju-slash"] = "Grasp the Robe: you must use a Slash on %src, otherwise skip your Action phase and Discard phase next turn",
  ...
  ["#mobile__yuanmo-move"] = "Far-Reaching Plan: you can move a card in play, then you can make the player who lost the card draw cards",
  ...
  ["#mobile__yufeng"] = "Ride the Wind: you can play a minigame; on success, make another player skip their Draw phase or their Action and Discard phases",
  ["#mobile__yufeng-choice"] = "Ride the Wind: guess the number of the next card",
  ["#mobile__yufeng-choose"] = "Ride the Wind: choose up to %arg other players; on their next turn they skip their Draw phase or their Action and Discard phases",
  ...
  ["#mobile__zengou-use"] = "Fabricated Slander: you can use in turn one basic card of each different name (they do not count toward the use limit and have no limit on the number of uses)",
  ...
  ["#mobile__zhaoxiong-invoke"] = "Manifest Malice: change your kingdom to Neutral, lose Humble Ambition, and gain Unbridled Might and Purge Dissent?",
  ...
  ["#mobile__zhenyi1"] = "True Rite: you can discard the ♠ Purple Star to change the judgement result of %dest to ♠5 or <font color='red'>♥5</font>",
  ["#mobile__zhenyi2"] = "True Rite: you can discard the ♣ Earth Queen to use a hand card as Peach",
  ["#mobile__zhenyi3"] = "True Rite: you can discard the <font color='red'>♥</font> Jade Purity to increase the damage dealt to %dest by 1",
  ["#mobile__zhenyi4"] = "True Rite: you can discard the <font color='red'>♦</font> Hook Star to randomly obtain one card of each of three card types from the draw pile",
  ...
  ["#mobile__zhouxuanz-give"] = "Manoeuvre: you can distribute these cards as you like, or click Cancel to keep them yourself",
  ...
  ["#mobile_qianlong__qingzheng-card"] = "Uprightness: you can discard your hand cards of one suit, then look at a player's hand and discard one suit from it",
  ["#mobile_qianlong__qingzheng-choose"] = "Uprightness: choose another player, look at their hand and discard one suit from it",
  ["#mobile_qianlong__qingzheng-throw"] = "Uprightness: discard %dest's hand cards of one suit; if fewer than %arg cards are discarded, deal damage to them",
  ...
  ["#mouli"] = "Scheme to Enthrone: make another player remove one of your Reserve cards, and they obtain a card of the same name from the draw pile",
  ...
  ["#muzhen1"] = "Harmonious Ranks: put an equip card into another player's equip area and obtain a hand card from them",
  ...
  ["#nigu"] = "Defiant Hold: discard at least one card, all of different suits, making the players in your ATK range choose to give you a card or your damage +1",
  ...
  ["#nos__cunsi"] = "Preserve the Heir: you can turn your character card over to make a player obtain a Slash, and the next Slash they use deals +1 damage",
  ...
  ["#offensive_siege_engine-invoke"] = "Great Siege Engine - Assault: you can reduce the Great Siege Engine's durability by 1 so that the damage dealt to %dest is +%arg",
  ...
  ["#poxiang-active"] = "Defy Surrender: give a card to a player, then draw three cards, remove all Valor and lose 1 HP",
  ["#poxiang_1_active"] = "Defy Surrender",
  ["#poxiang_2_maxcards"] = "Defy Surrender",
  ["#premeditate_rule&"] = "Premeditate",
  ["#premediterate-use"] = "You can use this Premeditate card %arg, or click Cancel to put all Premeditate cards into the discard pile",
  ["#qianchong-choice"] = "Modesty: choose a card type; this phase you use cards of that type with no limit on the number of uses and no distance restriction",
  ...
  ["#qingjue-invoke"] = "Appeal: %src uses %arg on %dest; you can draw a card and point fight with %src, cancelling the card if you win, or taking it over if you do not",
  ...
  ["#qingshix-invoke"] = "Discerning Eye: choose a player; if they are of the same kingdom as you, you each draw a card, otherwise you discard one card from each of you",
  ...
  ["#qinying"] = "Esteemed Valor: you can recast any number of cards, which counts as using a Duel; either side can discard a card to count as playing a Slash",
  ...
  ["#quanfeng1-invoke"] = "Urge Ascension: you can lose Grand Bearing and gain all of %dest's skills, then your max HP +1 and you recover 1 HP",
  ...
  ["#quchong-choose"] = "Siege Works: you can give the Great Siege Engine in play to another player and make them use it",
  ...
  ["#ruilian-type"] = "Sage Gleaning: you can choose one type among the cards %src discarded this turn, then you and they each obtain a card of that type from the discard pile",
  ...
  ["#shameng"] = "Blood Oath: discard two hand cards of the same color to make another player draw two cards, then you draw three cards",
  ...
  ["#shanjia-discard"] = "Mend Armour: you must discard %arg cards; if you discard no basic card or no trick card, you gain an extra effect",
  ...
  ["#shanxie"] = "Master of Arms: you can obtain a weapon card from the draw pile (if there is none, you randomly obtain another player's weapon)",
  ...
  ["#sheque-invoke"] = "Repelling Shot: you can use a Slash against %dest with no distance restriction that ignores armor",
  ["#sheque_1_trig"] = "Repelling Shot",
  ["#sheque_2_trig"] = "Repelling Shot",
  ["#sheyi-invoke"] = "Forsake the Heir: you can give %dest at least %arg cards to prevent the damage they would take",
  ["#sheyi_1_trig"] = "Forsake the Heir",
  ["#shezi-choice"] = "Seize the Timber: choose one area of %dest; if that area contains equip cards, obtain all cards in it",
  ["#shezi-choose"] = "Seize the Timber: choose a player; if the chosen area contains equip cards, obtain all cards in it",
  ...
  ["#shihe"] = "Show of Force: you can start a point fight; if you win, prevent the damage they deal to you; if you do not win, you discard a random card",
  ["#shihe_1_active"] = "Show of Force",
  ["#shihe_2_trig"] = "Show of Force",
  ["#shihe_3_trig"] = "Show of Force",
  ["#shiji-invoke"] = "Force Strike: you can look at the hand cards of %dest and discard all red cards among them, then draw that many cards",
  ...
  ["#shouye-invoke"] = "Defense of Ye: you can hold a countermeasure with %dest; if you succeed, %arg has no effect on you and you obtain it",
  ...
  ["#shunyi-invoke"] = "Effortless Flow: place all %arg hand cards on your character card until the end of the turn and draw a card?",
  ["#shunyi_1_trig"] = "Effortless Flow",
  ["#shunyi_2_trig"] = "Effortless Flow",
  ["#shuxing-invoke"] = "Binding Penalty: you can make this Slash have no effect on %dest, show their hand cards, and if there is a Dodge among them make them choose an option",
  ...
  ["#strategy-ask"] = "Respond to Strategy: if you and your opponent choose differently, %src's Strategy succeeds; otherwise %src fails",
  ...
  ["#suwang-invoke"] = "Long Renown: obtain all your Long Renown cards instead, then you can make another player draw two cards",
  ...
  ["#tanfeng1-choose"] = "Probe the Edge: discard up to two cards from a player; if their hand size is not greater than yours, they skip their Draw phase",
  ["#tanfeng2-choose"] = "Probe the Edge: deal damage to a player; if their HP is not greater than yours, they skip their Action phase",
  ["#tanfeng_1_trig"] = "Probing Blade",
  ["#taoluanh-invoke"] = "Quell Rebellion: the judgement of %dest is about to take effect, you can cancel this judgement and perform one option!",
  ...
  ["#tiantao-choose"] = "Heavenly Torrent: choose any number of other players and discard 1 card each from those players' %arg",
  ...
  ["#tingwei-choice"] = "Thunderous Might: carry out any options to make %src lose that many Thunder marks; if you carry out none, you become chained",
  ["#tingwei-choose"] = "Thunderous Might: gain 4 Thunder marks and make one target player choose any options to carry out",
  ...
  ["#wangzhuan-invoke"] = "Usurped Authority: you can draw a card to make the current turn player's non-forced skills invalid this turn",
  ...
  ["#weiming-choose"] = "Mighty Mandate: choose a player who has not been chosen before; if they die before you kill another player who has not been chosen, Mighty Mandate fails",
  ...
  ["#wisdom__qiai"] = "Seven Sorrows: give a non-basic card to a player, and they choose to make you recover HP or draw cards",
  ["#wisdom__qiai-choose"] = "Seven Sorrows: choose one option for %src to carry out",
  ["#wisdom__qiai_1_active"] = "Seven Sorrows",
  ["#wisdom__shanxi-choose"] = "War Proclamation: choose another player to gain the \"Proclamation\" mark (if it is already in play, the mark moves to that player)",
  ...
  ["#wuling-choice"] = "Five Beasts: choose the order in which to teach %dest the Five Animal Frolics<br>Chosen so far: %arg",
  ...
  ["#xiaoni"] = "Insolence: you can spend Mandate points (they can drop below zero) to use a card as a damage card!",
  ...
  ["#xing__yishi-invoke"] = "Righteous Release: reduce the damage dealt to %dest by 1 and obtain a card from their equip area?",
  ...
  ["#xinghun-choose"] = "Star Soul: make 1 player choose the cards to show, then you use the Slash among them against them",
  ["#xinghun-choosecard"] = "Star Soul: choose 5 cards from the top of the draw pile and %src's hand cards to show; the Slash among them will be used against you",
  ...
  ["#xiongjinAnother-invoke"] = "Bold Advance: you can make %dest draw %arg cards; at the start of their Discard phase this turn they discard all their basic cards",
  ["#xiongjinUser-invoke"] = "Bold Advance: you can draw %arg cards, and at the start of your Discard phase this turn you discard all your non-basic cards",
  ...
  ["#xiongtus"] = "Vicious Scheme: show a player's hand card, then choose to discard that card, or to discard cards and deal damage to them",
  ["#xiongtus-damage"] = "Vicious Scheme: click OK to deal 1 damage to %dest, or click Cancel to discard the card they showed",
  ["#xiongtus-discard"] = "Vicious Scheme: discard %arg cards to deal 1 damage to %dest, or click Cancel to discard the card they showed",
  ["#xiongtus_1_active"] = "Vicious Scheme",
  ["#xiongtus_2_trig"] = "Vicious Scheme",
  ["#xiongzi-invoke"] = "Majestic Bearing: you can restrict your other skills to a single fixed option usable only during your turn, then draw 2 cards",
  ["#xiongzi_1_trig"] = "Majestic Bearing",
  ["#xiugeng-choose"] = "Tend the Fields: you can record the hand card count of up to two players, and those players will draw cards or gain hand limit",
  ["#xiugeng_1_trig"] = "Tend the Fields",
  ["#xiugeng_2_trig"] = "Tend the Fields",
  ["#xizhan-invoke"] = "Playful Skirmish: on %dest's turn, discard a card and carry out the effect matching its suit, or click Cancel to lose 1 HP",
  ...
  ["#xuye-invoke"] = "Foster Growth: you can make %dest draw two cards, then if they have the most hand cards in play, you place a card from their area on top of the draw pile",
  ["#xuye_1_trig"] = "Foster Growth",
  ["#yajun-invoke"] = "Noble Bearing: you can start a point fight with another player using a card you obtained this turn",
  ...
  ["#yangjie"] = "Feigned Relief: you can start a point fight; if you do not win, you can make another player count as using a fire Slash on the player you fought points with",
  ...
  ["#yanhui-choose"] = "Flame Eddy: you can deal 1 fire damage to an eligible player, or cancel to draw %arg cards instead",
  ...
  ["#yanji-invoke"] = "Strict Discipline: you can perform Rectify, and if it succeeds you gain a reward after your Discard phase ends",
  ...
  ["#yaohu-slash"] = "Invite the Tiger: you must use a Slash against %dest, or this phase, when you use a damage card targeting %src, you must give them cards",
  ["#yaohu_1_trig"] = "Invite the Tiger",
  ["#yaohu_2_trig"] = "Invite the Tiger",
  ["#yaohu_3_trig"] = "Invite the Tiger",
  ["#yichong-choose"] = "Shifting Favour: choose another player and obtain every card of that suit in their equip area plus one hand card of that suit",
  ...
  ["#yirang-choose"] = "Gracious Yielding: give all your non-basic cards to a player, raise your max HP to match theirs and recover HP",
  ["#yirang_1_trig"] = "Gracious Yielding",
  ["#yixiang_1_trig"] = "Righteous Aid",
  ["#yixing"] = "Shifting Form: put all Gear cards into the discard pile and draw that many cards, then you can place any number of equip cards as Gear",
  ...
  ["#yizan1"] = "Loyal Support: you can use or play two cards (at least one of which is a basic card) as any basic card",
  ...
  ["#youyi"] = "Wandering Physician: you can remove every card from the Benevolence pile to make all players recover 1 HP",
  ...
  ["#yueyuan-active"] = "Leap from the Deep: you can draw %arg cards, then clear one suit recorded by your Hidden Blade",
  ...
  ["#zaoli-discard"] = "Restless Rage: choose at least one card; you discard those cards and all Rage, then draw the same number of cards",
  ...
  ["#zhanshi-invoke"] = "Survey the Field: discard any number of cards and choose that many players in the point fight; you draw three cards for each chosen player who wins",
  ...
  ["#zhaoxin"] = "Manifest Intent: you can place any number of cards as 'Ambition' and draw the same number of cards (at most three 'Ambition')",
  ["#zhaoxin-choose"] = "Manifest Intent: choose one 'Ambition' of %src to obtain",
  ["#zhaoxin-damage"] = "Manifest Intent: deal 1 damage to %dest?",
  ["#zhaoxin-get"] = "Manifest Intent: you can choose one 'Ambition' of %src to obtain, then they can deal 1 damage to you",
  ...
  ["#zhengjun-invoke"] = "Muster: you can perform Discipline; if it succeeds, you gain the reward after your Discard phase ends, and you can make another player gain the reward",
  ...
  ["#zhengpeng-choose"] = "Drifting Tumbleweed: you can choose a player and lose %arg HP, then draw the corresponding number of cards",
  ["#zhengpeng_1_trig"] = "Drifting Tumbleweed",
  ["#zhengshuo"] = "Rightful Calendar: make all players discard all their hand cards, reshuffle, then each draw four cards",
  ["#zhengshuo_1_active"] = "Rightful Calendar",
  ["#zhengxuan"] = "All Learning Gathered, the Way Made Clear",
  ["#zhenji"] = "The Ill-Fated Beauty",
  ["#zhenjun-choose"] = "Steady the Army: give a card to another player; they choose either to use a Slash or to let you deal damage",
  ...
  ["#zhijie-invoke"] = "Wise Counsel: you can show one of %dest's hand cards; when they use a card of the same type this phase they will draw and discard",
  ["#zhijie_1_trig"] = "Wise Counsel",
  ["#zhijie_2_trig"] = "Wise Counsel",
  ["#zhijie_3_trig"] = "Wise Counsel",
  ["#zhilve"] = "Strategic Insight: lose 1 HP to increase your hand limit this turn by 1, then carry out an option",
  ["#zhilve_1_active"] = "Strategic Insight",
  ["#zhimeng-choose"] = "Wise Alliance: you can choose a player and split your hand cards evenly at random with them",
  ...
  ["#zhoulin"] = "Cursed Scales: you can gain 2 Shield and choose one Beast Arts effect that always happens until the start of your next turn",
  ["#zhoulin_1_active"] = "Cursed Scales",
  ["#zhoulin_2_trig"] = "Cursed Scales",
  ["#zhouqun"] = "The Latter Sage",
  ["#zhouxian-discard"] = "Provincial Sage: discard a card of a type that appears among the revealed cards, otherwise %dest is removed as a target of %arg",
  ["#zhouxian_1_trig"] = "Provincial Sage",
  ["#zhouyu"] = "Grand Commander",
  ["#zhuangshi-discard"] = "Valiant Oath: you can discard at least one hand card to make that many of the first cards you use this phase ignore distance and be unable to be responded to",
  ["#zhuangshi-loseHp"] = "Valiant Oath: you can lose at least 1 HP to make that many of the first cards you use this phase not count toward use limits",
  ...
  ["#zhuguo"] = "Aid the State: make a player adjust their hand to their max HP (at most 5) and resolve the effect",
  ["#zhuguo-choose"] = "Aid the State: choose another player; %dest can use a Slash against them",
  ["#zhuguo-use"] = "Aid the State: you can use a Slash against %dest with no distance restriction and no limit on the number of uses",
  ["#zhuguo_1_active"] = "Aid the State",
  ["#zhujian"] = "Build the Fleet: make at least two players who have cards in their equip area each draw a card",
  ["#zhujian_1_active"] = "Build the Fleet",
  ["#zhujic"] = "Heir to the Family Craft",
  ["#zhujis-invoke"] = "Build Ramparts: you can discard your hand cards of one suit, then obtain and use an equip card of that suit from the draw pile",
  ...
  ["#zundi"] = "Honor the Heir: discard a hand card and choose a player, then you judge; on black they draw three cards, on red they can move a card on the field",
  ...
  ["$bihuoy2"] = "Better to join another and hold him off first, then submit - your merit will be far greater.",
  ...
  ["$bingfa4"] = "Cheapen the rewards and the loyal slacken; pardon the punishments and the treacherous grow bold.",
  ...
  ["$buxu1"] = "Vulgar scholars twist the texts; unless they are mended they will mislead all who come after.",
  ["$buxu2"] = "The classics are far from the sages and thick with errors - the Six Classics must be set right.",
  ...
  ["$daozhuan2"] = "You who would repay Heaven and earth and win long life -- believe in the Dao, and never slacken.",
  ...
  ["$gongmou2"] = "My king, hold the six armies back to show your strength in reserve - why ride out yourself for fear of defeat?",
  ...
  ["$guimou2"] = "Chickens tied together cannot roost as one; follow Gui's plan and they come apart one by one.",
  ...
  ["$gushe1"] = "You know the Mandate and you know the times - why raise a nameless army against our borders?",
  ["$gushe2"] = "Lay down your arms, surrender with honour, and you keep your marquisate. The state at peace, the people glad - would that not be fine?",
  ...
  ["$huantu1"] = "With warlords swarming, my lord should draw in and hold back - be not the first to court disaster.",
  ...
  ["$jilim2"] = "Since I pledged myself my offences have piled like mountains, yet I rest easy - how much more should my lord!",
  ...
  ["$juguz2"] = "The Yuans are lawless and their designs are treason - how could Hong betray the state to serve a traitor?",
  ...
  ["$liezhiz1"] = "The royal house is in peril and the traitor's head still on his shoulders - now is the hour to repay it with our lives.",
  ["$liezhiz2"] = "Han is stricken and the imperial order broken - gather the righteous host and march to save the state.",
  ...
  ["$luanqun2"] = "I hold an office of prudence, and I have read and heard much - all the more reason to speak my nature!",
  ...
  ["$m_ex__beige2"] = "The second stanza, the string drawn near to breaking; will crushed, heart broken, I sigh for myself.",
  ...
  ["$m_ex__benxi3"] = "My robe stained with the sunset of Yong and Liang, my horse across the last snows of Mount Qi!",
  ...
  ["$m_ex__duanliang1"] = "Their grain has not been hauled three times over - they have broken the great rule of the march.",
  ...
  ["$m_ex__liangyin4"] = "Nothing higher or brighter than sun and moon; nothing closer or more distant than husband and wife.",
  ["$m_ex__lianhuan1"] = "Too many generals, too many men to meet head on - let them chain themselves, and their momentum dies.",
  ["$m_ex__lianhuan2"] = "The good commander guards against loss even in cleverness, and plans for the turn mid-course.",
  ...
  ["$m_ex__wurong3"] = "If the tribes will not be won over, then civilising them never reached them - the fault is Yi's own.",
  ...
  ["$m_ex__xingshang1"] = "The swallows leave and the swans fly south; I think of you wandering far, and my heart breaks.",
  ...
  ["$m_ex__yaoming1"] = "The mountain turns away no grain of dust, and so it towers; the sea refuses no water, and so it runs deep.",
  ...
  ["$m_js__shelun4"] = "If this rebel host is not put to the sword, how shall the loyal men of the east be comforted!",
  ...
  ["$mobile__fengji2"] = "Care for the old, raise the orphans, treat the people as if wounded - so Xuzhou grows rich and settled.",
  ...
  ["$mobile__yinju1"] = "To strike Wu is to raise armies, exhaust the people, and gain nothing. I beg Your Majesty, think again!",
  ["$mobile__yinju2"] = "Now is the time to farm the garrisons and rest the troops, and take Wu and Shu slowly. Why rush headlong?",
  ...
  ["$shouyuez2"] = "Hear it and forget your cares, practise it and nourish your nature - a treasure for the cultivated self.",
  ["$shuanghuai1"] = "A woman keeps her honour: sooner the orchid broken and the jade snapped than a promise betrayed.",
  ["$shuanghuai2"] = "Humility is the handle of virtue; compliance, the conduct of a wife.",
  ["$shuanghuai3"] = "Yan Hui was prized for mending his faults, and Confucius praised him for never repeating them - shall a woman do less?",
  ...
  ["$suwang"] = "Long Renown",
  ["$suwang1"] = "With the state well ruled and its officers at peace, the people turn to virtue of themselves.",
  ...
  ["$xinghun1"] = "I look up to Ziwei and read the rise and fall; I look down, and the general's star lights my armour.",
  ...
  ["$xiugeng2"] = "Survey the soil, settle the people, count them and post officers -- so the garrison farms will thrive.",
  ...
  ["$yajun2"] = "Not one word of your benevolence yet - and already the schemes and the soldiers come first!",
  ...
  ["$yangjie2"] = "Feign lifting the siege, then strike them outside the walls - that is the easy way to break them!",
  ...
  ["$yiji1"] = "Very well.",
  ["$yiji2"] = "Enough of it.",
  ["$yijie1"] = "The Commentary says an army wins by harmony, not by numbers - when heaven and earth accord, all things are born.",
  ...
  ["$zhijie1"] = "Of old, Zihan would not call jade a treasure, and the Spring and Autumn Annals praised him for it.",
  ...
  [":anda"] = "Once per round, when a player enters the dying state, you can make the damage source choose one: 1. give them two cards of different colours; 2. that player recovers 1 HP.",
  [":anxianc"] = "After you discard hand cards for the first time each turn, you can obtain and use one Slash among them; this Slash does not count toward the use limit and has no distance or use restriction.",
  [":aocai"] = "When you need to use or play a basic card outside your turn, you can look at the top two cards of the draw pile and use or play the one you need from among them.",
  [":aosi"] = "(forced) After you deal damage in your Action phase to another player within your ATK range, you use cards on them this phase with no limit on the number of uses.",
  ...
  [":baoxi"] = "Once per round for each, after at least two basic cards enter the discard pile at once, you can lose 1 max HP and use a hand card as a Duel; after at least two non-basic cards enter the discard pile at once, you can lose 1 max HP and use a hand card as a Slash that does not count toward your limit and has no limit on the number of uses.",
  [":beiming"] = "At the start of the game, you can make up to two players each randomly obtain from the draw pile a weapon card whose ATK range is X (X is the number of suits among that player's hand cards).",
  [":beizhu"] = "Once per Action phase, you can look at another player's hand cards. If there are Slashes among them, they use those Slashes on you one after another (after you take damage from a Slash used this way, you draw a card); otherwise you discard a card from them and can make them obtain a Slash from the draw pile.",
  [":bifeng"] = "When you become the target of a basic card or a normal trick card, if the number of its targets is no more than 4, you can cancel it. If you do, after this card finishes resolving, if no other player responded to this card, you lose 1 HP; otherwise you draw two cards.",
  [":bihan"] = "When a player is about to take damage from a Slash, you can make yourself or them discard hand cards down to their current HP, making that Slash's damage -1.",
  [":bihuoy"] = "(once per game) When a player leaves the dying state, you can make them draw three cards, then this round, when players other than them calculate their distance to them, it is +X (X is the number of players in play).",
  [":biluan"] = "At the start of your Draw phase, if a player's distance to you is 1, you can give up drawing cards to make other players' distance to you increase by X (X is the number of surviving kingdoms).",
  [":binghuo"] = "At a player's Finish phase, if you used Gather Troops this turn to use or play a Troop, you can make a player perform a judgement; if the result is black, you deal 1 thunder damage to them.",
  [":binglun"] = "Once per Action phase, you can remove a Benevolence card and make a player choose one: 1. draw a card; 2. recover 1 HP at the end of their next turn.",
  [":bingqing"] = "When you use a card during your Action phase, if its suit differs from the suit of every card you have used this phase, you record that suit. After this card finishes resolving, according to the number of suits recorded this phase, you can perform the corresponding effect:<br>two suits, make a player draw two cards;<br>three suits, discard a card from a player's area;<br>four suits, deal 1 damage to another player.",
  [":biwei"] = "Once per Action phase, you can discard a hand card with the unique highest number and choose another player, making them discard all hand cards with a number not less than that card. If they did not discard any card this way, reset this skill.",
  [":bixian"] = "(forced) At the end of a phase in which you were the target of a card and your HP did not change, it counts as you using a Duel.",
  ...
  [":bojian"] = "(forced) At the end of your Action phase, if both the number of cards and the number of suits you used this phase differ from those of your previous Action phase, you draw two cards; otherwise you choose one card you used this phase from the discard pile and give it to a player.",
  [":buqi"] = "(forced) When a player enters the dying state, you remove two \"Benevolence\" cards and make them recover 1 HP. After a player dies, you remove all \"Benevolence\" cards.",
  [":buxu"] = "In your Action phase, if you have the skill Inheritance, you can discard X cards and choose one of your missing <a href='chengye_href'>Six Classics</a>, then randomly obtain from the draw pile or the discard pile a card corresponding to that Classic and add it to your Classics (X is the number of times you have already successfully used this skill this phase +1).",
  [":caiqiu"] = "At the start of each round, you look at the top X cards of the draw pile (X is the number of players in the game), then you can obtain at least one of them. If you do, after another player finishes resolving a card they use this round, if that card shares a name with a card you obtained this way, you lose 1 HP.",
  [":cangjia"] = "(forced) After you obtain a card outside your Action phase, record that card's suit; during your Action phase you cannot use cards of a suit this skill has not recorded.",
  [":canshi"] = "In your Draw phase, you can instead draw X cards (X is the number of wounded players); then, when you use a basic card or a normal trick card this turn, you discard a card.",
  [":caowei"] = "(forced) After you take damage, you recast all of your cards of at least one card type and draw a card.",
  ...
  [":changshi__chihe"] = "After you use a Slash and designate it at a single target, you can reveal the top two cards of the draw pile; that target cannot use cards of the same suit as the revealed cards to respond to this Slash, and for each revealed card whose suit matches this Slash's suit, this Slash's base damage +1.",
  [":changshi__chiyan"] = "After you use a Slash and designate its targets, you can place one card of a target face down next to their character card, and that player obtains this card at the end of this turn; when a Slash you use deals damage to a target player whose hand card count and equip area card count are both not greater than yours, this damage +1.",
  ...
  [":changshi__kuiji"] = "Once per Action phase, you can look at another player's hand cards and discard a total of four cards of four different suits from your hand cards and theirs.",
  [":changshi__lisong-specificSkillDesc"] = "Spy the Moment: (Soul Raid)",
  [":changshi__miaoyu"] = "You can use or play up to two cards of the same suit according to the following rules: <font color='red'>♥</font> as Peach, <font color='red'>♦</font> as a fire Slash, ♣ as Dodge, ♠ as Nullification. If you use or play two cards this way: <font color='red'>♥</font> cards, this card's base recovery is increased by 1; <font color='red'>♦</font> cards, this card's base damage is increased by 1; black cards, you discard a card from the current turn player.",
  ...
  [":changshi__xiaolu"] = "Once per Action phase, you can draw two cards, then choose one: 1. discard two hand cards; 2. give two hand cards to another player.",
  [":changshi__xiayun-specificSkillDesc"] = "Slander: (Righteous Contest)",
  [":changshi__yaozhuo"] = "Once per Action phase, you can start a point fight with a player. If you: win, skip their next Draw phase; do not win: you discard two cards.",
  [":changshi__zhangrang-specificSkillDesc"] = "Tide of Chaos: (Tide of Chaos)",
  [":changshi__zimou"] = "(forced) When you use, during your Action phase: your second card, you randomly obtain an Alcohol; your fourth card, you randomly obtain a Slash; your sixth card, you randomly obtain a Duel.",
  ...
  [":chengxiong"] = "After you use a trick card that targets only other players, you can choose a player whose card count is not less than X (X is the number of cards you have used this phase), discard a card from them, and if that card's colour is the same as the colour of the trick card you used, you deal 1 damage to them.",
  [":chengye"] = "(forced) After another player finishes using a non-converted card, or after an equip card or delayed trick card in another player's area enters the discard pile, if the corresponding one of your <a href='chengye_href'>Six Classics</a> is missing, you put this card on your character card, called a Classic; at the start of your Action phase, if none of your Six Classics is missing, you obtain all Classics.",
  [":chengzhang"] = "(awaken) In your Prepare phase, if the total of the damage you have dealt and the damage you have taken is 7 or more, you recover 1 HP and draw 1 card, then modify Wine Poetry (the effect that obtains a trick card is changed to trigger after you turn your character card over).",
  [":chengzhao"] = "In a player's Finish phase, if you have obtained at least two cards this turn, you can start a point fight with another player; if you win, it counts as you using a Slash on them that ignores armor.",
  [":chenshe"] = "When another player enters the dying state, you can discard, in order, one card each from you, them and the damage source; if all these players had a card discarded this way and all of the suits are the same, they recover HP up to their max HP, then you lose this skill.",
  [":chitu"] = "Chi Tu (equip card, horse)<br /><b>Horse skill</b>: The distance from you to other players is reduced by -1.",
  [":chiyuanc"] = "The first Slash you use each turn has no distance restriction and requires one extra Dodge to respond to it; once per Action phase, you can draw X cards (X is the number of red cards in the current consecutive run of cards used).",
  [":chiyun"] = "After you obtain cards for the first time in each phase, you can give at least one hand card to another player, and they choose one: 1. they show all hand cards of the same colour as those cards, and you deal 1 fire damage to them; 2. you draw two cards, and they become chained.",
  [":chizhang"] = "You use damage-dealing cards with no distance restriction; after you use a damage-dealing card from your hand other than Lightning and choose the first target, you can discard at least one hand card to make other players unable to use or play cards of the same color as the cards you discarded this way to respond to that card.",
  [":chongcha"] = "Your cards with a number of 10 or more do not count toward your hand limit, and when used they are treated as matching the number 0 in \"Circle Cutting\"; once per Action phase, if you have the skill \"Circle Cutting\", you can discard a card to adjust the X in \"Circle Cutting\" to the value of the next digit.",
  [":chongjian"] = "(kingdom) Wu, you can use an equip card as Alcohol, or as any kind of Slash with no distance restriction that ignores armor. After a Slash you used this way deals damage to a player, you obtain X cards from their equip area (X is the damage dealt).",
  [":chonglei"] = "(forced) During your Action phase, all other players' non-basic hand cards can only be used or played as Dodge; up to X times per Action phase (X is the number of other players), after a card you use is responded to by another player, or after you respond to a card used by another player, you obtain a hand card from that player.",
  [":chongsi"] = "In your Action phase, if you have not chosen the last option during this phase, you can choose another player and choose one option, then they also choose one option: 1. use a Slash; 2. discard two hand cards; 3. deal 1 damage to yourself or to the player equipped with Six Dragon Chariot.",
  [":chouhai"] = "(forced) When you take damage, if you have no hand cards, you make this damage +1.",
  [":choulue"] = "At the start of your Action phase, you can make another player choose whether to give you a card; if they do, you can count as using the last card that dealt damage to you other than a delayed trick card.",
  [":choumang"] = "Once per turn, after you use a Slash that has only one target, or after you become the only target of a Slash, you can choose one option: 1. this Slash's damage +1; 2. after this Slash is countered, you can obtain a card from the area of another player within distance 1 of you. Desperate Stand: discard the weapon cards in your equip area and in theirs (you can only choose this if you or they have a weapon card in the equip area).",
  [":chuhai"] = "(mission) Once per Action phase, you can draw a card and point fight with another player; for this point fight the number of your point fight card is increased by X (X is 4 minus the number of equips in your equip area). If you win: you look at their hand, and randomly obtain from the draw pile or the discard pile one card of each card type present in their hand; after you deal damage to them during this phase, put an equip card from the draw pile or the discard pile whose type matches one of your empty equip slots into your corresponding equip area.<br>\n  ⬤ Success: after an equip card enters your equip area, if there are no fewer than 3 equips in your equip area, you recover HP up to your max HP, gain Renown and lose Village Scourge.<br>\n  ⬤ Failure: if, before the mission is achieved, you point fight with Slay the Scourge and do not win, and your point fight result is not greater than 6, the mission fails.",
  [":chuifeng"] = "(kingdom) Wei, twice per Action phase, you can lose 1 HP, and it counts as using a Duel. When you take damage caused by a Duel used this way, prevent this damage, and this skill has no effect for the rest of this phase.",
  ...
  [":cuijin"] = "When you or a player in your ATK range uses a Slash, you can discard a card to make this Slash's base damage +1. After this Slash finishes resolving, if it has dealt no damage, you draw a card and deal 1 damage to its user.",
  [":cuijun__gongli"] = "(forced) At the start of the game, you add X triggering suits to Effortless Flow (X is the number of Friend characters in play).",
  [":cuizhen"] = "At the start of the game, you can choose up to three other players and disable their weapon slots; after you use a Slash or a damage trick card during your Action phase and choose another player as a target, if their number of hand cards is not less than their HP, you can disable their weapon slot; in your Draw phase, you draw X extra cards (X is the number of disabled weapon slots in play +1, at most 3).",
  ...
  [":daigong"] = "Once per turn, when you take damage, you can show all your hand cards to make the damage source choose one: 1. give you a card whose suit is different from every card you showed this way; 2. prevent this damage.",
  [":daizui"] = "(once per game) When you would take fatal damage, you can prevent this damage, then place the card that dealt the damage to you on the damage source's character card, called \"Absolution\". At the end of this turn, they obtain their \"Absolution\".",
  [":damage_maker"] = "In your action phase, you can run the damage maker once.",
  [":daming"] = "1. At the start of the game, you gain 1 Mandate point. 2. Once per Action phase of another player, they can give you a card, then you choose another player. If the latter has a card of the same type, the latter must give the former a card of the same type and you gain 1 Mandate point; otherwise you give the card you obtained this way to the former.",
  [":daming_other&"] = "Once per Action phase, you can give Peng Yang a card, then he chooses another player. If that player has a card of the same type, that player must give you a card of the same type and Peng Yang gains 1 Mandate point; otherwise Peng Yang gives the card he obtained back to you.",
  [":danggu"] = "(forced) At the start of the game, you obtain ten different Attendant cards, then you perform one Faction Forming (randomly show one Attendant card, then randomly show four Attendant cards; from those you choose one that is mutually compatible with the Attendant card shown first, and those two form a dual character); after you return to the game from recuperation, you perform one Faction Forming and draw a card.",
  [":dangshi"] = "After a damage card you use finishes resolving, you can make one of its other target players choose one: 1. discard X cards (X is the number of times players have chosen this option this round, at least 1); 2. you deal 1 damage to them.",
  [":daoji"] = "Once per Action phase, you can discard a non-basic card and choose another player with cards in their equip area; you obtain one card from their equip area and use it. If the card you obtain this way is a weapon card, you then deal 1 damage to them.",
  [":daozhuan"] = "Once per turn, when you need to use a basic card (once per card name per round), you can put a card from you or the current turn player into the discard pile, and this counts as using that basic card. If the current turn player lost a card this way, this skill is disabled for the rest of this round.",
  [":dayuan"] = "Da Yuan (equip card, horse)<br /><b>Horse skill</b>: The distance from you to other players is reduced by -1.",
  [":debao"] = "(forced) After another player obtains your cards, if the number of \"Benevolence\" cards is less than your max HP, you place the top card of the draw pile as a \"Benevolence\". In your Prepare phase, you obtain all \"Benevolence\" cards.",
  [":defensive_horse__xianjian"] = "This is a \"Pierce the Line\" defensive horse.",
  [":defensive_siege_engine"] = "Equip card - Weapon<br/><b>ATK range</b>: 9<br/><b>Durability</b>: 3<br/><b>Weapon skill</b>: After this card enters your equip area, discard the other cards in your equip area; before another equip card would enter your equip area, it is put into the discard pile instead; when you take damage, this card loses that much Durability (all of it if there is not enough), and this damage is reduced by X (X is the Durability lost); when this card would leave your equip area for a reason other than \"Siege Works\", prevent it, then this card loses 1 Durability; when this card's Durability drops to 0, destroy this card.",
  [":dengli"] = "After you use a Slash and choose another player as a target, or after you become the target of a Slash used by another player, if your HP is equal to theirs, you can draw a card.",
  [":dieyin"] = "Once per Action phase, you can turn your character card face down and choose a phase; you perform this extra phase after the current phase ends.",
  [":difei"] = "(forced) Once per turn, after you take damage, you draw a card or discard a hand card, then you show all your hand cards; if the card that dealt damage to you has no suit, or none of your hand cards has the same suit as the card that dealt damage to you, you recover 1 HP.",
  [":dilu"] = "Di Lu (equip card, horse)<br /><b>Horse skill</b>: The distance from other players to you is increased by +1.",
  [":dinghan"] = "When you become the target of a trick card, if that card's name has not been recorded, record that card name, then cancel this target; at the start of your turn, you can add or remove the record of one trick card name.",
  [":dingyi"] = "(forced) At the start of the game, you choose one option to apply to every player: 1. they draw 1 extra card in their Draw phase; 2. their hand limit +2; 3. their ATK range +1; 4. when they leave the dying state, they recover 1 HP.",
  [":dingzhen"] = "At the start of each round, you can make up to X other players within distance X of you choose one in turn (X is your current HP): 1. discard a Slash; 2. this round, trick cards they use during their turn cannot target you.",
  [":dingzhou"] = "Once per Action phase, you can choose another player and give them X cards (X is the number of cards they have on the field), then you obtain all of their cards on the field.",
  ...
  [":duanbi"] = "(once per game) In your Action phase, if the total hand size of all players is greater than twice the number of living players, you can make every other player discard X hand cards (X is half their hand size, rounded down, up to 3); then you can choose a player and give them three random cards discarded this way.",
  [":duanjin"] = "After a basic card you use finishes resolving, you can discard a card from another player who has used a card this turn.",
  [":duansuo"] = "Once per Action phase, you can unchain at least one player, then deal 1 fire damage to each of those players.",
  [":duanyang"] = "Once per turn, after your hand cards enter the discard pile other than by being used, you can put a random Slash among them onto your character card and use it at the end of this phase (with no limit on the number of uses). After a Slash you use this way deals damage, you can recast up to two cards in the damaged player's area, then you draw four cards.",
  ...
  [":dujin"] = "In your Draw phase, you can draw X+1 extra cards (X is half the number of cards in your equip area, rounded down).",
  [":dulie"] = "(forced) When you become the target of a Slash used by a player whose HP is greater than yours, you judge; if the result is <font color='red'>♥</font>, cancel it.",
  [":dummyskill"] = "No effect.",
  [":duohui"] = "At the start of another player's Prepare phase, they can give you a card, then you choose one:<br>1. give them another card of the same suit;<br>2. make them draw a card.",
  [":duoji"] = "(once per game) During your Action phase, you can discard two hand cards and obtain all cards in another player's equip area.",
  [":duwu"] = "During your Action phase, you can discard X cards and deal 1 damage to another player within your ATK range (X is that player's HP). If they enter the dying state because of this, after the dying state is resolved you lose 1 HP and this skill is invalid for the rest of this turn.",
  [":duzuo"] = "After you obtain a card other than through this skill, you can make a player obtain a fire Slash.",
  ...
  [":ex__leiji"] = "After you use or play a Dodge, you can make another player make one judgement; if the result is: ♠, you deal 2 thunder damage to them; ♣, you recover 1 HP and deal 1 thunder damage to them.",
  [":ex_crossbow"] = "Equip card - Weapon<br/><b>ATK range</b>: 3<br/><b>Weapon skill</b>: (forced) You can use Slash during your Action phase with no limit on the number of uses.",
  [":ex_eight_diagram"] = "Equip card - Armor<br/><b>Armor skill</b>: When you need to use or play a Dodge, you can make a judgement: if the result is not ♠, it counts as you using or playing a Dodge.",
  [":ex_nihilo"] = "Ex Nihilo (trick card)<br /><b>Phase</b>: Action phase<br /><b>Target</b>: Yourself<br /><b>Effect</b>: The target draws 2 cards.",
  [":ex_nioh_shield"] = "Equip card - Armor<br/><b>Armor skill</b>: (forced) Black Slash and <font color='red'>♥</font> Slash have no effect on you.",
  [":ex_silver_lion"] = "Equip card - Armor<br/><b>Armor skill</b>: (forced) When you take damage, if this damage is greater than 1, prevent the excess damage. After you lose the Moonlit Lion Helm from your equip area, you recover 1 HP and draw two cards.",
  [":ex_vine"] = "Equip card - Armor<br/><b>Armor skill</b>: (forced) Savage Assault, Archery Attack and normal Slash have no effect on you. You cannot be chained. When you take fire damage, this damage is increased by 1.",
  [":fan"] = "Fan (equip card, weapon)<br /><b>ATK range</b>: 4<br /><b>Weapon skill</b>: You can use any basic Slash as Fire Slash.",
  [":fangqiu"] = "(once per game) After you carry out \"Sleeping Dragon's Stratagem\", you can show your \"Sleeping Dragon's Stratagem\" predictions. If you do, after all predictions of this \"Sleeping Dragon's Stratagem\" are verified, the values of the effects carried out are each increased by 1; if the number of predicted cards is greater than 3 and all of them are correct, reset this skill.",
  [":fangzong"] = "(forced) During your Action phase, damage-dealing cards you use cannot choose players within your ATK range as targets; other players whose ATK range contains you cannot choose you as the target of damage-dealing cards they use. In your Finish phase, you draw until you have X hand cards (X is the number of players alive).",
  ...
  [":feijing"] = "You can use or play a damage trick card as a Slash; twice per turn, when you use a Slash and choose only one target, you can make all the players on one <a href='#PathDesc'>path</a> between you and that player simultaneously show a hand card and then discard it one by one, then you can choose a colour and the players who discarded a card of that colour become extra targets of this Slash.",
  [":feili"] = "When you take damage, if you have Slanderous Plot, you can discard two cards to prevent this damage; if the damage source has the \"Slander\" mark, you can instead remove that mark to prevent this damage, then you draw two cards and cannot use Slanderous Plot on them for the rest of the game.",
  [":fengjie"] = "(forced) In your Prepare phase, you choose another player; until the start of your next turn, in each player's Finish phase, if the player you chose is alive, you draw or discard until your hand size equals that player's HP (drawing to at most four cards).",
  [":fentao"] = "(forced) When another player in the chained state takes fire damage, they choose one: 1. the damage in this chain transmission +1; 2. they discard half of their cards (rounded up), and after this damage resolves they become chained.",
  [":fenyin"] = "During your turn, when you use a card of a different colour from the previous card, you can draw a card.",
  ...
  [":friend__manjuan"] = "Up to five times each round, after you obtain at least two cards at once other than through this skill, you can put any number of those cards on top of the draw pile in any order. If you do, for each card you place there you obtain a random card from the discard pile of a different type from it (up to five cards each time).",
  [":friend__yangming"] = "At the end of your Action phase, if you lost at least three hand cards this phase, you can reveal the top X cards of the draw pile (X is the number of suits among the cards that entered the discard pile this turn) and use any number of them, all of different suits (with no limit on the number of uses).",
  [":fubi"] = "Once per Action phase, you can choose a player who has the Ordained Rites effect and choose one option: 1. change their Ordained Rites effect; 2. discard a card, and until the start of your next turn their Ordained Rites effect is doubled.",
  [":fuhai"] = "(forced) After you use a card and choose a player who has a Pacify mark as a target, they cannot respond to this card and you draw a card (you draw at most two cards this way each turn); when a player who has a Pacify mark dies, you gain X max HP and draw X cards (X is their number of Pacify marks).",
  [":fujiy"] = "Once per Action phase, you can show and give one card each to any number of other players; these cards are called Talisman cards.<br>When a player uses a Talisman card, they obtain a card of the same suit as that Talisman card. If the Talisman card is a Slash, that Slash's base damage is increased by 1; if it is a Dodge, the user draws a card after it resolves.<br>If your hand size is the lowest in play after you give out cards with this skill, you draw a card, and the first Slash and the first Dodge you use carry the Talisman card effects above until the start of your next turn.",
  [":fuman"] = "Once per Action phase for each player, you can give a Slash to another player; then when they use that Pacify the Tribes card before the end of their next turn, you draw a card.",
  [":futu"] = "At the end of each turn, if during that turn you: dealt the most damage, you place the first black card from the top of the draw pile on your character card, called Karma; healed the most HP for players, you place the first red card from the top of the draw pile as Karma. When you take damage, you can remove a Karma to prevent it.",
  [":fuyu"] = "Once per turn for each, when you become the only target of a basic card or ordinary trick card used by another player, or when you use a basic card or ordinary trick card whose only target is another player, you can point fight with them; if the user of that card wins, the card resolves one extra time; if the user does not win, the card has no effect. If your point fight result is the same as the last time you triggered this skill, you draw two cards.",
  [":gaigong"] = "Once per turn, after you deal damage to another player or take damage dealt by another player, you can show up to two hand cards of yours or of that player and swap them with the same number of cards from the bottom of the draw pile; if the swapped cards contain at least three suits, you can use one of those cards (with no limit on the number of uses and not counting toward the use limit).",
  [":ganggeng"] = "Once per Action phase, you can give at least two hand cards to another player. At the end of the turn, if their number of hand cards is the most among all players, you draw a card; if it is not the most, you discard a card from their area.",
  ...
  [":ganjue"] = "Once per Action phase, you can use a card from your equip area as a Slash that does not count toward the use limit and has no distance or use restriction. If the target player has no hand card of the same suit as that Slash, they cannot respond to that Slash.",
  [":gaoyuan"] = "When you become the target of a Slash used by a player, you can discard a card to transfer this Slash to another player with a Candid Recommendation mark.",
  [":gebo"] = "(forced) After a player heals HP, you put a card from the top of the draw pile into the <a href='RenPile_href'>\"Benevolence\" area</a>.",
  ...
  [":gonghuan"] = "(forced) Once per turn, when another player who has a \"Marriage\" mark takes damage, if their HP is less than yours, transfer this damage to you; then remove the \"Marriage\" marks of both players.",
  [":gongmou"] = "In your Prepare phase, you can exchange hand cards with another player. If you do, you gain the skill Wondrous Plan and they gain the skill See Through until the end of the turn.",
  [":guansha"] = "(once per game) At the end of your Action phase, you can replace all your cards with the same number of random basic cards from the draw pile; your hand limit is increased by X this turn (X is the number of distinct card names you obtained this way).",
  ...
  [":guanzong"] = "Once per Action phase, you can make another player <font color='red'>count as</font> dealing 1 damage to a second other player.",
  ...
  [":guimou"] = "(forced) At the start of the game you randomly choose one option, or at the end of your turn you choose one option: until the start of your next Prepare phase, 1. record the other player who has used the fewest cards; 2. record the other player who has discarded the fewest cards; 3. record the other player who has obtained the fewest cards. At the start of your Prepare phase, you choose one of the recorded players, view their hand cards and you can choose one of those cards, then discard it or give it to another player.",
  [":guli"] = "Once per Action phase, you can use all your hand cards as one Slash that ignores armor. After that card is settled, if it dealt damage, you can lose 1 HP, then draw cards until your hand size equals your max HP.",
  [":guose"] = "You can use any diamond card as Indulgence.",
  [":gushe"] = "Once per Action phase, you can use a hand card to start a point fight with up to three players at the same time, then resolve the point fight results one by one; each player who does not win chooses one: 1. discard a card; 2. make you draw a card. If the player who does not win the point fight is you, you must first gain a Prattle mark (when you have 7 Prattle marks, you die).",
  [":guying"] = "(forced) Once per turn, after you lose exactly one card at once outside your turn by using, playing or discarding it, the current turn player must choose one: 1. give you a random card; 2. you obtain that card (if it is an equip card, you use it). In your Prepare phase, you must discard X cards (X is the number of times this skill has been triggered), then reset this skill's trigger count.",
  ...
  [":hannan"] = "Once per Action phase, you can start a point fight with another player; the player who wins the point fight deals 1 damage to the player who does not win.",
  [":heji"] = "After a player finishes using a Duel or a red Slash that targets only one other player, you can use a Slash or Duel from your hand against the same target with no distance restriction and no limit on the number of uses. If the card you use is not a converted card, you obtain a random red card when you use this card.",
  [":hengwei"] = "(forced) When you deal damage to another player, they must show and give you a hand card, or this damage +1; during your turn, other players cannot use cards of the same colour as a card they have shown this turn.",
  [":hongyi"] = "Once per Action phase, you can choose another player; when they deal damage before the start of your next turn, they judge, and if the result is red, the damaged player draws a card; black, the damage is reduced by 1.",
  [":hongyic"] = "(forced) At the start of the game, you gain 2 Resolve markers; after you deal or take damage, you gain 1 Resolve marker; you can have at most 4 Resolve markers.<br>In your Prepare phase, you choose one option, and in the next Finish phase this turn you carry out the other: 1. draw X cards (X is your current number of Resolve markers); 2. discard all your Resolve markers.",
  [":houfeng"] = "Once per round, at the start of the Action phase of a player in your ATK range, you can make them <a href='zhengsu_desc'>Rectify</a>; you and they both gain the <a href='zhengsu_desc'>Rectify</a> reward.",
  [":huaibi"] = "(lord skill) (forced) Your hand limit +X (X is the number of players of the kingdom you chose with Invite the Tiger).",
  ...
  [":huanshiz"] = "(mission) The first Slash you use each turn deals +1 damage; while you are not dying you cannot use Alcohol, but you can recast it.<br />Success: after you deal or take damage, if the damage value equals your HP, you gain the skill <a href=':jianlv'>Broad Foresight</a>.",
  [":huantu"] = "Once per round, before the Draw phase of another player in your ATK range begins, you can give them a card to make them skip their Draw phase. If you do, at the Finish phase this turn you choose one: 1. make them recover 1 HP and draw two cards; 2. you draw three cards and give them two hand cards.",
  [":huishig"] = "(once per game) In your Action phase, you can choose a player. If they have an awaken skill that has not been triggered and your max HP is not less than the number of living players, you choose one of those skills and that player counts as meeting its awaken condition; otherwise they draw four cards. Finally you lose 2 max HP.",
  [":huitian"] = "At the end of the turn of a player whose HP is greater than yours, you can draw a card and take an extra turn. At the start of each round, if you have used this skill, you die.",
  [":huiyao"] = "Once per Action phase, you can take 1 damage with no source and choose another player; it <font color='red'>counts as</font> them dealing 1 damage to another player of your choice.",
  ...
  [":jianlv"] = "After you discard at least X cards at once (X is the number of times you have used this skill plus 1), you can deal 1 damage to another player. Then if they die, you choose one: 1. this skill is treated as never having been used; 2. deal 1 damage to another player.",
  [":jianxiong"] = "After you suffer DMG: you can take the card(s) that caused it.",
  [":jianyi"] = "(forced) At the end of another player's turn, if there is an armor card discarded this turn in the discard pile, you choose one of them and obtain it.",
  [":jianyu"] = "Once per round, in your Action phase, you can choose two players; until the start of your next turn, after either of these players uses a card during their Action phase that designates the other as a target, you make the target draw a card.",
  [":jianzhan"] = "Once per Action phase, you can make another player choose one option: 1. it counts as them using a Slash on another player of your choice who is within their ATK range and has fewer hand cards than them; 2. you draw a card.",
  [":jibing"] = "At the start of your Draw phase, if your number of Troops is less than X (X is the number of kingdoms in play), you can give up drawing and instead put the top two cards of the draw pile on your character card, called Troops. You can use or play a Troop as a normal Slash or a Dodge.",
  [":jichou"] = "Once per turn, you can count as using a regular trick card whose name has not been recorded and record that card name; you cannot use non-virtual cards of a recorded name, and cannot respond to cards of a recorded name; once per Action phase, you can give at least one card of a recorded name to another player.",
  [":jichou_give&"] = "<font color='grey'>Once per Action phase, you can give at least one card whose name has been recorded by Swift Scheme to a player.</font>",
  [":jici"] = "After your point fight card is revealed when you use Wagging Tongue, if its number is less than X, you can make its number +X; if its number equals X, you can make the number of times you can use Wagging Tongue this phase +1 (X is the number of your Prattle marks).",
  [":jiebian"] = "At the end of a player's Action phase, if no player has taken damage during that phase, you can start a point fight with the current turn player or with the player with the lowest HP (you can use a Karma for this point fight); if you win, choose one: 1. deal 1 damage to the player who did not win; 2. make the player who did not win recover 1 HP and draw a card, then obtain two of their cards.",
  [":jiebing"] = "(forced) After you take damage, you choose another player other than the damage source, obtain a random card from them and show it; if this card is an equip card, you use it.",
  [":jiejianw"] = "At your Prepare phase, you can give any number of hand cards to another player and make them gain the Loyal Remonstrance mark. Once per player's turn, when a player with the Loyal Remonstrance mark becomes the only target of a non-equip card used by another player, you can transfer this card to you, then draw a card. At the end of the turn of the player with the Loyal Remonstrance mark, remove their Loyal Remonstrance mark; if their HP is not less than their HP was when you gave them the cards, you draw two cards.",
  [":jiejie"] = "Once per Action phase of each player, the current turn player can let you look at their hand cards, then you can choose a suit. If their hand: contains that suit, they use cards of that suit this turn with no limit on the number of uses, then they discard their hand cards of the other suits; does not contain that suit, they randomly obtain a card of that suit from the draw pile or the discard pile. Twice per round, if the suit contained in the cards they let you look at this way this round is the unique most numerous suit, you count as using Discerning Eye on them once.",
  [":jiejie&"] = "Once per Action phase, you can let Momentum Xin Xianying look at your hand cards, then they can choose a suit. If your hand: contains that suit, you use cards of that suit this turn with no limit on the number of uses, then you discard your hand cards of the other suits; does not contain that suit, you obtain a card of that suit. If the suit contained in the cards you showed Momentum Xin Xianying this way is the unique most numerous this round, they count as using Discerning Eye on you once.",
  [":jieyin"] = "Once per Action Phase: you can discard 2 hand cards and select a hurt male character; then, both of you heal 1 HP.",
  [":jiezhu"] = "Once per turn, you can discard hand cards down to the closest lower hand card count that no player in play has; it counts as using a Slash with no distance restriction that targets up to X players (X is the number of cards discarded). After that Slash finishes resolving, if that Slash had X targets and dealt damage to all of them, you draw cards up to the closest higher hand card count that no player in play has.",
  [":jiguan"] = "(forced) At the start of the game, you remove all horse cards from the game; your hand limit +2.",
  ...
  [":jilim"] = "At the start of another player's turn, if they are in your ATK range, you can secretly choose a number from 0 to 2 that you have not chosen this round. If you do, at the start of the Finish phase of that turn, compare the number of times they have targeted you with cards this turn against X: if it is less than X, you draw 4-X cards; if it equals X, you give them X cards; if it is greater than X, you can count it as using a Slash against them with no distance restriction (X is the number you chose this time).",
  [":jilun"] = "After you take damage, if you have the skill Swift Scheme, you can choose one: 1. draw X cards (X is the number of card names recorded by Swift Scheme, at least 1 and at most 3); 2. count as using a basic card, or a regular trick card recorded by Swift Scheme whose number of targets is not more than X (once for each card name).",
  [":jimi"] = "(forced) At the start of the game, all players replace the cards in their hand that are not Peach or Alcohol with the same number of Peaches or Alcohols taken at random from the draw pile; after a Peach or an Alcohol enters the discard pile for a reason other than being used, you obtain a damage card whose name is X characters long (X is the number of Peaches and Alcohols that have entered the discard pile this turn).",
  [":jimie"] = "(once per game) At the end of your Action phase, you can lose 8 Thunder marks and deal damage to one player equal to their max HP. Then, once both effects of your Thunder Rein have been carried out, this skill can be used again.",
  [":jinfan"] = "At the start of your Discard phase, you can place any number of hand cards on your character card, called Bells (at most one of each suit); you can use or play Bells as if they were hand cards; when a Bell leaves your character card, you obtain a card of the same suit from the draw pile.",
  [":jingxie"] = "In your Action phase, you can show a Crossbow, Eight Diagram, Nioh Shield, Sliver Lion or Vine from your hand or your equip area, then upgrade that card;<br>When you enter the dying state, you can recast an armor card, then restore your HP to 1.",
  [":jingzhong"] = "At the end of your Discard phase, if you have discarded at least two black cards this phase, you can choose another player; up to three times during their next Action phase, after they finish using a card, you obtain it.",
  ...
  [":jinzu"] = "Once per Action phase, you can choose another player; you show one hand card and they simultaneously show two hand cards. If, among all the shown cards, the number of your shown card is: the middle value, the next Slash you use on them this turn deals 1 extra damage to them and they cannot respond to it; an extreme value, you discard all the shown cards. If you discarded cards this way, this skill can be triggered again.",
  [":jiren"] = "(once per game) In your Action phase, you can make all players unable to choose themselves as a target when using non-weapon cards for the rest of the game.",
  [":jiren_debuff_desc"] = "All players cannot choose themselves as a target when using non-weapon cards",
  [":jishi"] = "(forced) After a card you use finishes resolving, if it dealt no damage, put it into the <a href='RenPile_href'>Benevolence area</a>; after a Benevolence card leaves the Benevolence area for a reason other than overflow, you draw a card.",
  [":jiuyuan"] = "(lord, forced) When another Wu character uses Peach to you, you heal +1 HP.",
  [":jiwei"] = "(forced) At the end of another player's turn, you draw a card for each of the following met this turn:<br>1. a player lost cards;<br>2. a player took damage (in Role mode this option is removed; in Landlord mode you draw one extra card for meeting this option).<br>In your Prepare phase, if your hand card count is not less than the number of players alive and not less than your HP (in Landlord or 2v2 mode this condition becomes: all players are alive and you have at least five hand cards), you must distribute all hand cards of the color you hold more of to other players (if the counts are equal, choose one color).",
  [":jiwei_1v2"] = "(forced) At the end of another player's turn, if this turn: a player lost cards, you draw a card; a player took damage, you draw two cards.<br>In your Prepare phase, if all players are alive and you have at least five hand cards, you must distribute all hand cards of the color you hold more of to other players (if the counts are equal, choose one color).",
  [":jiwei_2v2"] = "(forced) At the end of another player's turn, you draw a card for each of the following met this turn:<br>1. a player lost cards;<br>2. a player took damage.<br>In your Prepare phase, if your hand card count is not less than the number of players alive and not less than your HP, you must distribute all hand cards of the color you hold more of to other players (if the counts are equal, choose one color).",
  [":jiwei_role_mode"] = "(forced) At the end of another player's turn, if a player lost cards this turn, you draw a card.<br>In your Prepare phase, if your hand card count is not less than the number of players alive and not less than your HP, you must distribute all hand cards of the color you hold more of to other players (if the counts are equal, choose one color).",
  [":jixiy"] = "(awaken) After your turn ends, if you have not lost HP during three consecutive turns of your own, you gain 1 max HP, recover 1 HP, then choose one: 1. gain the skill False Majesty; 2. draw two cards, then gain the Lord's lord skill.",
  [":jiyul"] = "Once per Action phase, you can discard a hand card and obtain from the draw pile or the discard pile one random card of each type different from it; up to twice each phase, if you have used all the cards you obtained this way, this skill counts as not having been triggered.",
  [":jizhi"] = "When you use a non-delay trick card, you can draw 1 card.",
  [":juejin"] = "(persistent) (once per game) In your Action phase, you can make all players set their HP to 1 and gain X Shield (X is the amount of HP they lost this way; if that player is you, then +2), then remove all Alcohol, Peach and Dodge cards in the draw pile, the discard pile and every player's areas from the game.",
  [":jueying"] = "Jue Ying (equip card, horse)<br /><b>Horse skill</b>: The distance from other players to you is increased by +1.",
  [":jueyong"] = "(forced) When you become the target of a card that is not used by Peerless Valor, is not converted and is not virtual (Peach and Alcohol excepted), if you are the only target of this card and the number of Valor cards is less than your HP, you cancel it. Then put this card on your character card, called Valor. In your Finish phase, if you have Valor, resolve the Valor cards one by one in the order they were placed, making each card's original user use it on you (if that card's user is not in play, put the card into the discard pile).",
  [":juezhi"] = "In your Action phase, you can discard at least two cards, then randomly obtain from the draw pile a card whose number is X (X is the remainder when the sum of the numbers of the cards discarded this way is divided by 13; if the remainder is 0, X becomes 13).",
  [":juezhig"] = "Once per Action phase for each option: 1. you can draw a card, count as using a Duel, then discard all non-damage cards in your hand; 2. you can draw a card, recover 1 HP, then discard all damage cards in your hand.",
  [":juguz"] = "After you become the target of a card, if you are not wounded, you can draw two cards, then discard X cards (X is the number of times this skill has been used this turn).",
  [":juliao"] = "(forced) Other players calculate their distance to you +X (X is the number of kingdoms in play -1).",
  [":jungong"] = "During your Action phase, you can discard X+1 cards or lose X+1 HP (X is the number of times you have used this skill this turn), and it counts as using a Slash with no distance restriction and no limit on the number of uses. If this Slash deals damage to the target player, this skill is invalid for the rest of this turn.",
  [":junkui"] = "(forced) At the start of the game, you remove all horse cards from the game; the limit on the number of Slashes you can use +1.",
  [":jutu"] = "(forced) At your Prepare phase, you obtain all Life cards in play, draw X+1 cards, then place X cards on your character card, called Life (X is the number of players of the kingdom you chose with Invite the Tiger).",
  [":juxiangz"] = "(once per game) After another player's dying resolution ends, you can deal 1 damage to them.",
  [":kaiji"] = "At your Prepare phase, you can make up to X players each draw a card; if any player obtained a non-basic card this way, you draw a card (X is the number of living players who have entered the dying state).",
  [":kechang"] = "Level 1: (lord skill) (forced) Neutral kingdom players use Slash with no distance restriction.<br/>Level 2: (lord skill) (forced) Neutral kingdom players use Slash with no distance restriction; the Slashes you use cannot be responded to.",
  [":kechang_update"] = "(lord skill) (forced) Neutral kingdom players use Slash with no distance restriction; the Slashes you use cannot be responded to.",
  ...
  [":kouluet"] = "(forced) Hand cards you obtain outside your Draw phase do not count toward your hand limit and are all considered to be Slash.",
  [":kuangli"] = "(forced) At the start of your Action phase, a random number (at least one) of other players gain a Savage Frenzy mark until the end of the turn; up to twice each phase (in Fight the Landlord, up to once), after you use a card in your Action phase targeting a player with a Savage Frenzy mark, you discard one random card from yourself and one from them, then you draw two cards.",
  [":kuangli_1v2"] = "(forced) At the start of your Action phase, a random number (at least one) of other players gain a Savage Frenzy mark until the end of the turn; once per phase, after you use a card in your Action phase targeting a player with a Savage Frenzy mark, you discard one random card from yourself and one from them, then you draw two cards.",
  [":kuangli_role_mode"] = "(forced) At the start of your Action phase, a random number (at least one) of other players gain a Savage Frenzy mark until the end of the turn; up to twice each phase, after you use a card in your Action phase targeting a player with a Savage Frenzy mark, you discard one random card from yourself and one from them, then you draw two cards.",
  [":kuangwu"] = "At the start of another player's Action phase, you can draw or discard until your hand card count equals theirs (drawing up to five cards at most, discarding down to one card at most), then it counts as using a Duel against them. After this Duel finishes resolving, if they took no damage from this card, you lose 1 HP and Boastful Valor has no effect until the end of this round.",
  [":kubai"] = "Level 1: (forced) When you use the first card of each color during your turn, you draw a card; during your turn other players cannot use cards that have a color you have not used.<br />Level 2: (forced) When you use the first card of each suit during your turn, you draw a card; during your turn other players cannot use cards that have a suit you have not used.<br />Level 3: (forced) When you use the first card of each number during your turn, you draw a card; during your turn other players cannot use cards that have a number you have not used.",
  [":kuili"] = "(forced) After you take damage, you restore the weapon slot of the damage source.",
  [":kujian"] = "Once per Action phase, you can mark up to two hand cards as Counsel and give them to another player. When another player uses or plays a Counsel card, you and they each draw two cards. After another player loses a Counsel card from their hand other than by using or playing it, you and they each discard a card.",
  ...
  [":laishou"] = "(forced) When you take fatal damage, if your max HP is less than 9, prevent this damage and increase your max HP by that amount. In your Prepare phase, if your max HP is not less than 9, you die.",
  [":lianxi"] = "Slash does not count toward your hand limit; after a Slash of yours is discarded into the discard pile, you can count as using an ordinary Slash that does not count toward your number of uses, with no distance restriction and no limit on the number of uses.",
  [":lianying"] = "When you lose your last hand card: you can draw 1 card.",
  [":lianzhant"] = "After a Slash with a number that you used against a single target finishes resolving, you can use a Slash with a greater number against them with no distance restriction and no limit on the number of uses, then draw a card.",
  [":liaoyi"] = "At the start of another player's turn, if their hand card count is less than their HP and the number of Benevolence cards in play is not less than X, you can make them obtain X Benevolence cards; if their hand card count is greater than their HP, you can make them put X hand cards into the Benevolence area (X is the difference between their hand card count and their HP, at most 4).",
  [":lidian__heyu"] = "(forced) If allied Thoroughbred Yue Jin is in play, you obtain the cards discarded by Sever the Ford; if allied Thoroughbred Zhang Liao is in play, cards used with Public Spirit cannot be responded to. (Only in Landlord and 2v2 modes)",
  [":lidian__heyu_yuejin"] = "(forced) If allied Thoroughbred Yue Jin is in play, you obtain the cards discarded by Sever the Ford.",
  [":lidian__heyu_zhangliao"] = "(forced) If allied Thoroughbred Zhang Liao is in play, cards used with Public Spirit cannot be responded to.",
  [":liezhi"] = "In your Prepare phase, you can discard one card from the areas of each of up to two other players, one after another; after you take damage, Stern Integrity has no effect until your next Finish phase.",
  [":liezhiz"] = "Once per turn, you can reduce your max HP by 1, and it counts as using a Peach, or an Alcohol that does not count toward the use limit and has no limit on the number of uses.",
  ...
  [":lingce"] = "(forced) When a trick card that is neither virtual nor converted is used, if that card's name is one of the <a href='bag_of_tricks'>Bag of Tricks</a> card names, a card name already recorded by Steady the Han, or Orthodox and Unorthodox, you draw a card.",
  [":lingfa"] = "At the start of each round, if the current round number is not greater than 2, you can make effect X apply to all other players this round (X is the current round number): 1. when they use a Slash, they must discard a card, otherwise you deal 1 damage to them; 2. after a Peach they use finishes resolving, they must give you a card, otherwise you deal 1 damage to them. If the current round number is greater than 2, you lose this skill and gain <a href=':os__zhian'>Dark Governance</a> and <a href=':jianxiong'>Villainous Hero</a>.",
  [":liubing"] = "(forced) The suit of the first non-virtual Slash you use each turn counts as <font color='red'>♦</font>. After another player finishes using a non-converted black Slash during their Action phase, if it has dealt no damage, you obtain it.",
  ...
  [":lixia"] = "(forced) In another player's Finish phase, if you are not within their ATK range, you choose one: 1. draw a card; 2. make them draw a card. Then other players' distance to you is reduced by 1.",
  [":liyong"] = "(forced) After a Slash you use during your Action phase is countered by a Dodge, then after the next Slash you use during this phase designates its targets, the targets' non-forced skills have no effect until the end of the turn, this Slash cannot be responded to, and its damage to the target players is increased by 1; after this Slash deals damage, if the target player has not died, you lose 1 HP.",
  [":longdan"] = "You can use/play Slash as Dodge. You can use/play Dodge as Slash.",
  [":longyuan"] = "(awaken) In your Prepare phase, if you have used Loyal Support at least three times this game, you change Loyal Support so that it requires only one card.",
  [":luanchou"] = "Once per Action phase, you can remove all \"Marriage\" marks in play and choose two players, making them gain \"Marriage\". A player with \"Marriage\" counts as having the skill Shared Peril.",
  [":luanqun"] = "Once per Action phase, if you have hand cards, you can make all players show a hand card at the same time, then you can obtain up to two of those cards (up to four in Role mode) with the same color as the card you showed. Every player whose shown card differs in color from yours can only choose you as the target of the first Slash they use in their next Action phase, and you cannot respond to Slashes they use on their next turn.",
  [":luanqun_1v2"] = "Once per Action phase, if you have hand cards, you can make all players show a hand card at the same time, then you can obtain up to two of those cards with the same color as the card you showed. Every player whose shown card differs in color from yours can only choose you as the target of the first Slash they use in their next Action phase, and you cannot respond to Slashes they use on their next turn.",
  [":luanqun_role_mode"] = "Once per Action phase, if you have hand cards, you can make all players show a hand card at the same time, then you can obtain up to four of those cards with the same color as the card you showed. Every player whose shown card differs in color from yours can only choose you as the target of the first Slash they use in their next Action phase, and you cannot respond to Slashes they use on their next turn.",
  [":luezhen"] = "At the start of your Action phase, you can make all other players choose one in turn: 1. show X hand cards (X is the number of times they have chosen this option +1); 2. you count as using a Slash on them that does not count toward your limit and has no distance or use-count restriction.",
  [":lulian"] = "(forced) After the settlement of a hand card you use ends, if you have no hand card of that type and there is a target player whose: HP is less than or equal to yours, all targets of that card become chained; number of cards in the equip area is less than or equal to yours, you draw a card. Momentum: you deal 1 fire damage to a player whose HP is not the lowest.",
  [":lunxiong"] = "After you deal or take damage, you can discard the hand card with the unique highest number, then draw three cards. For the rest of the game, each card you discard this way must have a higher number than this card.",
  ...
  [":m_ex__anguo"] = "At the start of the game, you make another player gain the Steady the State mark; the hand card limit of the player who has the Steady the State mark equals their max HP; at the start of your Action phase, if a player in play has the Steady the State mark, you can move the mark to a player who has not had this mark this game; when you take damage, if a player in play has the Steady the State mark, the damage source does not have the mark, and the damage value is not less than your HP, prevent this damage; when the player who has the Steady the State mark enters the dying state, they remove the mark and recover their HP to 1, then you choose: 1. if your HP is greater than 1, you lose HP down to 1; 2. if your max HP is greater than 1, you reduce your max HP to 1. If you do, they gain 1 Armour.",
  [":m_ex__anjian"] = "(forced) After you use a Slash that designates a player as its target, if you are not within their ATK range, you choose one: 1. they cannot respond to this Slash; 2. this Slash's base damage to them is increased by 1.",
  [":m_ex__anxu"] = "Once per Action phase, you can make another player obtain a card from a second other player. If the card they obtain is not from an equip area, you draw a card. After they obtain a card this way, you can make whichever of the two has fewer hand cards draw a card.",
  [":m_ex__beige"] = "After a player takes damage caused by a Slash, you can discard a card to make them make a judgement; if the result is: <font color='red'>♥</font>, they recover X HP (X is the damage they took this time); <font color='red'>♦</font>, they draw three cards; ♣, the damage source discards two cards; ♠, the damage source turns their character card over.",
  [":m_ex__benxi"] = "At the start of your Action phase, you can discard any number of cards to make it so that this phase: you calculate your distance to other players -X, and the next basic card or ordinary trick card you use can choose up to X additional players whose distance from you is 1 as targets (X is the number of cards you discarded this way). Then, after that card finishes resolving, if it dealt damage, you draw five cards.",
  [":m_ex__bingyi"] = "In your Finish phase, you can show all your hand cards; if they are all of the same color or all of the same type, you make up to X players each draw a card (X is your number of hand cards).",
  [":m_ex__dangxian"] = "(forced) At the start of your turn, you obtain a Slash from the discard pile and perform an extra Action phase.",
  [":m_ex__danshou"] = "At another player's Finish phase, if you have not been a target of a card they used this turn, you draw a card; otherwise you can discard X cards to deal 1 damage to them (X is the number of times you were a target of a card they used this turn).",
  [":m_ex__dingpin"] = "In your Action phase, you can discard a card (it cannot be of a type you have used or discarded this turn) and choose a player, making them make a judgement; if the result is: black, that player draws X cards (X is their current HP, at most 3), then you cannot use \"Grading\" on them for the rest of this turn; <font color='red'>♥</font>, the card you discarded for this use of \"Grading\" does not count toward the types you have discarded; <font color='red'>♦</font>, you turn your character card over.",
  [":m_ex__duanliang"] = "You can use a black non-trick card as Supply Shortage. When you use Supply Shortage on a player whose hand size is not less than yours, it has no distance restriction.",
  [":m_ex__duodao"] = "After you take damage, you can obtain the weapon card in the damage source's equip area.",
  [":m_ex__fangquan"] = "You can skip your Action phase. If you do, your hand limit this turn is equal to your max HP, and after this turn ends, you can discard a hand card to make another player take an extra turn.",
  [":m_ex__fangzhu"] = "After you take damage, you can make another player choose one: 1. discard X cards and lose 1 HP; 2. draw X cards and turn their character card over (X is the amount of HP you have lost).",
  [":m_ex__fenji"] = "In a player's Finish phase, if they have no hand cards, you can make them draw two cards, then you lose 1 HP.",
  [":m_ex__fuli"] = "(once per game) When you are in the dying state, you can recover your current HP to X (X is the number of kingdoms in play). Then, if your HP is the unique highest in play, you turn your character card over.",
  [":m_ex__ganlu"] = "Once per Action phase, you can choose two players the difference between whose numbers of cards in their equip areas is no greater than the amount of HP you have lost, and exchange the cards in their equip areas; if you are one of the players you choose, the restriction on the difference does not apply.",
  [":m_ex__gongqi"] = "If there is a horse card in your equip area, your ATK range is unlimited; once per Action phase, you can discard a non-basic card and choose another player who has cards, then discard a card from them.",
  [":m_ex__guhuo"] = "Once per turn, you can place a hand card face down and use or play it as any basic card or ordinary trick card. Before using this card, each other player in turn chooses whether to challenge; if a player challenges, this card is turned face up: if it is false, this card is voided; if it is true, that player gains Lingering Grudge.",
  [":m_ex__hunzi"] = "(awaken) In your Prepare phase, if your HP is not greater than 2, you reduce your max HP by 1, then gain Handsome and Heroic Soul.",
  [":m_ex__huoji"] = "You can use a red card as Fire Attack.",
  [":m_ex__jianchu"] = "After you use a Slash and choose a target, you can discard one of their cards. If that card is: an equipment card, they cannot respond to this Slash; not an equipment card, that player obtains this Slash.",
  [":m_ex__jiangchi"] = "At the start of your Action phase, you can choose one option: 1. draw a card, and you cannot use Slash this phase; 2. discard a card, and this phase you use Slash with no distance restriction and can use one extra Slash.",
  [":m_ex__jianying"] = "When you use a card during your Action phase, if that card has the same number or suit as the previous card you used during this phase, you can draw a card. Once per Action phase, you can use a card as any kind of basic card; if the previous card you used during this phase has a suit, this card's suit is treated as the suit of the previous card you used this turn.",
  [":m_ex__jiaojin"] = "When you take damage dealt by a male player, you can discard an equip card to prevent this damage.",
  [":m_ex__jieming"] = "After you take 1 damage, you can make a player draw two cards, then if their number of hand cards is less than their max HP, you draw a card.",
  [":m_ex__jieyue"] = "At your Finish phase, you can give a card to another player, then they choose one: 1. keep one hand card and one card in their equip area, then discard the rest; 2. make you draw three cards.",
  [":m_ex__jiezi"] = "(forced) After another player skips their Draw phase, you draw a card.",
  [":m_ex__jinjiu"] = "(forced) The card name of your Alcohol counts as Slash, and such a Slash is a normal Slash; when you take damage from a Slash whose base damage was increased by an Alcohol taking effect, you reduce the damage by X (X is the base damage increase caused by that Alcohol); other players cannot use Alcohol during your turn.",
  [":m_ex__jiushi"] = "When you need to use an Alcohol, if your character card is face up, you can turn your character card over, and it counts as using an Alcohol; after you take damage, if your character card is face down and you have not used Wine Poetry for this damage, you can turn your character card over and randomly obtain a trick card from the draw pile.",
  [":m_ex__jiushi_upgrade"] = "When you need to use an Alcohol, if your character card is face up, you can turn your character card over, and it counts as using an Alcohol; after you take damage, if your character card is face down and you have not used Wine Poetry for this damage, you can turn your character card over; after you turn your character card over, you randomly obtain a trick card from the draw pile.",
  [":m_ex__juece"] = "In your Finish phase, you can deal 1 damage to another player who has lost cards this turn.",
  [":m_ex__junxing"] = "Once per Action phase, you can discard any number of hand cards and make another player choose one: 1. discard the same number of cards and lose 1 HP; 2. turn their character card over, then draw the same number of cards.",
  [":m_ex__kanpo"] = "You can use a black card as Nullification.",
  [":m_ex__kongsheng"] = "At your Prepare phase, or after you lose or recover HP, you can place any number of the current turn player's cards on their character card; at their Finish phase, you can use one of those cards, and they obtain the rest.",
  [":m_ex__liangyin"] = "When a card is placed on a character card, you can make a player draw a card; when any player obtains a card from a player's character card, you can make a player discard a card. At the end of each round, you can make the only player who became a target of Auspicious Match this round recover 1 HP, or make the only player who did not become a target of Auspicious Match this round lose 1 HP.",
  [":m_ex__lianhuan"] = "You can use or recast a ♣ hand card as Iron Chain; when you use Iron Chain you can designate one additional target.",
  [":m_ex__lihuo"] = "When you use a normal Slash, you can change this Slash into a fire Slash. If the target player of this Slash is chained, this Slash's damage is increased by 1. After a fire Slash you used finishes resolving, you lose 1 HP for every 2 damage it dealt.",
  [":m_ex__luanji"] = "In your Action phase, you can use two hand cards as an Archery Attack (you cannot use a suit already used for this skill during this phase); when another player plays a Dodge in response to an Archery Attack you used, they draw a card; after an Archery Attack you used finishes resolving, if no player took damage from that card, you draw cards equal to the number of targets that Archery Attack designated.",
  [":m_ex__mieji"] = "Once per Action phase, you can put a black trick card on top of the draw pile and choose another player who has hand cards; they choose: 1. give you a trick card; 2. discard two non-trick cards one at a time (discard one if they do not have enough).",
  [":m_ex__niepan"] = "(once per game) In your Action phase, or while you are dying, you can discard all the cards in your areas, draw three cards, heal your HP up to 3 and restore your character card.",
  [":m_ex__paiyi"] = "Once per Action phase, you can remove one \"Power\" card to make a player draw two cards. If that player's number of hand cards is greater than yours, you deal 1 damage to them.",
  [":m_ex__pingkou"] = "At the end of your turn, you can deal 1 damage to each of up to X other players (X is the number of phases you skipped this turn). If you do, you randomly obtain an equip card from the draw pile.",
  [":m_ex__pojun"] = "After you use a Slash and choose a target, you can place up to X of their cards face down beside that player's character card (X is their HP); if you do, at the end of the current turn, that player obtains these cards; when a Slash you use deals damage to a target player whose hand card count and equip area card count are both not greater than yours, this damage +1.",
  [":m_ex__qiangxi"] = "Once per Action phase for each player, you can lose 1 HP or discard a weapon card to deal 1 damage to another player in your ATK range.",
  [":m_ex__qiaoshui"] = "Once per Action phase, you can start a point fight with a player. If you win, the next basic card or normal trick card you use this phase can choose one more or one fewer target (with no distance restriction); if you do not win, you cannot use trick cards this phase.",
  [":m_ex__qieting"] = "After another player's turn ends, if they did not deal damage to another player during that turn, you can choose: 1. look at two of their hand cards and obtain one of them; 2. put a card from their equip area into your equip area; 3. draw a card.",
  [":m_ex__qimou"] = "(once per game) In your Action phase, you can lose any amount of HP; until the end of the turn, your distance to other players is reduced by X and you can use X additional Slash (X is the amount of HP you lost this way).",
  [":m_ex__qingjian"] = "Once per turn, after you obtain cards outside your Draw phase, you can place any number of hand cards face down on your character card; in a player's Finish phase, if there are \"Frugality\" cards on your character card, you distribute those cards among other players, and if you give away more than one card, you draw a card.",
  [":m_ex__qingnang"] = "Once per Action phase, you can discard a hand card and choose a wounded player, making them recover 1 HP. If the discarded card was red, you can use Green Salve again on a player not yet chosen this phase.",
  [":m_ex__qiuyuan"] = "When you become the target of a Slash, you can make another player give you a basic card other than Slash, otherwise they also become a target of this Slash.",
  [":m_ex__quanji"] = "At the end of your Action phase, if your hand card count is greater than your HP, or after you take 1 damage, you can draw a card, then you place a hand card on your character card, called Power; your hand card limit +X (X is the number of Power).",
  [":m_ex__shenxing"] = "X times per Action phase (X is your HP), you can discard two cards; if the discarded cards are different colors, you draw two cards; otherwise you draw one card.",
  [":m_ex__shuangxiong"] = "In your Draw phase, you can instead reveal the top two cards of the draw pile and obtain one of them, then this turn you can use hand cards whose colour differs from that card as Duel; after you take damage from a Duel used this way, you can obtain the Slashes other players played to respond to that Duel.",
  [":m_ex__sidi"] = "After a card other than a delayed trick that you use finishes resolving, you can choose another player who has not yet been assigned a Mark the Foe target, and name a Mark the Foe target player for them (neither choice is revealed). When the first card other than a delayed trick that they use targets only that Mark the Foe target and no one else (otherwise you clear the Mark the Foe target you named for them), you carry out an effect as follows: if the target is you, you draw a card; if the target is not you, you choose: 1. cancel that card, then if no player is dying at this time, you deal 1 damage to them; 2. you draw two cards. Then you clear the Mark the Foe target you named for them.",
  [":m_ex__tianxiang"] = "When you take damage, you can discard a <font color='red'>♥</font> hand card and choose another player. You prevent this damage and choose one: 1. the damage source deals 1 damage to them, and they draw X cards (X is the amount of HP they have lost, at most 5); 2. they lose 1 HP and obtain the card you discarded this way from the draw pile or the discard pile.",
  [":m_ex__tiaoxin"] = "Once per Action phase, you can choose another player; unless that player uses a Slash on you, you discard a card from them.",
  [":m_ex__tuntian"] = "After you lose cards outside your turn, you can make a judgement: if the result is <font color='red'>♥</font>, you obtain the judgement card; otherwise you put the judgement card, after it takes effect, on your character card, called a Field card; your distance to other players is -X (X is the number of Field cards).",
  [":m_ex__wurong"] = "Once per Action phase, you can hold a strategy duel with another player; according to what both sides choose:<br>Suppress-Resist, you deal 1 damage to them, then you draw a card.<br>Suppress-Submit, you obtain one card from them, then give them two cards.<br>Appease-Resist, you take 1 damage, then you draw a card.<br>Appease-Submit, they give you two cards; if they have fewer than two cards, instead they skip their next Draw phase.",
  [":m_ex__xianzhen"] = "Once per Action phase, you can start a point fight with a player. If you win, during this phase you ignore their armour and use cards against them with no distance restriction and no limit on the number of uses; if you do not win, you cannot use Slash during this phase. If your point fight card is a Slash, your Slashes do not count toward your hand limit this turn.",
  [":m_ex__xingshang"] = "When another player dies, you can choose one option: 1. obtain all their cards; 2. recover 1 HP.",
  [":m_ex__xingxue"] = "In your Finish phase, you can choose up to X players (X is your HP); each of those players draws a card and puts a card on top of the draw pile. If you do not have Banquet Execution, they can instead give a card to another target of this skill, and X becomes your max HP.",
  [":m_ex__xingxue_normal"] = "In your Finish phase, you can choose up to X players (X is your HP); each of those players draws a card and puts a card on top of the draw pile.",
  [":m_ex__xingxue_upgrade"] = "In your Finish phase, you can choose up to X players (X is your max HP); each of those players draws a card and chooses: 1. put a card on top of the draw pile; 2. give a card to another target of this skill.",
  [":m_ex__xuanfeng"] = "After you have discarded at least two cards in your Discard phase, or after you lose a card from your equip area, you can choose one option: 1. discard two cards in total from up to two other players; 2. move a card in one other player's equip area to the corresponding area of another other player.",
  [":m_ex__yanzhu"] = "Once per Action phase, you can make another player choose one option: 1. you obtain one card from their areas; 2. you obtain all cards in their equip area (at least one), then you lose Banquet Execution.",
  [":m_ex__yaoming"] = "(charge 2/4) During your Action phase or after you take damage, you can reduce 1 charge point and choose one: 1. discard a card from another player whose hand count is no less than yours; 2. make a player whose hand count is no greater than yours draw a card. If this option is different from the option you chose last time, you gain 1 charge point and clear the recorded option. After you take 1 damage, you gain 1 charge point.",
  [":m_ex__yicong"] = "(forced) Your distance to other players is -X (X is your HP -1); other players' distance to you is +Y (Y is your lost HP -1).",
  [":m_ex__yongsi"] = "(forced) During your Draw phase, you draw X cards instead (X is the number of kingdoms in play); at the start of your Discard phase, you must discard a card, or lose 1 HP.",
  [":m_ex__zenhui"] = "Once per Action phase, when you use a Slash or a black regular trick card and choose a player as its only target, you can choose another player who can be a legal target of this card, and choose one: 1. obtain a card from that player, then they replace you as the user of this card; 2. make them also become a target of this card.",
  [":m_ex__zhiji"] = "(awaken) In your Prepare phase, if you have no hand cards, you recover 1 HP or draw two cards, reduce your max HP by 1, then gain Stargaze.",
  [":m_ex__zhijian"] = "During your Action phase, you can put an equip card from your hand into another player's equip area, then draw a card. When you use an equip card during your Action phase, you draw a card.",
  [":m_ex__zhongyong"] = "After a Slash you use during your Action phase finishes resolving, if no target player used a Dodge in response to this Slash, you can obtain this Slash again; otherwise you can choose: 1. obtain the Dodges that responded to this Slash, then you can give this Slash to another player; 2. give the Dodges that responded to this Slash to another player, then your limit on the number of Slashes you can use this phase +1, and the base damage of the next Slash you use this phase +1. You cannot use cards obtained through Loyal Valour this turn.",
  [":m_ex__zhuikong"] = "Once per round, in another player's Prepare phase, if their HP is not less than yours, you can point fight with them. If you win, this turn they cannot use a card targeting any player other than themselves; if you do not win, you obtain their point fight card, then it counts as them using a Slash on you.",
  [":m_ex__zili"] = "(awaken) During your Prepare phase, if the number of Power is no less than 3, choose one: 1. recover 1 HP; 2. draw two cards. Then your max HP -1 and you gain Rejection.",
  [":m_ex__zongshi"] = "(forced) Your hand limit is +X (X is the number of kingdoms in play). In your Prepare phase, if your hand card count is greater than your HP, you use Slash with no limit on the number of uses this turn.",
  [":m_ex__zongshij"] = "After you take part in a point fight, you look at the top card of the draw pile and can choose one: obtain that top card of the draw pile, or obtain the lower-numbered of the two point fight cards.",
  [":m_ex__zongxuan"] = "Once per Action phase, you can draw a card, then put a card on top of the draw pile; when your cards are put into the discard pile because they are discarded, you can put any number of them on top of the draw pile.",
  [":m_js__fayi"] = "After a council you took part in ends, you can deal 1 damage to up to two (in Landlord mode, one instead) players whose opinion differs from yours.",
  [":m_js__fayi_1v2"] = "After a council you took part in ends, you can deal 1 damage to one player whose opinion differs from yours.",
  [":m_js__fayi_role_mode"] = "After a council you took part in ends, you can deal 1 damage to up to two players whose opinion differs from yours.",
  [":m_js__jishan"] = "Once per turn for each effect, when a player takes damage, you can lose 2 HP and prevent this damage, then you and they each draw a card; after you deal damage, you can make a player with the lowest HP whose damage has been prevented this way recover 1 HP.",
  [":m_js__juelie"] = "When a Slash you use deals damage to the target player, if your hand card count or your HP is the lowest in play, this damage is +1. After you use a Slash and choose a player as a target, you can discard a card, then discard one card from them.",
  [":m_js__shelun"] = "Once per Action phase, if you have hand cards, you can choose up to two (in Landlord mode, one instead) other players in your ATK range, then you make every other player whose hand card count is not greater than yours hold a council. If the result is red, you discard two cards from each of the chosen players; if black, you deal 1 damage to each of them.",
  [":m_js__shelun_1v2"] = "Once per Action phase, if you have hand cards, you can choose one other player in your ATK range, then you make every other player whose hand card count is not greater than yours hold a council. If the result is red, you discard two cards from the chosen player; if black, you deal 1 damage to them.",
  [":m_js__shelun_role_mode"] = "Once per Action phase, if you have hand cards, you can choose up to two other players in your ATK range, then you make every other player whose hand card count is not greater than yours hold a council. If the result is red, you discard two cards from each of the chosen players; if black, you deal 1 damage to each of them.",
  [":m_liuyi__liulongcanjia"] = "Equip card - Treasure<br/><b>Treasure skill</b>: your distance to other players is -X; other players' distance to you is +X (X is the number of cards with rank K in play).",
  [":m_liuyi_laws_cards"] = "",
  [":m_liuyi_laws_damage"] = "",
  [":m_liuyi_laws_gain"] = "",
  [":m_liuyi_laws_hp"] = "",
  [":m_shi__ceduan"] = "Once per Action phase, you can choose a player whose ATK range includes you; all players within that player's ATK range simultaneously show a hand card, then you use all of your hand cards of the color shown most often as one Slash of any kind that does not count toward the use limit against them. If it deals damage, you draw a card.",
  [":m_shi__dimeng"] = "Once per Action phase, you can make two players whose hand counts differ by no more than 3 exchange hand cards, then you choose one: 1. you discard X cards (all of them if you have fewer); 2. the player with fewer hand cards after the exchange draws X cards (X is your lost HP).",
  [":m_shi__haoshi"] = "At your Finish phase, you can choose another player; until the start of your next turn, they can use or play your hand cards as if they were their own hand cards. The first two times during that period that you lose your last hand card this way, you draw until you have three hand cards.",
  [":m_shi__haoshi&"] = "You can use or play Momentum Lu Su's hand cards as if they were your own hand cards.",
  [":m_shi__jixi"] = "At the end of a player's turn, if there is another player who has been a target of a card you used this turn, you can discard a card from the current turn player; it counts as using a Snatch with no distance restriction that targets any number of those players.",
  [":m_shi__kuanggu"] = "After you deal damage to a player at distance 1 or less, you can choose one option: 1. recover 1 HP; 2. draw a card.<br>⬤ Level 2: After you deal damage to a player at distance 1 or less, you can choose one option: 1. recover 1 HP; 2. draw a card. Backwater: discard a card, then the number of Slashes you can use this phase is +1.",
  [":m_shi__kuanggu1"] = "After you deal damage to a player at distance 1 or less, you can choose one option: 1. recover 1 HP; 2. draw a card.",
  [":m_shi__kuanggu2"] = "After you deal damage to a player at distance 1 or less, you can choose one option: 1. recover 1 HP; 2. draw a card. Backwater: discard a card, then the number of Slashes you can use this phase is +1.",
  [":m_shi__qingyan"] = "You can show X hand cards (X is the number of times this skill has been triggered this round, up to 5), and it counts as using a Dodge or a Nullification; then this skill is disabled until none of the cards shown this way are in your hand.",
  [":m_shi__tuntian"] = "Charge skill (0/0), after you lose a non-damage card, you gain 1 charge point; once per Action phase, you can spend at least 1 charge point to make up to that many players each randomly obtain a <font color='red'>♥</font> card; at the start of a player's turn, if your charge points are full, you draw a card and your charge point limit +1.",
  [":m_shi__xianshuai"] = "(forced) During your turn, the first hand card you use of each suit does not count toward the use limit and has no limit on the number of uses.",
  [":m_shi__zaoxian"] = "(forced) When the number of charge points you spend at once is no less than the corresponding value, you obtain the corresponding card from the discard pile:\n  3, Ex Nihilo;\n  5, Nullification;\n  7, Amazing Grace.",
  [":m_yuan__wusheng"] = "You can use or play any number of cards as a Slash with no distance restriction. After that Slash resolves, if this is the first time this turn that you converted that number of cards, you draw two cards and that Slash does not count toward the use limit.",
  [":m_yuan__yijue"] = "(forced) When you are about to deal lethal damage to a player, they choose whether to give you any number of cards; then you choose one: 1. they cannot use or play cards this turn, and you discard all your hand cards of the same suits as those cards; 2. prevent that damage, and this round, when they or you use a card targeting the other, that target is cancelled.",
  [":mashu"] = "(forced) The distance from you to other players is reduced by -1.",
  [":miaolue"] = "At the start of the game, you gain two <a href=':underhanding'>Underhanding</a>; after you take damage, you can choose one option: 1. draw two cards; 2. obtain a <a href='bag_of_tricks'>Bag of Tricks</a> card you name from the draw pile or the discard pile.",
  [":mibei"] = "(mission) <br>\n  ⬤ Success: after the settlement of a card you use, if you have no fewer than two Preps of every card type, you obtain one card of each type from the draw pile, then you gain the skill Kingmaker.<br>\n  ⬤ Failure: at the end of your Discard phase, if you have no Prep both at that moment and at the start of this turn's Prepare phase, you lose 1 max HP and the mission fails.",
  [":miewu"] = "Once per turn, you can discard 1 Armory mark and use or play a card as any basic card or trick card; if you do, you draw a card.",
  [":mingcha"] = "At the start of your Draw phase, you reveal the top three cards of the draw pile, then you can give up drawing and obtain the cards among them with a number of 8 or less; if you obtain cards this way, you can choose another player and obtain a random card from them.",
  [":mobile__baiyin"] = "(awaken) At the start of your Prepare phase, if you have at least 4 Endure marks, you lose 1 max HP, then gain Ultimate Strategy.",
  [":mobile__beini"] = "Once per Action phase, you can choose a player whose HP is not less than yours and make either you or them draw two cards, then the player who did not draw chooses one option: 1. it counts as using a Slash on the player who drew, with no distance restriction and no limit on the number of uses; 2. obtain a card on the field of the player who drew.",
  [":mobile__biaozhao"] = "In your Finish phase, you can place a card face down on your character card, called a Memorial. When a card with the same rank as the Memorial enters the discard pile, you remove the Memorial and lose 1 HP. In your Prepare phase, you remove the Memorial, then make a player recover 1 HP and draw three cards.",
  [":mobile__bijing"] = "In your Finish phase, you can choose a hand card and mark it as Closed Border. If you lose the Closed Border card outside your turn, at the start of the current turn player's Discard phase, they must discard two cards. In your Prepare phase, you discard the Closed Border card from your hand.",
  [":mobile__canyun"] = "Once per Action phase, you can choose up to X other players and discard that many cards (X is your HP; once per game for each player). Compare the number of cards in those players' equip areas with yours: fewer than yours, they recover 1 HP; more than yours, they lose 1 HP; equal to yours, they draw a card. If the number of targets you chose equals X, you draw a card.",
  [":mobile__catapult"] = "Equip card - Weapon<br/><b>ATK range</b>: 9<br/><b>Weapon skill</b>: after you deal damage to another player, you can discard all cards in their equip area.",
  [":mobile__chenjie"] = "(forced) If you have Halting Aid, after a player who has been a target of Halting Aid dies, you discard all cards in your area, then draw four cards.",
  [":mobile__chijie"] = "Once per turn, when you become the only target of a card used by another player, you can perform a judgement; if the number is greater than 6, cancel it.",
  [":mobile__choujue"] = "(forced) After you kill a player, you gain 1 max HP, draw two cards, and the number of times you can use Repel the Foe this turn is increased by 1.",
  [":mobile__dangyi"] = "(persistent) (lord skill) Once per turn, when you deal damage, you can make this damage +1 (twice per game).",
  [":mobile__daoshu"] = "Once per Action phase, you can choose another player with at least 2 hand cards. That player chooses one of three random card names and disguises a hand card with a different card name as a card of that name, then you look at their hand cards after the disguise and guess which one is disguised (in 2v2 or Landlord mode, instead choose an enemy player with at least 2 hand cards, and you and your allies guess at the same time). Each player who guesses correctly deals 1 damage to that player; each player who guesses wrong randomly discards two hand cards, or loses 1 HP instead if they do not have enough hand cards.",
  [":mobile__daoshu_1v2"] = "Once per Action phase, you can choose an enemy player with at least 2 hand cards. That player chooses one of three random card names and disguises a hand card with a different card name as a card of that name, then you look at their hand cards after the disguise and, together with your allies, guess at the same time which one is disguised. Each player who guesses correctly deals 1 damage to that player; each player who guesses wrong randomly discards two hand cards, or loses 1 HP instead if they do not have enough hand cards.",
  [":mobile__daoshu_role_mode"] = "Once per Action phase, you can choose another player with at least 2 hand cards. That player chooses one of three random card names and disguises a hand card with a different card name as a card of that name, then you look at their hand cards after the disguise and guess which one is disguised. Each player who guesses correctly deals 1 damage to that player; each player who guesses wrong randomly discards two hand cards, or loses 1 HP instead if they do not have enough hand cards.",
  [":mobile__diancai"] = "At the end of another player's Action phase, if you lost at least X cards during that phase (X is your HP), you can draw cards until you have as many hand cards as your max HP.",
  [":mobile__dianhua"] = "In your Prepare phase or Finish phase, you can view the top X cards of the draw pile (X is the number of your marks), then put these cards back on top of the draw pile in any order.",
  [":mobile__diaodu"] = "In your Prepare phase, you can move an equip card on the field, then the player who loses a card this way draws a card.",
  [":mobile__dingfa"] = "At the end of your Discard phase, if the number of cards you lost this turn is not less than 4, you can choose one option: 1. heal 1 HP; 2. discard up to two cards from a player.",
  [":mobile__falu"] = "(forced) After your cards are moved to the discard pile by being discarded, you obtain the corresponding marks according to the suits of those cards:<br>♠, you obtain 1 \"Purple Star\";<br>♣, you obtain 1 \"Earth Queen\";<br><font color='red'>♥</font>, you obtain 1 \"Jade Purity\";<br><font color='red'>♦</font>, you obtain 1 \"Hook Star\".<br>You can have at most one of each mark. At the start of the game, you obtain all four marks above.",
  [":mobile__fengji"] = "(forced) At the start of your turn, if your number of hand cards is not less than the number you had after the end of your previous turn, you draw three cards and your hand limit this turn is equal to your max HP.",
  [":mobile__fenxin"] = "Before a player you have killed reveals their role card, you can choose one:<br>1. if their camp is different from yours, gain all skills on their character card (except once-per-game, awaken, mission, lord and persistent skills);<br>2. exchange role cards with them (selectable only while neither your role card nor theirs is revealed).",
  [":mobile__fozong"] = "(forced) Your hand cards with the same color as the cards you obtained through Pure Land do not count toward your hand limit, and the amount of damage you deal and of HP you recover is +1.",
  [":mobile__fuhaiw"] = "Once per Action phase, you can make all other players choose Rising Tide or Ebbing Tide at the same time, then you draw X cards (X is the number of players who chose the same option consecutively, starting from your next player).",
  [":mobile__fujian"] = "(forced) In your Finish phase, you randomly view X hand cards of another player (X is the number of hand cards of the player with the fewest hand cards).",
  [":mobile__funan"] = "When another player uses or plays a card to respond to a card you use, you can obtain the card they used or played.<br>⬤ Level 2: When another player uses or plays a card to respond to a card you use, you can obtain the card they used or played; after the settlement of a card you use that was obtained this way ends, if no other player responded to that card, you draw a card.",
  [":mobile__funan_update"] = "When another player uses or plays a card to respond to a card you use, you can obtain the card they used or played; after the settlement of a card you use that was obtained this way ends, if no other player responded to that card, you draw a card.",
  [":mobile__geyuan"] = "When you use a card whose number is X (X is the value of the first digit after the decimal point of pi), you can draw Y cards and adjust X to the value of the next digit (Y is the number of times you have used this skill this turn plus 1, and at most pi).",
  [":mobile__gongsun"] = "At the start of your Action phase, you can discard two cards and choose another player, then declare the name of a basic card or a normal trick card. If you do, until the start of your next turn or until you die, neither you nor they can use, play or discard hand cards with that name.",
  [":mobile__guixiu"] = "(forced) In your Finish phase, if your HP is odd, you draw a card; otherwise you recover 1 HP.",
  [":mobile__hanzhan"] = "Once per Action phase, you can choose another player; you and they each draw until you have X hand cards (X is each player's own max HP, and each player draws at most three cards), then it counts as you using a Duel on them.",
  [":mobile__huishi"] = "Once per Action phase, if your max HP is less than 10, you can judge. If the suit differs from every other judgement result in this process and your max HP is less than 10, you can gain 1 max HP and repeat this process. Finally you give all judgement cards that took effect in this process to a player, and if they have the most hand cards in play, you lose 1 max HP.",
  [":mobile__huxiao"] = "Once per Action phase, you can choose one: 1. deal 1 fire damage to a player whose HP is not less than yours; 2. cards you use this turn have no distance restriction; Desperate Stand: discard a red card.",
  [":mobile__jianji"] = "Once per Action phase, you can secretly choose a hand card and make two players point fight; the player who wins counts as using a Slash with no distance restriction against the player who did not win. During this point fight, those players can secretly choose to use the card you chose for the point fight instead, then if that card is a Slash, you deal 1 damage to the player who chose to point fight with it.",
  [":mobile__jiaohua"] = "Twice per Action phase, you can make a player obtain from the draw pile a card of a type that has not been chosen this way; after every type has been chosen, reset the chosen types.",
  [":mobile__jiexun"] = "In your Finish phase, you can choose a suit and make another player draw cards equal to the number of cards of that suit on the field (up to 5), then they discard X cards (X is the number of times this skill has been used). If they discard all their hand cards this way, you upgrade Rebuttal.",
  [":mobile__jieyu"] = "In your Finish phase, you can randomly obtain X basic cards with different names from the discard pile (X is 3 minus the number of times you have been the target of another player's Slash or damage-dealing trick card from the last time you used this skill up to this phase, and X is at least 1).",
  [":mobile__jieyuan"] = "When you deal damage, you can choose one: 1. obtain a black card from the draw pile; 2. discard a black card, this damage +1. When you take damage, you can choose one: 1. obtain a red card from the draw pile; 2. discard a red card, this damage -1. Desperate Stand: delete all effects under the other trigger timing and upgrade this skill - the number of cards obtained becomes two, and the damage increase or decrease becomes 2.",
  [":mobile__jieyuan_black"] = "When you deal damage, you can choose one: 1. obtain two black cards from the draw pile; 2. discard a black card, this damage +2.",
  [":mobile__jieyuan_red"] = "When you take damage, you can choose one: 1. obtain two red cards from the draw pile; 2. discard a red card, this damage -2.",
  [":mobile__jilue"] = "When you gain this skill, you gain Demonic Talent, then gain a skill matching your kingdom:<br>Wei, Exile; Shu, Wisdom; Wu, Balance; Neutral, Absolute Kill.<br>At the start of your Action phase, you can choose one option: 1. remove X Forbearance marks, then choose and gain one skill from Ultimate Strategy that you do not have (X is the number of times you have chosen this option +1, and at least 2); 2. remove up to two Forbearance marks, then draw that many cards.",
  [":mobile__jimeng"] = "At the start of your Action phase, you can obtain a card from another player, then you give that player X cards (X is your HP).",
  [":mobile__jincui"] = "(once per game) In your Action phase, you can swap seats with another player, then you lose X HP (X is your HP minus the number of times you have used Guard the Court this game). If you did not lose HP this way, you gain 1 max HP, then the Desperate Stand option is removed from Guard the Court.",
  [":mobile__jingong"] = "Once per Action phase, you can use an equip card or a Slash as a trick card (choose one of three: two random normal trick cards, plus one card chosen at random between Beauty Trap and Knife Behind a Smile), then in this turn's Finish phase, if you have dealt no damage this turn, you lose 1 HP.",
  [":mobile__jintao"] = "(forced) The Slashes you use have no distance restriction and your Slash use limit +1. The first Slash you use in your Action phase cannot be responded to; the base damage value of the second Slash +1.",
  [":mobile__juexiang"] = "When you die, the player who killed you discards all cards in their equip area and loses 1 HP, then you can make another player gain the skill Lingering Echo; that player can discard a ♣ card on the field, then gain the skill Final Echo.",
  [":mobile__jujun"] = "(forced) At the end of a phase in which you have been the target of a card and your HP has changed, it counts as using an Archery Attack.",
  [":mobile__kuangcai"] = "At the start of your Action phase, you can set your active play time for this phase to 5 seconds. If you do, you use cards this phase with no distance restriction and no limit on the number of uses, and when you use a card, you draw a card and your active play time -1 second (you can draw at most five cards this way each phase).",
  [":mobile__kuangxiang"] = "Once per Action phase, you can exchange hand cards with another player whose hand count is no greater than yours. Until the start of your next Action phase, after you or they lose all the hand cards obtained this way, you can carry out the effect of Foster Growth once.",
  [":mobile__lianji"] = "Once per Action phase, you can choose two players; the first player randomly uses a weapon card from the draw pile, then it counts as randomly using one of the following cards on the second player: Slash, Duel, Fire Attack, Savage Assault, Archery Attack. If damage is dealt to the target player, you obtain that many \"Chain Stratagem\" marks.",
  [":mobile__lianpo"] = "After you kill another player, you can choose one: 1. gain an extra turn after this turn ends (once per turn); 2. if you have Ultimate Strategy, choose and gain one skill of Ultimate Strategy that you do not already have.",
  [":mobile__lianzhu"] = "Once per Action phase, you can show a card and give it to another player. This phase you use cards on the player who has that card with no distance or count restriction, and after you deal damage to them you can obtain that card.<br>After another player obtains that card during this phase, they choose one option: 1. give you a card other than that card, then give that card to the player who acts before them; 2. make you draw two cards.",
  [":mobile__liechi"] = "(forced) When you enter the dying state, the damage source discards a card.",
  [":mobile__lingren"] = "Once per phase, after you designate the first target for a Slash or a damage-dealing trick card during your Action phase, you can guess whether the hand card area of one of the target players contains a basic card, a trick card or an equip card. If you guess correctly: at least one of them, the damage this card deals to them is increased by 1; at least two of them, you draw two cards; all three, you obtain Villainous Hero and Mourning until the start of your next turn.",
  [":mobile__lirang"] = "At the start of another player's Draw phase, if you do not have the \"Modesty\" mark, you can gain the \"Modesty\" mark and make them draw two extra cards. If you do, at the end of that turn's Discard phase, you obtain up to two of the cards they discarded during that phase. Before your Draw phase begins, if you have the \"Modesty\" mark, you skip this phase and remove the \"Modesty\" mark.",
  [":mobile__meibu"] = "At the start of another player's Action phase, if you are within their ATK range, you can discard a card, then they are regarded as having the skill Cease Fire this turn. If the card you discarded this way is not a Slash or a black trick card, the distance between them and you is 1 this turn.",
  [":mobile__mingfa"] = "In your Finish phase, you can show a card. At the start of the first Action phase of your next turn, if that card is still among your hand cards or in your equip area, you can point-fight with it against another player. If you: win, you obtain a card from them and randomly obtain a card with number X from the draw pile (X is the number of your point-fight card minus 1); do not win, you cannot use cards on other players this turn. After your point-fight card is revealed, you make its number +2.",
  [":mobile__mingshi"] = "(forced) After you take damage, if you have the \"Modesty\" mark, the damage source must discard a card from their areas; if the discarded card is: black, you obtain it; red, you recover 1 HP.",
  [":mobile__moucheng"] = "(awaken) After a player deals damage, if you have more than 2 \"Chain Stratagem\" marks, you increase your max HP by 1, heal 1 HP, lose Chain Stratagem and obtain Vaunted Merit.",
  [":mobile__mumu"] = "At the start of your Action phase, you can choose one: discard an equip card in play; or obtain an armor card in play, then you cannot use or play Slash this turn.",
  [":mobile__mutao"] = "Once per Action phase, you can choose a player and make them put all Slashes in their hand onto their character card, then they give these Slashes at random one by one to each player, starting with the player next to them, then they deal X damage to the last player (X is the number of Slashes in the last player's hand, up to 2).",
  [":mobile__natu_fu"] = "After you use a trick card, you can trigger this skill. If this card:<br>1. has a name different from every Revival card in your hand, you make the player with the unique lowest HP recover 1 HP;<br>2. has a name that only you have used this game, you deal 1 fire damage to a player.<br>Ride the Momentum: all numbers in this execution of the effect +1.",
  [":mobile__natu_heng"] = "Once per round, if you have no:<br>1. non-damage cards in hand, you can count as using or playing a Dodge;<br>2. damage cards in hand, you can count as using or playing a Slash that does not count toward your limit and has no limit on the number of uses.",
  [":mobile__natu_lie"] = "After you use a basic card, you can adjust your hand card count to X (X is the number of times you have used this skill this turn +1, at most 5). If you discarded cards to do so, you can deal 1 damage to a player.",
  [":mobile__natu_xing"] = "At the start of the game, you obtain from the draw pile one card of each card name among the trick cards that can designate targets, called Revival (they cannot be used or discarded and do not count toward your hand limit). X times per turn (X is the number of damage cards you have used this turn), after you deal damage, one random Revival card becomes usable. If there is no unusable Revival card in your hand, the cards you use have no distance or use-count restriction and cannot be responded to.",
  [":mobile__natu_yi"] = "Once per Action phase, you can make up to two players each give you a card, then choose one:<br>1. use these cards as a Slash against one of those players (it does not count toward the use limit and has no distance or use limit); during this Slash's resolution, they cannot use hand cards of the same color as the cards it was converted from;<br>2. distribute these cards to players who were not targeted; after one of them uses a black card obtained this way and chooses another player as a target, that target's non-forced skills are invalid this turn.",
  [":mobile__niluan"] = "During another player's Finish phase, if they have used a card on a player other than themselves this turn, you can use a Slash against them (with no distance restriction); then, after that Slash finishes resolving, if that Slash dealt damage to them, you discard one of their cards.",
  [":mobile__qianlong"] = "(persistent) At the start of the game, you gain 20 Resolve; you gain the corresponding amount of Resolve in the following situations: after you take 1 damage -- 10; after you deal 1 damage -- 15; after you obtain cards -- 5.<br>Based on your Resolve you count as having the following skills: 25 - Upright; 50 - Wine Poetry; 75 - Banishment; 99 - Resolute Advance. Your Resolve has a maximum of 99.",
  [":mobile__qiantun"] = "(kingdom) Wei skill. Once per Action phase, you can make another player who has hand cards show at least one hand card, then you point fight with them (they can only use the shown cards for the point fight). If you win, you obtain the hand cards they showed; if you do not win, you obtain their unshown hand cards. (In Landlord mode, you obtain at most two cards.)",
  [":mobile__qiantun_1v2"] = "(kingdom) Wei skill. Once per Action phase, you can make another player who has hand cards show at least one hand card, then you point fight with them (they can only use the shown cards for the point fight). If you win, you obtain the hand cards they showed; if you do not win, you obtain their unshown hand cards. (You obtain at most two cards.)",
  [":mobile__qiantun_role_mode"] = "(kingdom) Wei skill. Once per Action phase, you can make another player who has hand cards show at least one hand card, then you point fight with them (they can only use the shown cards for the point fight). If you win, you obtain the hand cards they showed; if you do not win, you obtain their unshown hand cards.",
  [":mobile__qianxinz"] = "Once per Action phase, you can hand out up to two hand cards at random, one each, to the same number of other players; these are called Letters. Then, in such a player's next Prepare phase, if they have a Letter, they choose one option: 1. you draw two cards; 2. their hand limit this turn -2.",
  [":mobile__qingxian"] = "Once per Action phase, you can choose up to X other players and discard the same number of cards (X is your HP). For each of these players, if the number of cards in their equip area is: less than yours, they recover 1 HP; greater than yours, they lose 1 HP; equal to yours, they draw a card. If the number of targets you chose is equal to X, you draw a card.",
  [":mobile__qizhou"] = "(forced) You gain the following skills according to the number of suits among the cards in your equip area: at least 1 suit - Handsome; at least 2 suits - Surprise Raid; at least 3 suits - Whirlwind.",
  [":mobile__renjie"] = "(forced) Up to four times per round, when you need to use or play a card to respond to a card, if you are not the user of that card and you do not respond, you gain an Endure mark.",
  [":mobile__runwei"] = "Once per Action phase, you can show up to five cards from the top of the draw pile and make a player obtain all the cards of one colour among them. If you do: 1. once per phase, after you lose X cards (X is the number of cards they obtained this way), this skill can be used again, and it cannot target a player who has obtained cards this turn; 2. at the end of this phase, you discard the hand cards you obtained this way.",
  [":mobile__sanchen"] = "(awaken) In your Finish phase, if you have 3 Armoury marks, you gain 1 max HP, recover 1 HP, then gain the skill Conquer Wu.",
  [":mobile__saojian"] = "Once per Action phase, you can look at another player's hand cards and choose one of them, then they repeatedly discard a hand card until they have discarded five cards or discarded the card you chose.",
  [":mobile__shajue"] = "(forced) When another player enters the dying state, if they need more than one Peach or Alcohol to be saved, you gain a Cruelty mark and obtain the card that made them enter the dying state.",
  [":mobile__shangyi"] = "Once per Action phase, you can discard a card and choose another player who has hand cards; they look at your hand cards, then you look at their hand cards and obtain one of them.",
  [":mobile__shanxi"] = "At the start of your Action phase, you can discard a red basic card and choose another player, then put up to X of their cards on their character card (X is your HP); at the end of this turn they obtain those cards.",
  [":mobile__shejian"] = "At the end of your Discard phase, if you discarded at least two cards this phase and their suits are all different, you can discard a card from another player.",
  [":mobile__shiju"] = "(forced) After a card you use finishes resolving, if this card and the last card used before you used it are: of the same type, you obtain the top card of the draw pile; of the same suit, you obtain the bottom card of the draw pile. <a href='#ChengShi'>Ride the Momentum</a>: if the card names are also the same, you gain or upgrade the skill <a href=':kubai'>Withered White</a>.",
  [":mobile__shuaiyan"] = "At the start of your Discard phase, if your hand card count is greater than 1, you can show all your hand cards and make another player give you a card.",
  [":mobile__shushen"] = "Once per turn each, after you recover HP, you can make another player draw two cards; after you get cards, if the number of those cards is greater than 1, you can make another player recover 1 HP.",
  [":mobile__sidai"] = "(once per game) In your Action phase, you can use all your basic cards as a Slash (it does not count toward the number of uses). If those cards include: a Peach, after this Slash deals damage, the player who took the damage loses 1 max HP; a Dodge, the target of this Slash must discard a basic card, otherwise they cannot respond.",
  [":mobile__songshu"] = "At the start of the Draw phase of another player whose HP is greater than yours, if there are cards in the \"Benevolence\" area, you can make them give up drawing and obtain X cards from the \"Benevolence\" area instead (X is your HP, up to a maximum of 5). If you do, this turn the cards they use cannot target other players.",
  [":mobile__tianshu"] = "At the start of your Action phase, if <a href=':js__peace_spell'>Peace Spell</a> is not in the game, or is in the draw pile or the discard pile, you can discard a card and make a player obtain Peace Spell and use it.",
  [":mobile__tianyi"] = "(awaken) At the start of your Prepare phase, if every living player has taken damage this game, you gain 2 max HP, recover 1 HP, and make a player gain the skill Auspicious Aid.",
  [":mobile__tongdu"] = "Once per turn, when you become the only target of a card used by another player, you can make a player recast a card.",
  [":mobile__tongji"] = "When another player becomes the target of a Slash, if you are within their ATK range and you are not the user of this Slash, they can discard a card to transfer this Slash to you.",
  [":mobile__wangliec"] = "At the start of your Action phase, you can choose a hand card. Your use of this card this phase has no distance restriction and cannot be responded to, and after your use of this card finishes resolving, you cannot use cards on other players this phase.",
  [":mobile__wangzun"] = "(forced) In the Prepare phase of a player whose HP is greater than yours, you draw a card (if they are the Lord or the Landlord, you draw one extra card and their hand limit this turn is reduced by 1).",
  [":mobile__wanwei"] = "Once per round, when another player enters the dying state, or during your Action phase when you choose another player, you can make them recover X+1 HP (if that is not enough to save them from the dying state, they instead recover to 1 HP), then you lose X HP (X is your HP).",
  [":mobile__weisi"] = "(Neutral kingdom) Once per Action phase, you can choose another player and make them move any number of their hand cards out of the game until the end of the turn, then it counts as using a Duel on them; after this card deals damage to them, you obtain all their hand cards (in Landlord mode, all becomes one).",
  [":mobile__weisi_1v2"] = "(Neutral kingdom) Once per Action phase, you can choose another player and make them move any number of their hand cards out of the game until the end of the turn, then it counts as using a Duel on them; after this card deals damage to them, you obtain one of their hand cards.",
  [":mobile__weisi_role_mode"] = "(Neutral kingdom) Once per Action phase, you can choose another player and make them move any number of their hand cards out of the game until the end of the turn, then it counts as using a Duel on them; after this card deals damage to them, you obtain all their hand cards.",
  [":mobile__wuji"] = "(once per game) During your Action phase, you can modify Vengeance (after using a Vengeance card, draw a card) until the end of this phase; if you obtain at least two cards from Vengeance this phase, you instead modify Vengeance permanently.",
  [":mobile__xiahui"] = "(forced) Your black cards do not count toward your hand limit; when another player obtains a Chain Execution card or a black card of yours, they cannot use, play, or discard those cards until their HP decreases.",
  [":mobile__xiaoxi"] = "You can use or play a black card as Slash.",
  [":mobile__xiezheng"] = "In your Finish phase, you can make up to one player (in Landlord mode, up to two players instead, once per game) each place a random hand card on top of the draw pile, then it counts as you using a Besiege (in Role mode, you must give priority to targeting players of the same kingdom). After it resolves, if it dealt no damage, you lose 1 HP.",
  [":mobile__xiezheng_1v2"] = "Once per game, in your Finish phase, you can make up to two players each place a random hand card on top of the draw pile, then it counts as you using a Besiege. After it resolves, if it dealt no damage, you lose 1 HP.",
  [":mobile__xiezheng_2v2"] = "In your Finish phase, you can make one player place a random hand card on top of the draw pile, then it counts as you using a Besiege. After it resolves, if it dealt no damage, you lose 1 HP.",
  [":mobile__xiezheng_role_mode"] = "In your Finish phase, you can make one player place a random hand card on top of the draw pile, then it counts as you using a Besiege (you must give priority to targeting players of the same kingdom). After it resolves, if it dealt no damage, you lose 1 HP.",
  [":mobile__xiezheng_role_mode2"] = "In your Finish phase, you can make one player place a random hand card on top of the draw pile, then it counts as you using a Besiege. After it resolves, if it dealt no damage, you lose 1 HP.",
  [":mobile__xionghuo"] = "At the start of the game, you gain 3 Cruelty marks. During your Action phase, you can give one Cruelty mark to another player. Damage you deal to other players who have this mark is +1, and at the start of their Action phase, they remove a Cruelty mark and one of the following happens at random: 1. they take 1 fire damage and cannot use Slash on you this turn; 2. they lose 1 HP and their hand limit is -1 this turn; 3. you obtain a random hand card of theirs and a random card from their equip area.",
  [":mobile__xuehen"] = "After you deal or take damage for the first time each turn, you can show up to X hand cards (X is your lost HP); these cards count as Slash with no limit on the number of uses, until you deal damage with these cards.",
  [":mobile__xuehen_update"] = "After you deal or take damage for the first time each turn, you can show up to X hand cards (X is your lost HP); these cards count as Slash with no limit on the number of uses, until you deal damage with these cards. After a Slash converted this way finishes resolving, you draw a card.",
  [":mobile__xuewei"] = "In your Prepare phase, you can mark another player (visible only to you). If you do, until the start of your next turn, when the player you marked takes damage for the first time, you prevent this damage and take that much damage instead, then you deal that much damage of the same element to the damage source.",
  [":mobile__xunjie"] = "(forced) When you take damage, if there is no Great Siege Engine - Offense or Great Siege Engine - Defense in play, and the damage source's HP is greater than yours, you make a judgement; if the result is red, this damage is reduced by 1.",
  [":mobile__xushen"] = "(once per game) During your Action phase, you can draw up to three cards and lose that much HP. If you enter the dying state because of this, then after you leave the dying state, you can distribute \"<a href=':wusheng'>Warrior Saint</a>\", \"<a href=':dangxian'>Vanguard</a>\" and \"<a href=':zhiman'>Subdue Barbarians</a>\" among the players who recovered HP for you during this dying resolution (if such a player already has the corresponding skill, they draw three cards instead).",
  [":mobile__yanjiao"] = "Once per Action phase, you can give all hand cards of one suit to another player, then deal 1 damage to them. If you do, at the start of your next turn you draw X cards (X is the number of cards you gave this way).",
  [":mobile__yilie"] = "(forced) At the start of the game, you choose another player.<br>When that player takes damage, if you have no Ardor marks, you gain Ardor marks equal to the damage amount, then prevent this damage;<br>After that player deals damage to another player, you recover 1 HP;<br>In your Finish phase, if you have Ardor marks, you draw a card and lose X HP (X is the number of your Ardor marks), then remove all your Ardor marks.",
  [":mobile__yimou"] = "After a player at distance 1 or less from you takes damage, you can choose one: 1. make them obtain a Slash from the draw pile; 2. make them give a hand card to another player and draw a card.",
  [":mobile__yingbing"] = "(forced) When a player who has a Curse uses a card of the same suit as that Curse, you draw a card; if this is the second time you have drawn a card because of that Curse, remove that Curse.",
  [":mobile__yinju"] = "Once per Action phase, you can make another player choose one: 1. at the start of the Prepare phase of their next turn, they skip their Action phase and Discard phase that turn; 2. use a Slash on you with no distance restriction.",
  [":mobile__yizheng"] = "Once per Action phase, you can point fight with a player whose HP is not greater than yours. If you: win, they skip their next Draw phase; do not win, you lose 1 max HP.",
  [":mobile__yuanmo"] = "Twice per turn, at your Prepare phase or after you take damage, you can move a card in play, then you can make the player who lost the card this way draw X cards (X is the number of players by which their ATK range was reduced because of this, up to 5).",
  [":mobile__yuejian"] = "Your hand limit equals your max HP; when you enter the dying state, you can discard two cards to recover 1 HP.",
  [":mobile__yufeng"] = "Once per Action phase, you can perform one <a href=':mobile__yufeng_href'>Ride the Wind</a>. If it fails, you draw X cards; if it succeeds, you can choose up to X other players, and in their next Prepare phase they make a judgement: if the result is black, they skip their Action phase and Discard phase; if the result is red, they skip their Draw phase; if you choose fewer than X players, each remaining point instead lets you draw a card (X is your Ride the Wind score, at most 3).",
  [":mobile__yufeng_href"] = "Reveal a random card from among the draw pile and the discard pile, then repeatedly guess whether the next revealed card has a higher or lower rank than the previously revealed one, until you reach the score cap or guess wrong (2 or 3 points); each correct guess scores one point.",
  [":mobile__zengou"] = "Once per Action phase, you can look at all of a player's hand cards, then choose one option:<br>1. it counts as using two basic cards whose names are not among their hand cards (not counting toward the use limit and with no limit on the number of uses);<br>2. you and they each in turn replace the cards in your hand areas that share a card name with an equal number of Slashes from the draw pile (Slashes obtained this way do not count toward the hand limit until the end of your respective turns).<br>Then they gain a Slander mark naming a basic card you specify. After the first card a player with this mark uses each turn resolves, if it has the same name as the recorded one, they remove this mark and lose 1 HP.",
  [":mobile__zhaoxiong"] = "(persistent) (once per game) In your Prepare phase, if you are wounded, you can change your kingdom to Neutral, then you gain the skill Purge Dissent (in Role mode, the clause about giving priority to targeting players of the same kingdom is deleted from Coerced Campaign).",
  [":mobile__zhaoxiong_1v2"] = "(persistent) (once per game) In your Prepare phase, if you are wounded, you can change your kingdom to Neutral, then you gain the skill Purge Dissent.",
  [":mobile__zhaoxiong_role_mode"] = "(persistent) (once per game) In your Prepare phase, if you are wounded, you can change your kingdom to Neutral, then you gain the skill Purge Dissent, and the clause about giving priority to targeting players of the same kingdom is deleted from Coerced Campaign.",
  [":mobile__zhenfeng"] = "(once per game) In your Action phase, you can choose one option: 1. recover 2 HP; 2. change the X in Fierce Battle and the X in Blazing War each to one of your current HP, your lost HP, or the number of living players (you can only choose an option for a skill you have).",
  [":mobile__zhennan"] = "After a player designates the first target of a non-delayed trick card, if you are among the targets and the number of targets is greater than X (X is the user's HP, and at least 1), you can discard a card to deal 1 damage to a player.",
  [":mobile__zhenyi"] = "You can discard the corresponding mark at the following timings to trigger the following effects:<br>Before a judgement card takes effect, you can discard \"Purple Star\", then change the judgement result to ♠5 or <font color='red'>♥5</font> and end this timing;<br>While you are dying, you can discard \"Earth Queen\", then use one of your hand cards as Peach;<br>When you deal damage, you can discard \"Jade Purity\", then perform a judgement, and if the result is black, the damage is increased by 1;<br>After you take elemental damage, you can discard \"Hook Star\", then you randomly obtain one card of each of three card types from the draw pile or the discard pile.",
  [":mobile__zhixi"] = "(forced) During your Action phase, you can use at most X cards (X is your HP). After you use a trick card, your Action phase ends.",
  [":mobile__zhoufu"] = "Once per Action phase, you can place a hand card next to the character card of another player who has no Curse; it is called a Curse. When a player who has a Curse makes a judgement, the Curse is used as the judgement card. At the end of a player's turn, you make each player whose Curse was removed this turn lose 1 HP.",
  [":mobile__zhouxuanz"] = "Once per Action phase, you can choose another player and choose a type of non-basic card or the name of a basic card. If the first card that player then uses or plays matches your choice, you look at the top three cards of the draw pile and distribute them to any players.",
  [":mobile__zishu"] = "(forced) Outside your turn, all hand cards you obtain are put into the discard pile at the end of the current turn's Finish phase; during your turn, when you obtain hand cards other than through this skill's effect, you draw a card.",
  [":mobile_dongjiao__weizhuang"] = "Once per turn for each option, if the number of card types among your <a href='#CardDisplayedDesc'>revealed cards</a> is not less than: 1, the value of basic cards you use is +1; 2, after you use a trick card and choose its first target, you can obtain one card from another player among the targets; 3, after an equip card you use finishes resolving, you can make a player who has <a href='#CardDisplayedDesc'>revealed cards</a> draw two cards.",
  [":mobile_qianlong__fangzhu"] = "(persistent) Once per Action phase, you can choose one option for another player to carry out (you cannot choose the player you last chose this way since the start of your previous turn): 1. until the end of their next turn, they cannot use hand cards other than trick cards; 2. until the end of their next turn, all their skills are invalid.",
  [":mobile_qianlong__jiushi"] = "(persistent) When you need to use an Alcohol, if your character card is face up, you can turn your character card over, and it counts as using an Alcohol; after you take damage, if your character card is face down and you have not used Wine Poetry for this damage, you can turn your character card over; after you turn your character card over, you obtain a random trick card from the draw pile.",
  [":mobile_qianlong__qingzheng"] = "(persistent) At the start of your Action phase, you can choose another player who has hand cards; you discard all your hand cards of one suit, then look at their hand cards and choose a suit, and they discard all their hand cards of that suit. If you do and the number of cards you discarded this way is greater than the number of hand cards they discarded, you deal 1 damage to them.",
  [":mobile_xiuge__weizhuang"] = "Once per turn for each option, you can discard a: 1. weapon card, and it counts as using any Slash; 2. armor card, and it counts as using a Dodge; defensive horse card, and it counts as using a Peach; offensive horse card, and it counts as using an Alcohol. Cards you use this way have no limit on the number of uses and do not count toward the use limit, and after they finish resolving you obtain one card of the discarded card's suit from the draw pile or the discard pile. If your <a href='#CardDisplayedDesc'>revealed cards</a> contain four suits, discarding in this skill becomes showing.",
  [":moucuan"] = "(awaken) In your Prepare phase, if your number of Troops is not less than X (X is the number of kingdoms in play), you lose 1 max HP, then gain the skill Scourge of War.",
  [":mowang"] = "(forced) When you are about to die, if you have the skill Partisan Ban and you still have unrevealed Attendant cards, you recuperate for one round instead; at the end of the turn, you die.",
  [":muzhen"] = "Once per Action phase for each, you can: put an equip card into another player's equip area, then obtain a hand card from them; give two cards to another player who has cards in their equip area, then obtain a card from their equip area.",
  [":mxing__zhiyan"] = "Once per Action phase for each option, you can choose one: 1. draw until your hand size equals your max HP, then you cannot use cards on other players for the rest of this phase; 2. give X hand cards to another player (X is your hand size minus your HP).",
  [":naxue"] = "You can skip your Action phase. If you do, you can discard any number of cards, draw that many cards, then give up to two other players a card each.",
  [":nigu"] = "Once per Action phase, you can discard at least one card, all of different suits, and make the players in your ATK range simultaneously choose whether to give you a card. Then the next X instances of damage you deal this turn are +1 (X is the number of players who chose not to give you a card).",
  [":nioh_shield"] = "Nioh Shield (equip card, armor)<br /><b>Armor skill</b>: Black Slash has no effect on you.",
  [":nos__cunsi"] = "Once per Action phase, you can turn your character card face down to make a player obtain a Slash; the damage dealt by the next Slash they use +1.",
  [":nos__guixiu"] = "(forced) After you take damage, you turn your character card face up; after your character card is turned face up, you draw a card.",
  ...
  [":offensive_siege_engine"] = "Equip card - Weapon<br/><b>ATK range</b>: 9<br /><b>Durability</b>: 2<br /><b>Weapon skill</b>: after this card enters your equip area, discard the other cards in your equip area; before another equip card enters your equip area, put it into the discard pile instead; when you deal damage, you can reduce this card's durability by 1 to make this damage +X (X is the number of game rounds, at most 3); when this card would leave your equip area for a reason other than Siege Ram, prevent it, then this card's durability is -1; when this card's durability drops to 0, destroy this card.",
  [":pangtong__gongli"] = "(forced) If your ally Friend Zhuge Liang is in play, Cultivate Fame reveals 1 more card; if your ally Friend Xu Shu is in play, after you trigger Cultivate Fame you obtain one of the cards revealed this time whose suit was not used. (Only in Fight the Landlord and 2v2 modes)",
  [":pangtong__gongli_xushu"] = "(forced) If your ally Friend Xu Shu is in play, after you trigger Cultivate Fame you obtain one of the cards revealed this time whose suit was not used.",
  [":pangtong__gongli_zhugeliang"] = "(forced) If your ally Friend Zhuge Liang is in play, Cultivate Fame reveals 1 more card.",
  [":panxiang"] = "When a player takes damage, you can choose one (you cannot choose the option you chose the last time you triggered this skill on that player): 1. this damage -1, then the damage source draws two cards; 2. this damage +1, then they draw three cards.",
  ...
  [":peidong"] = "You can take <a href=':m_liuyi__liulongcanjia'>Six Dragon Chariot</a> and:<br />move it from your equip area to the next player, which counts as using a Slash;<br />obtain it from another player's field, which counts as using a Dodge;<br />reveal it from your hand or the draw pile, which counts as using a Peach;<br />put it from outside the game into your treasure slot, which counts as using an Alcohol.",
  [":pingcai"] = "Once per Action phase, you can pick a treasure and wipe the dust off it. If the wipe succeeds, you can perform the effect matching the treasure's type:<br>Crouching Dragon: deal 1 fire damage to a player. If a living Crouching Dragon Zhuge Liang is on the field, this becomes dealing 1 fire damage to each of up to two players.<br>Fledgling Phoenix: chain up to three players. If a living Pang Tong is on the field, this becomes chaining up to four players.<br>Water Mirror: move an armor card on the field. If a living Sima Hui is on the field, this becomes moving an equip card on the field.<br>Mystic Sword: make a player draw a card and recover 1 HP. If a living Xu Shu is on the field, this becomes making a player draw a card and recover 1 HP, then you draw a card.",
  [":pinghe"] = "(forced) Your base hand card limit is your lost HP; when you take damage caused by another player, if your max HP is greater than 1 and you have hand cards, you prevent this damage, lose 1 max HP and give a hand card to another player, then if you have the skill Heroic Supremacy, the damage source gains a Pacify mark.",
  [":polu"] = "(forced) At the start of your turn, you obtain a <a href=':mobile__catapult'>Thunderbolt Catapult</a> from outside the game, the draw pile or the discard pile, and use it; after you take 1 damage, if there is no Thunderbolt Catapult in your equip area, you draw a card, then randomly obtain a weapon card from the draw pile and use it.",
  [":polus"] = "After you kill a player, or after you die, you can make any number of players each draw X cards (X is the number of times you have used this skill +1).",
  [":powei"] = "(mission) At the start of the game, you make all other players gain the Siege mark; at the start of a turn, you make every player who has the Siege mark move their Siege mark to the next player (if the next player is you, it moves to the player after you instead); after a player with the Siege mark takes damage, remove their Siege mark; at the start of the turn of a player who has Siege, you can choose one option and make yourself count as being within their ATK range this turn: 1. discard a hand card and deal 1 damage to them; 2. if their HP is not greater than yours, you obtain one of their hand cards.<br>\n  ⬤ Success: at the start of a turn, if there is no Siege mark in play, you gain the skill Divine Renown;<br>\n  ⬤ Failure: when you enter the dying state, if your HP is less than 1, you recover HP up to 1, remove all Siege marks in play, then discard all cards in your equip area.",
  [":poxiang"] = "Once per Action phase, you can give a card to another player, then draw three cards, remove all Valor and lose 1 HP; the cards you obtain this way do not count toward your hand limit this turn.",
  [":premeditate"] = "This is a Premeditate card. Premeditate cards are offered for use one by one in the next Judge phase, in reverse order of placement.",
  [":qianchong"] = "(forced) If all cards in your equip area are black, you have Curtain; if all cards in your equip area are red, you have Sagacity. At the start of your Action phase, if you meet neither of the above conditions, you choose a card type, and this phase you use cards of that type with no limit on the number of uses and no distance restriction.",
  [":qiangyong"] = "(forced) When a Slash you use deals damage, discard X cards from the damaged player (X is the number of times you have used Slash this turn), then if they have no hand cards, this Slash's damage is increased by 1.",
  [":qianxun"] = "(forced) You can't be the target of Snatch or Indulgence.",
  [":qiaosi"] = "Once per Action phase, you can perform the water-powered puppet show once and obtain the cards it yields, then choose one: 1. discard the same number of cards; 2. give the same number of cards to another player. (If you have fewer, give or discard all of them.)",
  [":qicai"] = "(forced) Your trick cards have unlimited range.",
  [":qihui"] = "(forced) When you use a card, if you have no mark for that card's type, you gain 1 Enlightenment mark of that type; then if you have 3 Enlightenment marks, you remove 2 Enlightenment marks and choose one: 1. heal 1 HP; 2. draw two cards; 3. the next card you use does not count toward the use limit and has no limit on the number of uses.",
  [":qingdao"] = "After a damage-dealing card used by another player finishes resolving, if you were among the targets, then: if you took damage from this card, you can obtain a Dodge from the draw pile or the discard pile, or discard a card in a player's area; if you did not take damage from this card, you can obtain a Slash from the draw pile or the discard pile, or use a hand card (with no distance restriction).",
  ...
  [":qingjue"] = "Once per round, when another player uses a card whose only target is another player with less HP than them, if no player is dying, you can draw a card and point fight with the user; if you win or you are not a legal target of this card, cancel this card; if you do not win and you are a legal target of this card, this card's target is changed to you.",
  [":qingnang"] = "Once per Action Phase: you can discard 1 hand card and select a wounded player; then, he heals 1 HP.",
  [":qingshix"] = "After you take damage, you can choose a player. If your kingdom and theirs are: the same, you and they each draw a card; different, you discard one card from each of you.",
  [":qingyu"] = "(mission) When you take damage, you must discard two hand cards and prevent this damage.<br>\n  ⬤ Success: in your Prepare phase, if you are unwounded and have no hand cards, you gain the skill Suspended Life.<br>\n  ⬤ Failure: when you enter the dying state, you lose 1 max HP and the mission fails.",
  [":qinying"] = "Once per Action phase, you can recast any number of cards, which counts as using a Duel. If you do, during the resolution of this Duel, up to X times (X is the number of cards you recast this way) you or the target player can discard a card in their area, which counts as playing a Slash.",
  [":qinying&"] = "You can discard a card in your area, which counts as playing a Slash.",
  [":qinzheng"] = "(forced) Each time you have used or played: three cards, you randomly obtain a Slash or a Dodge; five cards, you randomly obtain a Peach or an Alcohol; eight cards, you randomly obtain an Ex Nihilo or a Duel.",
  [":qirang"] = "After an equip card is placed into your equip area, you can randomly obtain a trick card from the draw pile; when you use that trick card there is no distance restriction and you draw a card.",
  [":qishe"] = "You can use an equip card as Alcohol; your hand limit is +X (X is the number of cards in your equip area).",
  [":qixi"] = "You can use any black card as Dismantlement.",
  [":quanchong"] = "(forced) Once per round, in your Finish phase, you discard all your cards and take an extra turn after the current turn ends. If your HP is not the unique highest in play, you lose 1 HP at the start of that turn.",
  [":quanfeng"] = "(once per game) After another player dies, you can <a href='memorialize'>memorialize</a> that player: you lose Grand Decorum, gain all skills on their character card (lord skills excepted), gain 1 max HP and recover 1 HP; when you are dying, you can gain 2 max HP and recover 4 HP.",
  [":quchong"] = "In your Action phase, you can recast an equip card; at the end of each turn, you remove the equip cards in the discard pile from the game and gain an equal number of casting points; at the start of your Action phase, if there is no Great Siege Engine in play (<a href=':offensive_siege_engine'>Great Siege Engine - Offense</a>, <a href=':defensive_siege_engine'>Great Siege Engine - Defense</a>), then according to the number of times you have cast you can pay 0, 5, 10, 10 casting points (in 2v2 or Landlord mode this becomes 0, 2, 5, 5) to choose one kind of Great Siege Engine and give it to a player and make them use it; otherwise you can give the Great Siege Engine in play to another player and make them use it.",
  [":quchong_1v2"] = "In your Action phase, you can recast an equip card; at the end of each turn, you remove the equip cards in the discard pile from the game and gain an equal number of casting points; at the start of your Action phase, if there is no Great Siege Engine in play (<a href=':offensive_siege_engine'>Great Siege Engine - Offense</a>, <a href=':defensive_siege_engine'>Great Siege Engine - Defense</a>), then according to the number of times you have cast you can pay 0, 2, 5, 5 casting points to choose one kind of Great Siege Engine and give it to a player and make them use it; otherwise you can give the Great Siege Engine in play to another player and make them use it.",
  [":quchong_role_mode"] = "In your Action phase, you can recast an equip card; at the end of each turn, you remove the equip cards in the discard pile from the game and gain an equal number of casting points; at the start of your Action phase, if there is no Great Siege Engine in play (<a href=':offensive_siege_engine'>Great Siege Engine - Offense</a>, <a href=':defensive_siege_engine'>Great Siege Engine - Defense</a>), then according to the number of times you have cast you can pay 0, 5, 10, 10 casting points to choose one kind of Great Siege Engine and give it to a player and make them use it; otherwise you can give the Great Siege Engine in play to another player and make them use it.",
  [":quesong"] = "During a player's Finish phase, if you have taken damage this turn, you can make a player choose one: 1. draw three cards (if the number of cards in their equip area is greater than 2, they draw two cards instead) and reset their character card; 2. recover 1 HP.",
  [":rangjie"] = "After you take 1 damage, you can choose one: 1. move a card in play; 2. randomly obtain a card of a type you name from the draw pile or the discard pile. Finally you draw a card.",
  [":recast"] = "Put this card into discard pile, then draw 1 card.",
  ...
  [":renshi"] = "(forced) When you take damage caused by a Slash, if you are wounded, you prevent this damage, obtain that Slash and lose 1 max HP.",
  [":renshih"] = "Once per Action phase for each player, you can give a hand card to another player.",
  [":renxing"] = "Up to twice each round, the first time each turn that a card is discarded outside the Discard phase, you can choose one: 1. you and the current turn player each draw a card; 2. discard a card from a player who has not used or played a Slash this turn.",
  [":reveal_skill&"] = "In action phase, you can reveal a character who has Forced skills.",
  [":rongbei"] = "(once per game) In your Action phase, you can choose a player who has an empty equip slot in their equip area; for each empty equip slot, they randomly use an equip card of the matching type from the draw pile or the discard pile.",
  [":ruilian"] = "At the start of each round, you can choose a player; before the end of their next turn, if they have discarded cards during that turn, you can choose one type among the cards they discarded that turn, then you and they each obtain a card of that type from the discard pile.",
  ...
  [":shameng"] = "Once per Action phase, you can discard two hand cards of the same color and choose another player; that player draws two cards, then you draw three cards.",
  [":shangjian"] = "(forced) At a player's Finish phase, if the number of cards you lost this turn (the number of cards lost other than by using equip cards, plus the number of cards that did not enter your equip area while you were using equip cards) is not greater than your HP, you draw that many cards.",
  [":shanjia"] = "Once per Action phase, you can draw three cards, then discard X cards (X is 3 minus the number of cards you have lost from your equip area this game). If you discarded no: basic card, you can count as using a Slash that does not count toward your limit and has no limit on the number of uses; trick card, your use of cards this phase has no distance restriction.",
  [":shanxie"] = "Once per Action phase, you can obtain a weapon card from the draw pile (if there is none, you randomly obtain a weapon card from another player's equip area). When another player uses a Dodge to respond to a Slash you used, if that Dodge has no number or its number is not greater than twice your ATK range, that Dodge has no effect.",
  [":shenpeij"] = "(once per game) When you enter the dying state, you can recover X HP (X is the number of times you have entered the dying state this game), deal that much thunder damage to a player and gain <a href=':huitian'>Turn the Tide</a>.",
  [":shenzhuo"] = "(forced) After a Slash you use that is neither converted nor virtual finishes resolving, you must choose one option: 1. draw a card, and the limit on the number of Slashes you can use this turn is +1; 2. draw three cards, and you cannot use Slash for the rest of this turn.",
  [":shepan"] = "Once per round for each card name, and once per turn, after you become the target of a damage-dealing card used by another player, you can choose one: 1. draw a card; 2. put one of their hand cards on top of the draw pile. Then if you and they have the same number of hand cards, this card has no effect on you.",
  [":sheque"] = "During another player's Prepare phase, if there are cards in their equip area, you can use a Slash against them with no distance restriction; this Slash ignores armor.",
  [":sheyi"] = "Once per round, when another player takes damage, if their HP is less than yours, you can give them at least X cards to prevent this damage (X is your HP).",
  [":shezi"] = "(forced) In your Prepare phase, you choose a player and choose one of their areas; if that area contains equip cards, you obtain all cards in that area.",
  [":shidi"] = "(forced) (toggle) At the start of your Prepare phase, switch to Yang; at the start of your Finish phase, switch to Yin; Yang: your distance to other players is -1, and black Slashes you use cannot be responded to; Yin: other players' distance to you is +1, and you cannot respond to red Slashes used on you by other players.",
  [":shihe"] = "Once per Action phase, you can start a point fight with another player. If you win, until the end of their next turn, prevent the damage they deal to friendly players; if you do not win, you discard a random card.",
  [":shiji"] = "When you deal elemental damage to another player, if your hand card count is not the single highest in the game, you can look at their hand cards and discard all red cards among them, then you draw that many cards.",
  [":shishoul"] = "(forced) After another player carries out one option of Aid and Guard, you carry out the other option of Aid and Guard.",
  [":shishu"] = "(forced) After another player obtains your cards during their own turn, you make them choose one option: 1. discard those cards; 2. give you a card whose type differs from that of every one of those cards.",
  [":shixin"] = "(forced) Prevent all fire damage you would take.",
  [":shizhong"] = "(forced) At the start of your Finish phase, you draw a card and show all your hand cards; at the start of your Prepare phase, you draw X cards (X is the number of cards still in your hand out of those you showed with Strength in Numbers last time), and if X equals the number of cards you showed last time, then when you deal damage this turn, change the damage amount to 100000!",
  [":shoufa"] = "After you deal damage for the first time each turn, you can choose a player at distance 2 or less from you; up to five times each turn, after you take damage, you can choose a player at distance greater than 1 from you (in Fight the Landlord, those distances become distance 1 or less from you, and distance not less than 1 from you); they carry out one random effect:<br>Leopard, they take 1 damage with no source;<br>Eagle, you obtain a random card from them;<br>Bear, you discard a random card from their equip area;<br>Rabbit, they draw a card.",
  [":shoufa_1v2"] = "After you deal damage for the first time each turn, you can choose a player at distance 1 or less from you; up to five times each turn, after you take damage, you can choose a player at distance not less than 1 from you; they carry out one random effect:<br>Leopard, they take 1 damage with no source;<br>Eagle, you obtain a random card from them;<br>Bear, you discard a random card from their equip area;<br>Rabbit, they draw a card.",
  [":shoufa_role_mode"] = "After you deal damage for the first time each turn, you can choose a player at distance 2 or less from you; up to five times each turn, after you take damage, you can choose a player at distance greater than 1 from you; they carry out one random effect:<br>Leopard, they take 1 damage with no source;<br>Eagle, you obtain a random card from them;<br>Bear, you discard a random card from their equip area;<br>Rabbit, they draw a card.",
  [":shouye"] = "Once per turn, after you become the only target of a card used by another player, you can hold a countermeasure with them; if your countermeasure succeeds, this card has no effect on you, and after this card finishes resolving, you obtain it.",
  ...
  [":shouyuez"] = "At the start of your Draw phase, or after your HP decreases, you can choose one: 1. draw a card and make a player gain the skill <a href=':qinyin'>Zither Song</a> (if they already have it, they draw a card instead); 2. make a player reset their character card.",
  [":shuanghuai"] = "Once per turn, when another player at distance 1 or less from you takes damage, you can choose one: 1. prevent this damage; 2. make them obtain a Peach from the discard pile. If that player is the same as the one from your last use of this skill, you and they each draw a card; if different, you lose 1 HP.",
  [":shuchen"] = "(forced) When a player enters the dying state, if the number of 'Benevolence' cards is at least 4, you obtain all 'Benevolence' cards, then make them recover 1 HP.",
  [":shuliang"] = "In a player's Finish phase, if their hand card count is less than their HP, you can remove one \"Grain\", then that player draws two cards.",
  [":shunyi"] = "When you use the hand card with the unique lowest number, if this card's suit is <font color='red'>♥</font> and its number is greater than X (X is the number of times you have triggered this skill this turn), you can place all hand cards of this suit face down on your character card until the end of the current turn, then you draw a card.",
  [":shunyi_inner"] = "When you use the hand card with the unique lowest number, if this card's suit is {1} and its number is greater than X (X is the number of times you have triggered this skill this turn), you can place all hand cards of this suit face down on your character card until the end of the current turn, then you draw a card.",
  [":shuxing"] = "Once per player during your turn, when another player becomes the target of a Slash, you can make this Slash have no effect on them, then show all their hand cards. If there is a Dodge among their hand cards, they must choose one option: 1. lose 1 HP; 2. give you every Dodge among them, and the next time an Uphold the Law choice is made, you choose in their place.",
  [":shuyong"] = "When you use or play a Slash, you can obtain a card in another player's area. Then if the number of cards you have obtained from their area this way this round is greater than 1, they draw a card.",
  [":sifeng"] = "At your Finish phase, you can distribute the top three cards of the draw pile in any order and place them face down on the character cards of up to two other players, called 'Waiting Blade'.<br>For a player with 'Waiting Blade' on their character card: after they use a card during their turn, you remove the first 'Waiting Blade' on their character card, and if the card they used differs in color from the removed 'Waiting Blade', they discard a hand card; at the end of their turn, if any 'Waiting Blade' has not been removed, you choose one: 1. obtain the 'Waiting Blade' on their character card; 2. remove the remaining 'Waiting Blade' on their character card, then deal 1 damage to them.",
  ...
  [":sizi"] = "(charge 4/4) Once per Action phase, you can spend at least 1 charge point, then gain the following effects until X turns have ended or your turn begins (X is the number of charge points spent this way): 1. when a player uses a Slash to deal damage, that damage +1; 2. at the end of a player's turn, you draw two cards, then each player who has used a Slash this turn loses 1 HP. If X is greater than your HP, you additionally gain the following effect: at the end of a player's turn, if no player has used a Slash this turn, the current turn player loses 1 HP.",
  ...
  [":suwang"] = "At the end of a player's turn, if they designated you as a target when using a card during that turn and you took no damage (in 2v2 mode this becomes: the damage you took is no more than 1), you put the top card of the draw pile onto your character card, called \"Long Renown\"; in your Draw phase, if you have Long Renown cards, you can obtain all of them instead of drawing, then you can make another player draw two cards.",
  [":suwang_2v2"] = "At the end of a player's turn, if they designated you as a target when using a card during that turn and the damage you took is no more than 1, you put the top card of the draw pile onto your character card, called \"Long Renown\"; in your Draw phase, if you have Long Renown cards, you can obtain all of them instead of drawing, then you can make another player draw two cards.",
  [":suwang_role_mode"] = "At the end of a player's turn, if they designated you as a target when using a card during that turn and you took no damage, you put the top card of the draw pile onto your character card, called \"Long Renown\"; in your Draw phase, if you have Long Renown cards, you can obtain all of them instead of drawing, then you can make another player draw two cards.",
  [":tamo"] = "At the start of the game, you can rearrange the seats of all players (in Role mode this becomes all players except the Lord; in Fight the Landlord this becomes all players except the third seat).",
  [":tanfeng"] = "At your Prepare phase, you can choose any number of options: 1. discard up to two cards from a player, then if their hand card count is not greater than yours, you skip your Draw phase; 2. deal 1 fire damage to a player, then if their HP is not greater than yours, you skip your Action phase.",
  [":taoluanh"] = "Once per turn, before a player's judgement card takes effect, if the judgement result is a spade, you can cancel this judgement and choose one: 1. you obtain this judgement card; 2. if the player making the judgement is not you, you count as using a fire Slash against them with no distance restriction and no limit on the number of uses.",
  [":taomie"] = "After you take damage or after you deal damage, you can make the damage source or the damaged player gain the Extermination mark (if the mark is already in play, it is transferred to that player); you and the player with the Extermination mark are considered to be in each other's ATK range; when you deal damage to a player with the Extermination mark, choose one: 1. this damage +1; 2. you obtain a card from their area and can give this card to another player; Backwater: discard their Extermination mark, and this damage does not make them gain the Extermination mark.",
  ...
  [":tiansuan"] = "Once per round, during your Action phase, you can draw a Fate Lot (before the draw begins, you can quietly cheat and add one extra Fate Lot to increase its chance of being drawn).<br/>Then you choose a player, who gains the effect of the Fate Lot until the start of your next turn.<br/>If they gain the Great Fortune lot, you look at their hand cards and obtain a card from their area; if they gain the Good Fortune lot, you obtain a card from them.<br/>The effects of the Fate Lots are as follows:<br/>Great Fortune: prevent the damage they take.<br/>Good Fortune: when they take damage, if the damage value is greater than 1, change the damage value to 1; after they take each 1 damage, you draw a card.<br/>Middling Fortune: when they take damage, change the damage to fire damage, and if the damage value is greater than 1, change the damage value to 1.<br/>Poor Fortune: when they take damage, the damage value +1.<br/>Worst Fortune: when they take damage, the damage value +1; they cannot use Peach or Alcohol.",
  [":tiantao"] = "(forced) At your Finish phase, you choose an area and discard all cards in it, then discard one card each from the same area of any number of other players in order; each player who has a card discarded this way and did not have a Slash discarded loses 1 HP.",
  [":tianyin"] = "(forced) At your Finish phase, you obtain from the draw pile one card of each card type you have not used this turn.",
  [":tianzuo"] = "(forced) At the start of the game, add 8 <a href=':raid_and_frontal_attack'>Raid and Frontal Attack</a> cards to the draw pile; Raid and Frontal Attack has no effect on you.",
  [":tieqi"] = "After you use Slash to target a player: you can perform a judgment; if it’s red, he can't use Dodge.",
  [":tingwei"] = "After you use a Slash and choose targets, you can gain 4 Thunder marks and choose one target player; they choose any options (each time they choose an option, you lose 1 Thunder mark):<br>1. their non-forced skills are invalid until the end of their next turn;<br>2. they give you an equip card;<br>3. this card deals +1 damage to them:<br>4. they discard a random card.<br>If they choose none of them, they become chained.",
  [":tongqu"] = "At the start of the game, you gain a Canal mark; in your Prepare phase, you can lose 1 HP to make a player without a Canal mark gain a Canal mark. A player who has Canal draws one extra card in their Draw phase, then gives a card to another player who has Canal or discards a card; if the card given this way is an equip card, that player uses it. When a player who has Canal enters the dying state, their Canal is removed.",
  [":treasure__xianjian"] = "This is a Breach treasure.",
  [":tunchu"] = "In your Draw phase, if you have no \"Grain\", you can draw two extra cards, then you can place any number of hand cards on your character card, called \"Grain\"; if there is \"Grain\" on your character card, you cannot use Slash.",
  ...
  [":wangzhuan"] = "After a player takes damage that was not caused by a card, if you are the damage source or the damaged player, you can draw a card, then the current turn player's non-forced skills are invalid this turn.",
  [":wanlan"] = "When a player takes fatal damage, you can discard all cards in your equip area (at least one) to prevent this damage.",
  ...
  [":weifeng"] = "(forced) After the first Slash or damage-dealing trick card you use in your Action phase finishes resolving, you choose one of its other target players who has no \"Fear\", and make them gain a \"Fear\" mark named after this card. When a player with \"Fear\" takes damage, remove the \"Fear\" and apply the effect: if the name of the card dealing the damage is the same as the \"Fear\", this damage is increased by 1; if it is different, you obtain a card from them. In your Prepare phase or when you die, remove all \"Fear\" marks.",
  [":weiming"] = "(mission) At the start of your Action phase, you mark another player who has not been marked before.<br>⬤ Success: after you kill an unmarked player, you change Blood Path to level 2;<br>⬤ Failure: after a marked player dies, you change Blood Path to level 3.",
  [":weitong"] = "(persistent) (lord skill) If there is another living Wei kingdom player in play, the Resolve your Hidden Dragon grants at the start of the game becomes 60.",
  [":weizhuang"] = "At the start of the Finish phase of a player who has <a href='#CardDisplayedDesc'>revealed cards</a>, you can reduce one of the following values by 1 and use one <a href=':caiqiu'>Tailor the Robe</a>: 1. the number of cards you draw in your Draw phase; 2. the limit on the number of Slashes you can use; 3. your hand limit; 4. your HP. X times per game; each time X cards have been revealed, you increase one of the above values by 1 (X is the number of players in the game +1).",
  [":wisdom__qiai"] = "Once per Action phase, you can give a non-basic card to another player, then they choose one: 1. make you recover 1 HP; 2. make you draw two cards.",
  [":wisdom__shanxi"] = "At the start of your Action phase, you can make a player who has no \"Proclamation\" gain one \"Proclamation\" mark (if that mark is already in play, it is transferred to that player instead); after a player with the \"Proclamation\" mark recovers HP, if they are not in the dying state, they must choose one: 1. give you two cards; 2. lose 1 HP.",
  [":wufei"] = "The source of damage caused by Slashes and normal trick cards you use counts as the player who has the Sparrow mark. After you take damage, if the player who has the Sparrow mark has more than 3 HP, you can make them take 1 sourceless damage.",
  [":wuku"] = "(forced) When a player uses an equipment card, you gain 1 Armoury mark. (You can have at most 3 Armoury marks.)",
  [":wuling"] = "Twice per Action phase, you can choose a player without a Five Beasts mark and teach them the Five Animal Frolics in an order of your choosing. In their Prepare phase, a player with a Five Beasts mark switches to the next effect in the order they were taught:<br>Tiger: when you deal damage with a card that has only one target, that damage +1.<br>Deer: recover 1 HP and discard all cards in your judgement area; you cannot be the target of delayed trick cards.<br>Bear: once per turn, when you take damage, that damage -1.<br>Ape: obtain a card from another player's equip area.<br>Crane: you draw three cards.",
  [":wurong-anfu"] = "If the opponent chooses Resist, you take 1 damage, then you draw a card<br>If the opponent chooses Submit, they give you two cards; if they have fewer than two cards, instead they skip their next Draw phase",
  [":wurong-fankang"] = "If the opponent chooses Suppress, they deal 1 damage to you, then they draw a card<br>If the opponent chooses Appease, they take 1 damage, then they draw a card",
  [":wurong-guishun"] = "If the opponent chooses Suppress, they obtain one card from you, then they give you two cards<br>If the opponent chooses Appease, you give them two cards; if you have fewer than two cards, instead you skip your next Draw phase",
  [":wurong-zhenya"] = "If the opponent chooses Resist, you deal 1 damage to them, then you draw a card<br>If the opponent chooses Submit, you obtain one card from them, then give them two cards",
  ...
  [":wuyuan"] = "Once per Action phase, you can give a Slash to another player, then you recover 1 HP and they draw a card. If that Slash is: a red Slash, that player recovers 1 extra HP; not a normal Slash, that player draws an extra card.",
  [":xianghai"] = "(forced) Other players' hand limit -1; equip cards in your hand all count as Alcohol.",
  [":xiangzhen"] = "(forced) Savage Assault has no effect on you; after a Savage Assault finishes resolving, if it dealt damage, you and the damage source each draw a card.",
  [":xianjian"] = "After you use a Slash and choose its only target, you can choose one option: 1. you draw a card and they discard X cards (X is the number of cards they have in play, and at least 1); 2. after this Slash finishes resolving, you put this Slash into one of their empty equip slots, called a Breach card.",
  [":xiaoge"] = "(forced) For a Slash you use: when it would deal damage to a player who became an extra target through Flying Path, prevent that damage, then you recover 1 HP and obtain the card that player discarded; after the Slash finishes resolving, if it had only one player as its target, it counts as you using a Duel on that player.",
  [":xiaoji"] = "After you lose 1 card in your equipment area: you can draw 2 cards.",
  [":xiaoni"] = "1. Once per Action phase, if your Mandate points are greater than 0, you can use a card as any kind of Slash or as a damage-dealing trick card, and you lose Mandate points equal to the number of targets of that card.<br>2. Your hand limit is X (X is your Mandate points, and at most your HP).",
  [":xiaxing"] = "At the start of the game, you obtain and use <a href=':xuanjian_sword'>Mystic Sword</a>; after Mystic Sword enters the discard pile, you can remove 2 Enlightenment marks to obtain it.",
  [":xichang"] = "(forced) At the start of the game, you choose your appearance for this game and gain the corresponding Attire; when you obtain a card other than by drawing, <a href='#DisplayCardsDesc'>reveal</a> it; your revealed hand cards are not visible when another player chooses cards from you.<br /><a href=':weizhuang'>Attire (Osmanthus Hall)</a><br /><a href=':mobile_dongjiao__weizhuang'>Attire (Eastern Suburb)</a><br /><a href=':mobile_xiuge__weizhuang'>Attire (Embroidered Chamber)</a>",
  ...
  [":xiezhi"] = "(forced) After your HP changes, you gain X charge points (X is the size of this change). If you would gain charge points beyond the maximum this way, your hand limit and your limit on the number of Slashes you can use +1.",
  [":xing__yishi"] = "When you deal damage to another player, you can reduce this damage by 1 and obtain a card from their equip area.",
  [":xingbu"] = "In your Finish phase, you can reveal the top three cards of the draw pile, then, according to the number of red cards among them, you can make another player of your choice gain one of the following effects:<br/>3 red cards: <font color='#CC3131'>«Five Stars in Alignment»</font>, on their next turn they draw 2 extra cards in their Draw phase and can use one extra Slash in their Action phase;<br/>2 red cards: «White Rainbow Pierces the Sun», on their next turn the number of Slashes they can use in their Action phase is -1 and they skip their Discard phase;<br/>no more than 1 red card: <font color='grey'>«Mars Guards the Heart»</font>, on their next turn they discard a hand card in their Prepare phase.",
  [":xinghun"] = "Once per Action phase, you can look at the top five cards of the draw pile, exchange any number of hand cards with an equal number of them and arrange them, then you make another player show five cards in total from your hand cards and the top of the draw pile, and you use the Slash among them against them one by one.",
  [":xingqi"] = "When you use a card that is not a delayed trick card, if there is no Prep with that card's name, record that card's name as a Prep. In your Finish phase, you can remove a Prep and obtain a card of the same name from the draw pile.",
  [":xingtu"] = "(forced) When you use a card, if this card's number is a factor of X, you draw a card; you use cards whose number is a multiple of X with no limit on the number of uses (X is the number of the last card you used).",
  [":xiongjin"] = "Once per round for each, at the start of your Action phase or another player's Action phase, you can make yourself or them draw X cards (X is your lost HP, at least 1 and at most 3). If you do, at the start of the Discard phase this turn, you discard all your non-basic cards or they discard all their basic cards.",
  [":xiongsi"] = "(once per game) In your Action phase, if you have at least three hand cards, you can discard all your hand cards, then every other player loses 1 HP.",
  [":xiongtus"] = "Once per Action phase, you can show a hand card of another player and choose one: 1. discard that card; 2. discard X cards and deal 1 damage to them (X is the number of suits that have not entered the discard pile this turn). If you do, then for the rest of this turn, after you deal damage other than through this skill you draw a card, and this skill becomes usable up to twice this phase.",
  [":xiongzi"] = "(once per game) At the start of your Prepare phase, you can make your Blazing Current, Flame Eddy and Burning Tide trigger only during your turn for the rest of the game, keeping only all of their option 1 or all of their option 2, then draw two cards.",
  [":xiugeng"] = "At the start of your turn, you can record the hand card count of up to two players. If you do, at the start of those players' Draw phase, if their hand card count is: not greater than the recorded value, they draw two cards; not less than the recorded value, their hand limit +1.",
  [":xizhan"] = "(forced) At the start of another player's turn, you choose one option:<br>1. discard a card and make your Fragrant Trail invalid this turn, then carry out the effect matching the discarded card's suit:<br>♠, it counts as them using an Alcohol;<br><font color='red'>♥</font>, it counts as you using an Ex Nihilo;<br>♣, it counts as you using an Iron Chain on them;<br><font color='red'>♦</font>, it counts as you using a fire Slash on them.<br>2. lose 1 HP.",
  [":xuancun"] = "At the end of another player's turn, if your HP is greater than your hand card count, you can make them draw X cards (X is the difference between your HP and your hand card count, at most 2).",
  [":xuanjian_sword"] = "Equip card - Weapon<br/><b>ATK range</b>: 3<br/><b>Weapon skill</b>: you can use all your hand cards of one suit as a Slash.",
  [":xuanjian_sword_skill&"] = "You can use all your hand cards of one suit as a Slash.",
  [":xuetu"] = "(toggle) Once per Action phase, you can: Yang, make a player recover 1 HP; Yin, make a player draw two cards.<br>⬤ Level 2: Once per Action phase for each option, you can choose one: 1. make a player recover 1 HP; 2. make a player draw two cards.<br>⬤ Level 3: (toggle) Once per Action phase, you can: Yang, recover 1 HP and make a player discard two cards; Yin, draw a card and deal 1 damage to a player.",
  [":xuetu_v2"] = "Once per Action phase for each option, you can choose one: 1. make a player recover 1 HP; 2. make a player draw two cards.",
  [":xuetu_v3"] = "(toggle) Once per Action phase, you can: Yang, recover 1 HP and make a player discard two cards; Yin, draw a card and deal 1 damage to a player.",
  [":xunyi"] = "At the start of the game, you choose another player and give them the Duty mark.<br>After you or the player with Duty takes 1 damage, if the damage source is not the other of the two of you, that other one discards a card.<br>After you or the player with Duty deals 1 damage, if the damaged player is not the other of the two of you, that other one draws a card.<br>When the player with Duty dies, you can transfer the Duty mark.",
  [":xushu__gongli"] = "(forced) If your ally Friend Zhuge Liang is in play, when you trigger Mystic Sword it instead lets you use one hand card as Slash; if your ally Friend Pang Tong is in play, the Slash you use with Mystic Sword has no distance restriction. (Only in Fight the Landlord and 2v2 modes)",
  [":xushu__gongli_pangtong"] = "(forced) If your ally Friend Pang Tong is in play, the Slash you use with Mystic Sword has no distance restriction.",
  [":xushu__gongli_zhugeliang"] = "(forced) If your ally Friend Zhuge Liang is in play, when you trigger Mystic Sword it instead lets you use one hand card as Slash.",
  [":xuye"] = "Once per turn, after the player with the fewest hand cards in play takes damage, you can make them draw two cards, then if they have the most hand cards in play, you place a card from their area on top of the draw pile.",
  [":yajun"] = "During your Draw phase, you draw one extra card. At the start of your Action phase, you can start a point fight with another player using a card you obtained this turn; if you: win, you can put one of the point fight cards on top of the draw pile; do not win, your hand limit this turn -1.",
  [":yance"] = "Once per round, at the start of the first round or in your Prepare phase, you can choose one: randomly obtain a trick card from the draw pile; carry out <a href='wolongyance'>\"Sleeping Dragon's Stratagem\"</a>. If you carry out \"Sleeping Dragon's Stratagem\", then when a card is used, if that card's type or color matches your prediction, you draw a card (each time you carry out \"Sleeping Dragon's Stratagem\" you can draw at most five cards this way).<br>After all predictions of \"Sleeping Dragon's Stratagem\" have been verified, or when you carry out \"Sleeping Dragon's Stratagem\" again, if the number of correct predictions in this \"Sleeping Dragon's Stratagem\" is:<br>0, you lose 1 HP, and thereafter the number of cards \"Sleeping Dragon's Stratagem\" can predict is reduced by 1;<br>less than half, you discard a card;<br>at least half (rounded up), you obtain from the draw pile a card matching the condition you declared, according to the way you predicted this time;<br>all correct, you draw two cards, and thereafter the number of cards \"Sleeping Dragon's Stratagem\" can predict is increased by 1 (up to 7).",
  [":yangjie"] = "Once per Action phase, you can start a point fight with a player. If you do not win, you can make another player count as using a fire Slash with no distance restriction on the player who fought points with you.",
  [":yanhui"] = "After you use a card and choose its first target, you can show a hand card of one target player; if that card has already been shown this turn, you discard it. If you do, at the end of this phase you choose one: 1. deal 1 fire damage to a player who had a card discarded this way this phase; 2. draw X cards (X is the number of players who have shown cards this turn).",
  [":yanji"] = "At the start of your Action phase, you can perform \"<a href='zhengsu_desc'>Rectify</a>\".",
  [":yaohu"] = "Once per round, at the start of your turn, you must choose a kingdom in play. At the start of the Action phase of another player of that kingdom, they obtain one of your Life cards, then they must choose one: 1. use a Slash that does not count toward the use limit against another player within their ATK range that you designate; 2. this phase, when they use a damage-dealing card targeting you, they must give you two cards, or cancel it.",
  [":yichong"] = "In your Prepare phase, you can choose another player and name a suit, obtain all their equipment of that suit and one of their hand cards of that suit, and make them gain a Sparrow mark until the start of your next turn (if a Sparrow mark is already in play, it is moved to that player instead). When a player who has a Sparrow mark obtains a card of the suit you named, you obtain that card (you obtain at most one card from this Sparrow mark).",
  ...
  [":yijie"] = "(forced) When you die, adjust the HP of all players in play to X (X is the average HP of all other players in play, rounded down and at least 1).",
  [":yijin"] = "(forced) At the start of the game, you gain 6 'Gold' marks; at the start of your turn, if you have no 'Gold', you die. At the start of your Action phase, you make another player who has no 'Gold' gain one 'Gold' and the matching effect until the end of their next turn:<br>Bountiful Office: Draw phase draw count +4, and the limit on Slash uses in the Action phase +1;<br>Weighty Trust: recover 3 HP at the end of their turn;<br>Bought Calamity: lose 1 HP at the start of their Action phase, and hand limit -3 this turn;<br>Shut Out: skip the Draw phase;<br>Divine Reach: prevent non-thunder damage taken;<br>Gold Besotted: skip the Action phase and the Discard phase.",
  ...
  [":yingba"] = "Once per Action phase, you can make another player whose max HP is greater than 1 lose 1 max HP and gain a Pacify mark, then you lose 1 max HP; you use cards on players who have a Pacify mark with no distance restriction.",
  [":yingjia"] = "(once per game) At the end of a player's turn, if you have used at least two trick cards with the same name this turn, you can discard a hand card and make a player take an extra turn; at the start of this extra turn they draw two cards.",
  [":yingjian"] = "In your Prepare phase, you can count as using a Slash with no distance restriction.",
  [":yingyuan"] = "When a card you used during your turn finishes resolving and is put into the discard pile, you can give it to another player (once per turn for each card name).",
  [":yingzi"] = "In your Draw Phase: you can draw +1 additional card.",
  [":yinship"] = "(forced) You have only the Draw phase, the Action phase and the Discard phase; you cannot be chosen as the target of delayed trick cards.",
  [":yinzhan"] = "(forced) When you use a Slash to deal damage to a player, if your: HP is not more than theirs, this damage +1; hand card count is not more than theirs, you discard a card of theirs after this Slash finishes resolving. <a href='#ChengShi'>Seize Momentum</a>: you recover 1 HP and obtain the card they discarded.",
  [":yirang"] = "At the start of your Action phase, you can give all your non-basic cards (at least one) to another player whose max HP is greater than yours, then you raise your max HP to match that player's and recover X HP (X is the number of card types among the cards you gave them this way).",
  [":yixiang"] = "Once per turn, after you become the target of a card used by a player whose HP is greater than yours, you can randomly obtain from the draw pile a basic card that you do not have.",
  [":yixing"] = "Once per Action phase, you can put all your Gear cards into the discard pile and draw that many cards, then you can put any number of equip cards on your character card, called Gear. You have all the effects of your Gear cards.",
  [":yiyongw"] = "After you take damage caused by a Slash used by another player, if there is a weapon card in your equip area, you can obtain that Slash, then use it as a normal Slash on them (if there is no weapon card in their equip area, this Slash deals 1 extra damage to them).",
  [":yizan"] = "You can use or play two cards (at least one of which is a basic card) as any basic card.",
  [":yizhu"] = "In your Finish phase, you draw two cards, then choose two cards as \"Lost Pearls\" and record them, shuffling them at random into the top 2X cards of the draw pile (X is the number of living players in the game). After another player uses a recorded \"Lost Pearl\" card and it designates a single target, you can cancel it, then you remove that card from the record.",
  [":youlve"] = "(forced) After you obtain a card during your turn other than by this skill, you draw a card; after you lose a card outside your turn other than by this skill, you discard a card.",
  [":youye"] = "(forced) At another player's Finish phase, if they have not dealt damage to you this turn, you place the top card of the draw pile on your character card, called 'Reserve' (at most 5). After you deal or take damage, you distribute all 'Reserve' cards as you wish.",
  [":youyi"] = "At the end of your Discard phase, you can put the cards discarded this phase into the <a href='RenPile_href'>Benevolence pile</a>. Once per Action phase, you can discard all cards in the Benevolence pile to make all players recover 1 HP.",
  [":yuanqing"] = "(forced) At the end of your Action phase, from among the cards that entered the discard pile because you used them this turn, you randomly place one card of each type into the <a href='RenPile_href'>'Benevolence' zone</a>.",
  [":yuejin__heyu"] = "(forced) If allied Thoroughbred Zhang Liao is in play, after a Slash you used Breach on deals damage, you can carry out the option that was not chosen against the target player; if allied Thoroughbred Li Dian is in play, after a player loses a Breach card for the first time each turn, you draw a card. (Only in Landlord and 2v2 modes)",
  [":yuejin__heyu_lidian"] = "(forced) If allied Thoroughbred Li Dian is in play, after a player loses a Breach card for the first time each turn, you draw a card.",
  [":yuejin__heyu_zhangliao"] = "(forced) If allied Thoroughbred Zhang Liao is in play, after a Slash you used Breach on deals damage, you can carry out the option that was not chosen against the target player.",
  [":yuetan"] = "After a player at distance 1 or less from you becomes the target of a damage card, you can give them a card (if that player is you, you can use this skill directly instead). After this damage card finishes resolving, if they have taken no damage from this card, you draw a card. Each time you lose two cards this way, you recover 1 HP.",
  [":yueyuan"] = "Once per Action phase, you can draw X cards (X is the number of suits recorded by your Hidden Blade), then clear one suit recorded by your Hidden Blade.",
  [":yuhua"] = "(forced) Your non-basic cards do not count toward your hand limit; at your Finish phase, if your hand count is greater than your HP, you look at the top X cards of the draw pile (X is the number of card types in your hand), place any number of them on top of the draw pile and the rest on the bottom of the draw pile.",
  [":yuli"] = "(forced) 1. Damage you deal becomes thunder damage; if it is already thunder damage, this damage +1; 2. When you take thunder damage, prevent it and draw that many cards.",
  [":yunan"] = "(awaken) Your starting kingdom is Wei; when you make a player enter the dying state, if a player has died this round, you change your kingdom to Neutral, then gain or upgrade the skill <a href=':kechang'>Prosperity</a>.",
  [":yuxiang"] = "(forced) If you have Shield: the distance from you to other players is reduced by 1; the distance from other players to you is increased by 1; when you take fire damage, that damage is increased by 1.",
  [":zaoli"] = "(forced) During your Action phase, you cannot use or play hand cards that you did not obtain this turn. When you use or play a hand card, if your number of Rage marks is less than 4, you gain 1 Rage mark. At the start of your turn, if you have Rage marks, you remove all Rage marks and discard any number of cards (at least one card), then draw X cards (X is the number of Rage marks you removed plus the number of cards you discarded). If the number of Rage marks you removed is greater than 2, you lose 1 HP.",
  [":zhangliao__heyu"] = "(forced) If allied Thoroughbred Yue Jin is in play, Rampart Charge's 'non-basic hand cards' becomes 'hand cards'; if allied Thoroughbred Li Dian is in play, Sweeping Force's X is fixed at 3. (Only takes effect in Landlord and 2v2 modes.)",
  [":zhangliao__heyu_lidian"] = "(forced) If allied Thoroughbred Li Dian is in play, Sweeping Force's X is fixed at 3.",
  [":zhangliao__heyu_yuejin"] = "(forced) If allied Thoroughbred Yue Jin is in play, Rampart Charge's 'non-basic hand cards' becomes 'hand cards'.",
  [":zhangming"] = "(forced) ♣ cards you use cannot be responded to. Once per turn, after you deal damage to another player, they discard a random hand card, then you obtain from the draw pile or the discard pile one card of each type other than the type of the card they discarded (if they cannot discard a hand card, instead you obtain one card of each type from the draw pile or the discard pile); cards obtained this way do not count toward your hand limit this turn.",
  [":zhanlie"] = "At the start of a player's turn, you record X (X is your ATK range at that time). After each of the first X Slashes this turn enters the discard pile, if that card is in the discard pile, you gain 1 Blaze mark (you can have at most 6 Blaze marks); at the end of your Action phase, you can remove all your Blaze marks and count as using a Slash with no limit on the number of uses, then choose up to Y options (Y is the number of marks you removed this time divided by 3, rounded down): 1. this Slash's targets +1; 2. this Slash's base damage +1; 3. the target players must discard an extra card in order to respond to this Slash; 4. after this Slash finishes resolving, you draw two cards.",
  [":zhanshi"] = "When players make a point fight, you can choose any number of players in this point fight and discard that many cards; after this point fight resolves, you draw three cards for each chosen player who won.",
  [":zhaohan"] = "(forced) At the start of your Prepare phase, if X is: less than 4, you gain 1 max HP and recover 1 HP; not less than 4 and less than 7, you lose 1 max HP (X is the number of times you have triggered this skill).",
  [":zhaohuo"] = "(forced) When another player enters the dying state, if your max HP is greater than 1, you reduce your max HP to 1, then you draw cards equal to the amount of max HP reduced.",
  [":zhaoxin"] = "Once per Action phase, you can place any number of cards on your character card, called 'Ambition' (their total cannot exceed 3), then draw the same number of cards. At the end of the Draw phase of you and of players in your ATK range, that player can obtain one 'Ambition' that you choose, then you can deal 1 damage to them.",
  [":zhenbian"] = "(forced) Your hand limit equals your max HP; when cards enter the discard pile for a reason other than being used, this skill records the suits of those cards, then if this skill has recorded all four suits and your max HP is less than 8, you clear the recorded suits and gain 1 max HP.",
  [":zhenfu"] = "In your Finish phase, if you have lost cards by discarding this turn, you can make another player gain 1 shield.",
  [":zhengjian"] = "(forced) In your Finish phase, you give a player a Candid Recommendation mark, then at the start of your next turn they draw X cards and remove the Candid Recommendation mark (X is the number of cards they used or played during that period, up to their max HP and up to 5).",
  [":zhengjing"] = "Once per Action phase, you can collate the classics once, and place any of the cards you collated onto a player's character card, called Canon, then you obtain the remaining cards. In the Prepare phase of a player who has Canon on their character card, they obtain all of the Canon cards, then they skip this turn's Judge phase and Draw phase.",
  [":zhengjun"] = "At the start of your Action phase, you can perform \"<a href='zhengsu_desc'>Discipline</a>\"; after your Discard phase ends, if \"<a href='zhengsu_desc'>Discipline</a>\" succeeded, you gain the \"<a href='zhengsu_desc'>Discipline</a>\" reward, then you can make another player also gain the \"<a href='zhengsu_desc'>Discipline</a>\" reward.",
  [":zhengnan"] = "After another player dies, you can draw three cards; if you do, you gain any one of the following skills: Warrior Saint, Vanguard and Subdue the Savage.",
  [":zhengpeng"] = "At the end of a player's turn, you can choose an eligible player and lose X HP (X is the number of times this skill has been used this round); you draw a card for each of the following that player met this turn: they took damage, they lost an equip card, they are not the current turn's player and obtained cards. <a href='#ChengShi'>Ride the Momentum</a>: reset this skill's X, then you obtain one card of each type from the discard pile.",
  [":zhengshuo"] = "(once per game) In your Action phase, you can make all players discard all their hand cards in turn, then reshuffle the draw pile. If you do, all players each draw four cards.",
  [":zhengsu_bianzhen"] = "During your Action phase, use at least 2 cards, and the cards you use are of the same suit",
  [":zhengsu_leijin"] = "During your Action phase, use at least 3 cards, and the numbers of the cards you use are increasing",
  [":zhengsu_mingzhi"] = "During your Discard phase, discard at least 2 cards, and the cards you discard are all of different suits",
  [":zhenjun"] = "At the start of your Action phase, you can give a card to another player, then make them choose whether to use a non-black Slash; after this Slash finishes resolving you draw X cards (X is the damage dealt by this Slash +1, up to 5). If they do not, you can deal 1 damage to them or to a player within their ATK range.",
  [":zhenting"] = "Once per turn, when you or a player in your ATK range becomes the target of a Slash or a delayed trick card, if you are not the user of this card, you can choose one option: 1. discard a hand card from the user of this card; 2. draw a card. Desperate Stand: you become the target of this card in their place.",
  [":zhenting_inner"] = "Once per turn, when you or a player in your ATK range becomes the target of a Slash or a delayed trick card, if you are not the user of this card, you can choose one option: 1. discard a hand card from the user of this card; 2. draw a card.",
  [":zhenxing"] = "In your Finish phase or after you take damage, you can look at the top three cards of the draw pile, then obtain the one among them whose suit differs from that of both of the others.",
  [":zherui"] = "After a player with a Breach card in their equip area uses a Slash and chooses targets, you use Breach on them once with the option chosen by them; after a player loses a Breach card from their equip area, you deal 1 damage to them.",
  [":zhiheng"] = "Once per Action Phase: you can discard any # of cards; then, draw the same # of cards.",
  [":zhijie"] = "Once per round, at the start of a player's Action phase, you can show one of their hand cards. After they use a card of the same type as that card during this phase, they draw a card and discard X cards (X is the number of times this effect has triggered minus 1); at the end of that phase, if the number of cards they drew this way during the phase is greater than the number of cards they discarded this way, you and they each draw a card.",
  [":zhilve"] = "Once per Action phase, you can lose 1 HP to increase your hand limit this turn by 1, and choose one option: 1. move a card on the field; 2. draw a card and it counts as using a Slash with no distance restriction and no limit on the number of uses.",
  [":zhimeng"] = "At the end of your turn, you can split your hand cards evenly at random with another player (if this is not Role mode, this becomes another player whose hand card count is no greater than your hand card count +1); if the total number of cards is odd, you take the larger share.",
  [":zhimeng_1v2"] = "At the end of your turn, you can split your hand cards evenly at random with another player whose hand card count is no greater than your hand card count +1; if the total number of cards is odd, you take the larger share.",
  [":zhimeng_role_mode"] = "At the end of your turn, you can split your hand cards evenly at random with another player; if the total number of cards is odd, you take the larger share.",
  [":zhiyi"] = "(forced) At a player's Finish phase, if you have used or played a basic card this turn, you choose one: 1. it counts as using any one basic card you have used or played this turn; 2. draw a card.",
  [":zhongao"] = "(mission) At the start of the game, you gain the skill <a href=':m_shi__kuanggu'>Bloodlust</a>.<br>⬤ Success: after you kill a player, you upgrade the skill Bloodlust. If, during that phase, the number of cards you used is less than the number of cards you discarded for Valiant Oath, you draw a card; the number of cards you used is less than the amount of HP you lost for Valiant Oath, you recover 1 HP (if you are not wounded, you draw a card instead).<br>⬤ Failure: when you enter the dying state, or you choose not to use the skill Valiant Oath, you lose the skill Valiant Oath and gain the skill <a href=':kunfen'>Desperate Struggle</a>.",
  [":zhoulin"] = "(once per game) In your Action phase, if you have Beast Arts, you can gain 2 Shield and choose one beast effect; until the start of your next turn, Beast Arts always carries out that beast effect.",
  [":zhouxian"] = "(forced) When you become the target of a damage card used by another player, you reveal the top three cards of the draw pile, then they must discard a card of a type that appears among the revealed cards, otherwise this target is cancelled.",
  ...
  [":zhuangshi"] = "At the start of your Action phase, you can perform at least one of the following in order: 1. discard at least one hand card, then the first X cards you use this phase have no distance restriction and cannot be responded to (X is the number of cards you discarded this way); 2. lose at least 1 HP, then the same number of the first cards you use this phase do not count toward use limits.",
  [":zhugeliang__gongli"] = "(forced) If Friend Pang Tong is in play on your side, the initial number of cards you can predict when you carry out \"Sleeping Dragon's Stratagem\" is increased by 1; if Friend Xu Shu is in play on your side, the result of the first card you predict with \"Sleeping Dragon's Stratagem\" is always treated as correct. (Only takes effect in Landlord and 2v2 modes.)",
  [":zhugeliang__gongli_pangtong"] = "(forced) If Friend Pang Tong is in play on your side, the initial number of cards you can predict when you carry out \"Sleeping Dragon's Stratagem\" is increased by 1.",
  [":zhugeliang__gongli_xushu"] = "(forced) If Friend Xu Shu is in play on your side, the result of the first card you predict with \"Sleeping Dragon's Stratagem\" is always treated as correct.",
  [":zhuguo"] = "Once per Action phase, you can make a player adjust their hand to X cards (X is their max HP, at most 5). Then if they: did not draw, they recover 1 HP; drew cards this way and have the most hand cards in the game, you can choose another player and let them decide whether to use a Slash against this player with no distance restriction and no limit on the number of uses.",
  [":zhujian"] = "Once per Action phase, you can make at least two players who have cards in their equip area each draw a card.",
  [":zhujis"] = "At the end of your Action phase, you can choose a hand card, discard all your hand cards of the same suit as it, then obtain and use an equip card of that suit from the draw pile. If the number of cards you discarded is not less than the number of cards in your equip area before you used that equip card, choose one: 1. draw two cards; 2. heal 1 HP; 3. gain 1 Shield.",
  [":zifu"] = "(forced) At the end of your Action phase, if you used no card this phase, your hand limit -1 this turn and you remove all your Preps.",
  [":zixing"] = "Zi Xing (equip card, horse)<br /><b>Horse skill</b>: The distance from you to other players is reduced by -1.",
  [":zujin"] = "Once per turn for each card name, if you are not wounded or your HP is not the lowest, you can use or play a basic card as Slash; if you are wounded, you can use or play a basic card as Dodge or Nullification.",
  [":zundi"] = "Once per Action phase, you can discard a hand card and choose a player, then you judge; if the result is: black, they draw three cards; red, they can move a card on the field.",
  [":zuoxing"] = "Once per Action phase, you can make God Guo Jia lose 1 max HP, and it counts as using a regular trick card.",
  [":zuoyou"] = "(toggle) Once per Action phase, Yang: you can make a player draw three cards, then they discard two hand cards; Yin: you can make a player discard a hand card, then they gain 1 Shield (in 2v2 mode this becomes: make a player gain 1 Shield).",
  [":zuoyou_2v2"] = "(toggle) Once per Action phase, Yang: you can make a player draw three cards, then they discard two hand cards; Yin: you can make a player gain 1 Shield.",
  [":zuoyou_role_mode"] = "(toggle) Once per Action phase, Yang: you can make a player draw three cards, then they discard two hand cards; Yin: you can make a player discard a hand card, then they gain 1 Shield.",
  ...
  ["RenPile_href"] = "The Benevolence pile is a public area on the field used to hold cards.<br>It holds at most 6 cards; when it holds more than 6, the card put there earliest goes to the discard pile.",
  ["Rename"] = "Rename",
  ["Replay"] = "Replay",
  ...
  ["chengye_href"] = "Odes - damage-dealing trick cards;<br>Documents - basic cards;<br>Rites - Nullification;<br>Changes - Ex Nihilo;<br>Music - Indulgence;<br>Spring and Autumn - equip cards",
  ["chengzhang"] = "Verse Complete",
  ...
  ["defensive_siege_engine"] = "Great Siege Engine - Defense",
  ["delayedPindian"] = "<b>Delayed point fight:</b><br>Before the point-fight cards are revealed, the result is not announced at once: the point-fight cards are placed face down and removed from the game. After this turn ends, if the condition for revealing the result is still unmet, those point-fight cards are put into the discard pile, and no further point-fight procedure or timing is carried out.",
  ...
  ["jilun_use"] = "Count as using a basic card, or a regular trick card recorded by Swift Scheme whose number of targets is not more than %arg",
  ...
  ["premeditate_href"] = "Place a hand card face down in your judgement area; at the start of your Judge phase, resolve the Premeditate cards one by one in the order they were placed (the last one placed is handled first): 1. use this card, then you cannot use another card with this name during this phase; 2. put all Premeditate cards into the discard pile.",
  ["prey"] = "Obtain",
  ...
  ["shuxing_give"] = "Give every Dodge among them, and hand %src the right to make your next Uphold the Law choice",
  ...
  ["taomie"] = "Extermination",
  ["taomie_beishui"] = "Backwater: discard their Extermination mark, and this damage does not make them gain the mark",
  ...
  ["wolongyance"] = "Predict the colour or the type of a set number of cards that will be used from now on (the number of cards you can predict starts at 3). The prediction method is either predicting by colour or predicting by type. A prediction is revealed when a player uses a card; once all the predictions have been revealed, this is called fully verified.",
  ["wooden_ox"] = "Wooden Ox",
  ["wu"] = "Wu",
  ["wufei"] = "Slander",
  ["wuke"] = "Wu Ke",
  ...
  ["zhengsu_desc"] = "<b>#Rectify:</b><br>The player who uses the skill chooses one of Drumbeat Advance, Shift Formation or Sound the Halt for the target to carry out; if Rectify succeeds this turn, they gain the Rectify reward at the end of the Discard phase.<br><b>Drumbeat Advance:</b>During the Action phase, the points of all cards used must increase, and at least three cards must be used.<br><b>Shift Formation:</b>During the Action phase, all cards used must be of the same suit, and at least two cards must be used.<br><b>Sound the Halt:</b>During the Discard phase, all cards discarded must be of different suits, and at least two cards must be discarded.<br><b>Rectify reward:</b>Draw two cards or recover 1 HP.",
  ...
  ["~m_ex__quancong"] = "I chased fame like a man building a house on roadside advice... and so it was never finished...",
  ...
  ["~m_ex__wuyi"] = "We never feared the perilous roads of Shu, yet the Wei River and Chang'an we cannot pass...",
  ...
  ["~m_ex__yujin"] = "Peril and hardship at last, and I have failed thirty years of the Chancellor's trust... alas...",
  ...
  ["~m_js__wangyun"] = "The armies would not disband, and new chaos rises - this old man must answer with his life...",
  ...
  ["~m_liuyi__zhouyu"] = "Bo Ya broke his zither for the friend who knew him - not the lost music, but the true heart, is what we prize.",
  ...
  ["~mobile__caosong"] = "Ever I grieved that hearts run shallower than water - on level ground they raise up waves...",
  ...
  ["~mobile__cuilingyi"] = "No paint keeps a face a thousand years; high or low, we all come back to the same mound of earth.",
  ...
  ["~mobile__duyu"] = "A round stone in the Luo, the road turning south... plain living alone will keep me whole...",
  ...
  ["~mobile__liuye"] = "Alas. I could not aid my sovereign above, nor keep my colleagues below. I was no minister to save an age.",
  ...
  ["~mobile__simazhou"] = "All I ask is burial beside the Grand Consort's tomb, and my lands divided among my four sons.",
  ...
  ["~mobile__xianglang"] = "The Master said: in teaching there are no classes. A pity - so many never came to the school...",
  ...
  ["~mobile__zhangjih"] = "It grieves me that I shall not see the realm made quiet, and the Qiang and Hu come to submit.",
