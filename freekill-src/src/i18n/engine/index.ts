 ...
 *
 * Merge order is upstream -> override -> authored, and the three key sets are
 * disjoint by construction (the coverage test asserts it).
 */
...
export { AUTHORED_EN_US, OVERRIDE_EN_US, UPSTREAM_EN_US };
...
export const COUNTS = {
  ...
  authored: Object.keys(AUTHORED_EN_US).length,
} as const;
